...
// $Id: TestOfServerFactory.java,v 1.1 2001/06/16 16:47:32 raif Exp $
//
 ...
 * @since version 0.8.9
 */
public class TestOfServerFactory extends TestCase {
	...
	public TestOfServerFactory(String name) {
		super(name);
	}
	...
	public static Test suite() {
		return new TestSuite(TestOfServerFactory.class);
	}
   ...
   private static boolean includes(String[] sa, String n) {
	...
	public void testGetServerMechanismsWithNullProperties() {
	   String[] mechanisms = new ServerFactory().getMechanismNames(null);
	...
	public void testGetServerMechanismsForNoPlaintext() {
	   Hashtable p = new Hashtable();
	   p.put(Sasl.POLICY_NOPLAINTEXT, "true");
	   String[] mechanisms = new ServerFactory().getMechanismNames(p);
	...
	public void testGetServerMechanismsForNoActive() {
	   Hashtable p = new Hashtable();
	...
	public void testGetServerMechanismsForNoDictionary() {
	   Hashtable p = new Hashtable();
	...
	public void testGetServerMechanismsForNoAnonymous() {
	   Hashtable p = new Hashtable();
	...
	public void testGetServerMechanismsForNoForwardSecrecy() {
	   Hashtable p = new Hashtable();
	...
	public void testGetServerMechanismsForPassCredentials() {
	   Hashtable p = new Hashtable();
