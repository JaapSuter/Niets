...
// $Id: PasswordFile.java,v 1.6 2001/10/18 09:54:01 raif Exp $
//
 ...
 */
public class PasswordFile implements CramMD5Params
{
   ...
   throws IOException {
      ...
      String[] fields = new String[7]; // create the new entry
      fields[0] = user;
      fields[1] = passwd;
