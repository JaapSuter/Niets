...
public final class Phonemetadata
{
    ...
    implements Externalizable
  {
      ...
      throws IOException
    {
      ...
      if (paramObjectInput.readBoolean())
      {
        ...
        setVoicemail(localPhoneNumberDesc11);
      }
      if (paramObjectInput.readBoolean())
      {
        ...
        setEmergency(localPhoneNumberDesc12);
      }
      if (paramObjectInput.readBoolean())
      {
        ...
        setNoInternationalDialling(localPhoneNumberDesc13);
      }
    ...
    implements Externalizable
  {
    ...
    {
      if ((this.nationalNumberPattern_.equals(paramPhoneNumberDesc.nationalNumberPattern_)) && (this.possibleNumberPattern_.equals(paramPhoneNumberDesc.possibleNumberPattern_)) && (this.exampleNumber_.equals(paramPhoneNumberDesc.exampleNumber_)));
