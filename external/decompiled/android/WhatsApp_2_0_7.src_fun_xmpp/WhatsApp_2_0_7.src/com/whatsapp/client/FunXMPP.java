...
/*      */ {
		...
		{
			System.out.println("HELLO FUNXMPP!");
			 String usePushName = "s40 user";
			String resource = "S40-1.2-443";
			String chatUserID="PHONE_NUMBER_HERE";
			String domain ="s.whatsapp.net";
			String socketURL="bin-short.whatsapp.net:5222";
			 FunXMPP.Connection connection = null;
			 
		/* 105 */     Socket conn = null;
		/* 106 */     InputStream is = null;
		/* 107 */     OutputStream os = null;
			
			
			 conn = new Socket("bin-short.whatsapp.net",5222);
			 
			  is = conn.getInputStream();
/* 177 */        	 os = conn.getOutputStream();
		 Object login = new FunXMPP.Login.WhatsApp(new FunXMPP.BinTreeNodeReader(is, FunXMPP.dictionary), new FunXMPP.BinTreeNodeWriter(os, FunXMPP.dictionary), new S40MD5Digest());
/*     */ 
/* 191 */         connection = new FunXMPP.Connection((FunXMPP.Login)login, "s.whatsapp.net", resource, chatUserID, usePushName, "8ef85f123674647e9b421a8e4bea63cb", null,null,null);
/*     */ 
...
/* 3071 */         return nextInternalTree(); } catch (XmlPullParserException e) {
				throw new FunXMPP.CorruptStreamException("got XmlPullParseX : " + e.toString());
/*      */       }
/* 3073 */       
/*      */     }
/*      */ 
...
/*      */ 	
		System.out.println(md5Digest((this.connection.user + ":" + this.connection.domain + ":" + this.connection.password).getBytes()));
...
/* 2159 */       String KD = new String(bytesToHex(md5Digest(A1))) + ":" + nonce + ":" + nc + ":" + cnonce + ":auth:" + new String(bytesToHex(md5Digest(A2.getBytes())));
		...
		//System.out.println(KD);System.exit(1);
...
/* 2177 */       bigger_response.append(nc);
		...
		//System.out.println(bigger_response.toString());System.exit(1);
...
/*      */ 	   //System.out.println(challengeData);
 		   //System.exit(1);
...
/*      */       throws IOException, FunXMPP.CorruptStreamException;
		...
		public  IqResultHandler(java.lang.String x,com.whatsapp.client.FunXMPP.StringRunnable y,com.whatsapp.client.FunXMPP.IntRunnable z)
		{
