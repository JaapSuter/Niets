...

{
	...
	// @@@@@@@@@@@@@ Fields 
	public String /*java.lang.String*/  isoCode ; // ofs = 43274 addr = 0)
	public String /*java.lang.String*/  name ; // ofs = 43278 addr = 0)
	public int /*int*/  countryCode ; // ofs = 43282 addr = 0)
	public java.util.Vector /*java.util.Vector*/  mccVector ; // ofs = 43286 addr = 0)
	public net.rim.device.api.util.IntVector /*net.rim.device.api.util.IntVector*/  lengthsVector ; // ofs = 43290 addr = 0)
	public net.rim.device.api.util.IntVector /*net.rim.device.api.util.IntVector*/  trimsVector ; // ofs = 43294 addr = 0)
	public boolean /*boolean*/  leadingZeroAllowed ; // ofs = 43298 addr = 0)
...
public final boolean hasMcc( com.whatsapp.client.CountryPhoneInfo$Country, int ); // address: 0
	...
	invokestatic_lib module:WhatsApp-35.class#1.routine_2039(  ) // class#1
	astore_2 
	aload_0_getfield .field_3_3   // get_name_1:  .field_3_3   // get_name_2:  .field_3_3   // get_Name:    .field_3_3   // getName->1:  null   // getName->2:  null   // getName->N:  null   // ofs = -1 ord = 0 addr = 3
	aload_2 
