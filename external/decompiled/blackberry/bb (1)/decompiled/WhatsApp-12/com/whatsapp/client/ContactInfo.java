...
{
	// @@@@@@@@@@@@@ Static fields 
	private static com.whatsapp.client.ContactInfoDetailsNameComparator /*com.whatsapp.client.ContactInfoDetailsNameComparator*/  field_41830 ; // ofs = 41830 addr = 237)
	private static com.whatsapp.client.ContactInfoDetailsNameComparator /*com.whatsapp.client.ContactInfoDetailsNameComparator*/  field_41836 ; // ofs = 41836 addr = 238)

	// @@@@@@@@@@@@@ Fields 
	private net.rim.device.api.collection.util.BigVector /*net.rim.device.api.collection.util.BigVector*/  field_41786 ; // ofs = 41786 addr = 0)
	private net.rim.device.api.collection.util.BigVector /*net.rim.device.api.collection.util.BigVector*/  field_41790 ; // ofs = 41790 addr = 0)
	public java.util.Hashtable /*java.util.Hashtable*/  _contactsByUID ; // ofs = 41794 addr = 0)
	public java.util.Hashtable /*java.util.Hashtable*/  _contactsByPhone ; // ofs = 41798 addr = 0)
	private java.util.Hashtable /*java.util.Hashtable*/  field_41802 ; // ofs = 41802 addr = 0)
	private java.util.Hashtable /*java.util.Hashtable*/  field_41806 ; // ofs = 41806 addr = 0)
	public int /*int*/  _contactsSortOrder ; // ofs = 41810 addr = 0)
	public String /*java.lang.String*/  _userDefinedLabel1 ; // ofs = 41814 addr = 0)
	public String /*java.lang.String*/  _userDefinedLabel2 ; // ofs = 41818 addr = 0)
	public String /*java.lang.String*/  _userDefinedLabel3 ; // ofs = 41822 addr = 0)
	public String /*java.lang.String*/  _userDefinedLabel4 ; // ofs = 41826 addr = 0)
...
<init>( com.whatsapp.client.ContactInfo ); // address: 0
	...
	aload_0 
	invokespecial com.whatsapp.client.ContactInfo.routine_8867 // pc=1
	return 
	}


static private final java.util.Vector com.whatsapp.client.ContactInfo.routine_9837( net.rim.device.api.collection.util.BigVector, java.lang.String, int ); // address: 0
	{
	enter 
	...
	bipush 32
	iconst_0 
	invokestatic_lib module:WhatsApp-35.class#1.routine_4762(  ) // class#1
	astore_5 
	aload_0 
...
Label32:
	...
	aload_4 
	aload 8
	invokestatic boolean com.whatsapp.client.ContactInfo.routine_10115( java.lang.String, int, java.util.Hashtable, module:WhatsApp.class#31 ) // ContactInfo
	ifne Label47
	iconst_0 
	istore 9
	goto Label49
...
Label28:
	...
	dup 
	ldc literal_206:"Unknown type filtering contacts: "
...
static private final boolean com.whatsapp.client.ContactInfo.routine_10115( java.lang.String, int, java.util.Hashtable, module:WhatsApp.class#31 ); // address: 0
	{
	enter 
	iload_1 
	iconst_1 
...
Label11:
	...
	invokestatic boolean casefreeKeywordMatch( module:WhatsApp.class#31, java.lang.String ) // ContactInfo
	ifne Label24
	iconst_0 
	istore_4 
	goto Label26
...
static public final boolean casefreeKeywordMatch( module:WhatsApp.class#31, java.lang.String ); // address: 0
	{
	enter 
...
static private final com.whatsapp.client.ContactInfo.routine_10741( module:WhatsApp.class#31 ); // address: 0
	{
	enter 
	aload_0 
	ifnull Label8
...
static final <clinit>(  ); // address: 0
	...
	putstatic com.whatsapp.client.ContactInfo.field_41830 // ContactInfo
	new ContactInfoDetailsNameComparator
	dup 
	iconst_1 
	invokespecial com.whatsapp.client.ContactInfoDetailsNameComparator.<init> // pc=2
	putstatic com.whatsapp.client.ContactInfo.field_41836 // ContactInfo
	clinit_return 
	}

	// @@@@@@@@@@@@@ Non-virtual routines 

final addContact( com.whatsapp.client.ContactInfo, module:WhatsApp.class#31 ); // address: 0
	{
	enter 
...
public final resort( com.whatsapp.client.ContactInfo ); // address: 0
	...
	enter_narrow 
	aload_0_getfield .field_0_   // get_name_1:  .field_0_   // get_name_2:  .field_0_   // get_Name:    .field_0_   // getName->1:  null   // getName->2:  null   // getName->N:  null   // ofs = -1 ord = 0 addr = 0
	getstatic com.whatsapp.client.ContactInfo.field_41830 // ContactInfo
	invokevirtual sort( net.rim.device.api.collection.util.BigVector, net.rim.device.api.util.Comparator ) // pc=2
	aload_0_getfield .field_1_1   // get_name_1:  .field_1_1   // get_name_2:  .field_1_1   // get_Name:    .field_1_1   // getName->1:  null   // getName->2:  null   // getName->N:  null   // ofs = -1 ord = 0 addr = 1
	getstatic com.whatsapp.client.ContactInfo.field_41836 // ContactInfo
	invokevirtual sort( net.rim.device.api.collection.util.BigVector, net.rim.device.api.util.Comparator ) // pc=2
	return 
	}
...
Label32:
	...
	astore_6 
	aload_6 
	invokestatic_lib module:WhatsApp-43.class#0.routine_616(  ) // class#0
...
final module:WhatsApp.class#31 getContactInfoDetails( com.whatsapp.client.ContactInfo, int ); // address: 0
	{
	enter_narrow 
	aload_0_getfield .field_0_   // get_name_1:  .field_0_   // get_name_2:  .field_0_   // get_Name:    .field_0_   // getName->1:  null   // getName->2:  null   // getName->N:  null   // ofs = -1 ord = 0 addr = 0
	astore_2 
...
Label49:
	...
	aload_0_getfield .field_6_6   // get_name_1:  .field_6_6   // get_name_2:  .field_6_6   // get_Name:    .field_6_6   // getName->1:  null   // getName->2:  null   // getName->N:  null   // ofs = -1 ord = 0 addr = 6
	iload 10
	invokenonvirtual_lib .routine_10741 // pc=4
	goto_w Label285
Label57:
	aload 8
...
Label9:
	...
	aload_1 
	iload_2 
	invokestatic java.util.Vector com.whatsapp.client.ContactInfo.routine_9837( net.rim.device.api.collection.util.BigVector, java.lang.String, int ) // ContactInfo
	areturn 
	}
...
private final com.whatsapp.client.ContactInfo.routine_8867( com.whatsapp.client.ContactInfo ); // address: 0
	{
	enter 
	aload_0 
	invokenonvirtual com.whatsapp.client.ContactInfo.clear // pc=1
	invokestatic_lib module:WhatsApp-35.class#1.routine_309(  ) // class#1
	ifne Label6
	goto_w Label119
Label6:
	aconst_null 
...
Label29:
	...
	astore_6 
	aload_2 
	invokestatic com.whatsapp.client.ContactInfo.routine_10741( module:WhatsApp.class#31 ) // ContactInfo
	goto Label57
Label41:
	new_lib //module:WhatsApp.class#31 module:WhatsApp.class#31 module:WhatsApp.class#31
	dup 
	invokespecial_lib .routine_12926 // pc=1
	astore_2 
	aload_2 
	aload_3 
	aload_0 
	invokenonvirtual_lib .routine_8242 // pc=3
	aload_2 
...
final removeContact( com.whatsapp.client.ContactInfo, module:WhatsApp.class#31 ); // address: 0
	{
	enter 
	aload_0_getfield .field_0_   // get_name_1:  .field_0_   // get_name_2:  .field_0_   // get_Name:    .field_0_   // getName->1:  null   // getName->2:  null   // getName->N:  null   // ofs = -1 ord = 0 addr = 0
	getstatic com.whatsapp.client.ContactInfo.field_41830 // ContactInfo
...
Label51:
	...
	iconst_0 
	invokenonvirtual_lib .routine_13199 // pc=3
	iinc 7 1
	goto Label29
Label62:
	aload_4 
...
final boolean updateContact( com.whatsapp.client.ContactInfo, module:WhatsApp.class#31, module:WhatsApp.class#31 ); // address: 0
	{
	enter 
	iconst_1 
	istore_3 
