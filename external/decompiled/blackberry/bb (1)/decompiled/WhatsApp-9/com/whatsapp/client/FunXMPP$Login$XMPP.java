...
public final read1( com.whatsapp.client.FunXMPP$Login$XMPP ); // address: 0
	...
	invokeinterface interfacemethodref_139 // pc=1 guess=52
	aload_0_getfield .field_1_1   // get_name_1:  .field_1_1   // get_name_2:  .field_1_1   // get_Name:    .field_1_1   // getName->1:  null   // getName->2:  null   // getName->N:  null   // ofs = -1 ord = 0 addr = 1
	invokeinterface interfacemethodref_142 // pc=1 guess=53
	astore_1 
	aload_1 
	ldc literal_524:"stream:features"
...
public final read2( com.whatsapp.client.FunXMPP$Login$XMPP ); // address: 0
	...
	enter 
	aload_0_getfield .field_1_1   // get_name_1:  .field_1_1   // get_name_2:  .field_1_1   // get_Name:    .field_1_1   // getName->1:  null   // getName->2:  null   // getName->N:  null   // ofs = -1 ord = 0 addr = 1
	invokeinterface interfacemethodref_142 // pc=1 guess=54
	astore_1 
	aload_1 
	ldc literal_536:"failure"
...
Label13:
	aload_1 
	ldc literal_533:"success"
	invokestatic require( com.whatsapp.client.FunXMPP$ProtocolTreeNode, java.lang.String ) // FunXMPP$ProtocolTreeNode
	aload_1 
	ldc literal_537:"expiration"
	...
	dup 
	ldc literal_538:"invalid expire date: "
...
Label39:
	aload_1 
	ldc literal_539:"kind"
	invokenonvirtual com.whatsapp.client.FunXMPP$ProtocolTreeNode.getAttributeValue // pc=2
	astore_3 
	ldc literal_540:"paid"
	aload_3 
...
Label62:
	aload_1 
	ldc literal_542:"status"
	invokenonvirtual com.whatsapp.client.FunXMPP$ProtocolTreeNode.getAttributeValue // pc=2
	astore_4 
	ldc literal_543:"expired"
	aload_4 
	invokevirtual_short .equals // idx=1 pc=2
	ifeq Label81
	new FunXMPP$LoginFailureException
...
Label81:
	...
	new_lib java.io.IOException//java.io.IOException java.io.IOException java.io.IOException
	dup 
	ldc literal_545:"active account with no expiration"
	invokespecial_lib java.io.IOException.<init> // pc=2
	athrow 
Label92:
	aload_0_getfield .field_3_3   // get_name_1:  .field_3_3   // get_name_2:  .field_3_3   // get_Name:    .field_3_3   // getName->1:  null   // getName->2:  null   // getName->N:  null   // ofs = -1 ord = 0 addr = 3
...
final java.lang.String read2Challenge( com.whatsapp.client.FunXMPP$Login$XMPP ); // address: 0
	...
	enter_narrow 
	aload_0_getfield .field_1_1   // get_name_1:  .field_1_1   // get_name_2:  .field_1_1   // get_Name:    .field_1_1   // getName->1:  null   // getName->2:  null   // getName->N:  null   // ofs = -1 ord = 0 addr = 1
	invokeinterface interfacemethodref_142 // pc=1 guess=55
	astore_1 
	aload_1 
	ldc literal_536:"failure"
	invokestatic boolean tagEquals( com.whatsapp.client.FunXMPP$ProtocolTreeNode, java.lang.String ) // FunXMPP$ProtocolTreeNode
...
final read3( com.whatsapp.client.FunXMPP$Login$XMPP ); // address: 0
	...
	enter_narrow 
	aload_0_getfield .field_1_1   // get_name_1:  .field_1_1   // get_name_2:  .field_1_1   // get_Name:    .field_1_1   // getName->1:  null   // getName->2:  null   // getName->N:  null   // ofs = -1 ord = 0 addr = 1
	invokeinterface interfacemethodref_139 // pc=1 guess=56
	aload_0_getfield .field_1_1   // get_name_1:  .field_1_1   // get_name_2:  .field_1_1   // get_Name:    .field_1_1   // getName->1:  null   // getName->2:  null   // getName->N:  null   // ofs = -1 ord = 0 addr = 1
	invokeinterface interfacemethodref_142 // pc=1 guess=57
	astore_1 
	aload_1 
	ldc literal_524:"stream:features"
	invokestatic require( com.whatsapp.client.FunXMPP$ProtocolTreeNode, java.lang.String ) // FunXMPP$ProtocolTreeNode
	aload_1 
	ldc literal_522:"receipt_acks"
...
final send1( com.whatsapp.client.FunXMPP$Login$XMPP ); // address: 0
	...
	invokeinterface interfacemethodref_138 // pc=3 guess=58
	return 
	}
...
final send2DigestMD5Mechanism( com.whatsapp.client.FunXMPP$Login$XMPP ); // address: 0
	...
	dup 
	ldc literal_526:"xmlns"
	ldc literal_527:"urn:ietf:params:xml:ns:xmpp-sasl"
	...
	aload_0_getfield .field_2_2   // get_name_1:  .field_2_2   // get_name_2:  .field_2_2   // get_Name:    .field_2_2   // getName->1:  null   // getName->2:  null   // getName->N:  null   // ofs = -1 ord = 0 addr = 2
	aload_1 
	invokeinterface interfacemethodref_141 // pc=2 guess=59
	return 
	}
...
final send2SASLResponse( com.whatsapp.client.FunXMPP$Login$XMPP, java.lang.String ); // address: 0
	...
	aload_0_getfield .field_2_2   // get_name_1:  .field_2_2   // get_name_2:  .field_2_2   // get_Name:    .field_2_2   // getName->1:  null   // getName->2:  null   // getName->N:  null   // ofs = -1 ord = 0 addr = 2
	aload_3 
	invokeinterface interfacemethodref_141 // pc=2 guess=60
	return 
	}
...
final send2UselessResponse( com.whatsapp.client.FunXMPP$Login$XMPP ); // address: 0
	...
	aload_0_getfield .field_2_2   // get_name_1:  .field_2_2   // get_name_2:  .field_2_2   // get_Name:    .field_2_2   // getName->1:  null   // getName->2:  null   // getName->N:  null   // ofs = -1 ord = 0 addr = 2
	aload_1 
	invokeinterface interfacemethodref_141 // pc=2 guess=61
	return 
	}
...
final send3( com.whatsapp.client.FunXMPP$Login$XMPP ); // address: 0
	...
	aload_0_getfield .field_3_3   // get_name_1:  .field_3_3   // get_name_2:  .field_3_3   // get_Name:    .field_3_3   // getName->1:  null   // getName->2:  null   // getName->N:  null   // ofs = -1 ord = 0 addr = 3
	getfield .field_1_1   // get_name_1:  .field_1_1   // get_name_2:  .field_1_1   // get_Name:    .field_1_1   // getName->1:  null   // getName->2:  null   // getName->N:  null   // ofs = -1 ord = 0 addr = 1
	invokeinterface interfacemethodref_138 // pc=3 guess=62
	return 
	}
...
Label25:
	...
	dup 
	ldc literal_526:"xmlns"
	ldc literal_551:"urn:ietf:params:xml:ns:xmpp-bind"
	invokespecial com.whatsapp.client.FunXMPP$KeyValue.<init> // pc=3
	aastore 
	bipush 2
	newarray_object FunXMPP$ProtocolTreeNode
	...
	aload_0_getfield .field_2_2   // get_name_1:  .field_2_2   // get_name_2:  .field_2_2   // get_Name:    .field_2_2   // getName->1:  null   // getName->2:  null   // getName->N:  null   // ofs = -1 ord = 0 addr = 2
	aload_5 
	invokeinterface interfacemethodref_141 // pc=2 guess=63
	return 
	}
...
final send5( com.whatsapp.client.FunXMPP$Login$XMPP ); // address: 0
	...
	dup 
	ldc literal_526:"xmlns"
	ldc literal_556:"urn:ietf:params:xml:ns:xmpp-session"
	invokespecial com.whatsapp.client.FunXMPP$KeyValue.<init> // pc=3
	aastore 
	invokespecial com.whatsapp.client.FunXMPP$ProtocolTreeNode.<init> // pc=3
	astore_1 
	...
	aload_0_getfield .field_2_2   // get_name_1:  .field_2_2   // get_name_2:  .field_2_2   // get_Name:    .field_2_2   // getName->1:  null   // getName->2:  null   // getName->N:  null   // ofs = -1 ord = 0 addr = 2
	aload_2 
	invokeinterface interfacemethodref_141 // pc=2 guess=64
	return 
	}
