...
Label16:
	...
	aload_3 
	invokeinterface interfacemethodref_51 // pc=2 guess=31
	ifnonnull Label16
	getstatic_lib module:WhatsApp-15.class#16.static_35 // class#16
	aload_3 
	aload_0 
	invokeinterface interfacemethodref_52 // pc=3 guess=32
	aload_0 
	aload_3 
...
public <init>( com.whatsapp.client.FunXMPP$FMessage, com.whatsapp.client.FunXMPP$FMessage$Key ); // address: 0
	...
	aload_1 
	aload_0 
	invokeinterface interfacemethodref_52 // pc=3 guess=33
	aload_2 
	monitorexit 
	return 
	astore_3 
...
Label3:
	aload_1 
	aload_0 
	invokeinterface interfacemethodref_53 // pc=2 guess=34
	return 
Label7:
	aload_1 
	aload_0 
	invokeinterface interfacemethodref_54 // pc=2 guess=35
	return 
Label11:
	aload_1 
	aload_0 
	invokeinterface interfacemethodref_55 // pc=2 guess=36
	return 
Label15:
	aload_1 
	aload_0 
...
Label19:
	aload_1 
	aload_0 
	invokeinterface interfacemethodref_57 // pc=2 guess=38
	return 
Label23:
	aload_1 
	aload_0 
	invokeinterface interfacemethodref_58 // pc=2 guess=39
	return 
Label27:
	aload_1 
	aload_0 
	invokeinterface interfacemethodref_59 // pc=2 guess=40
	return 
	}
