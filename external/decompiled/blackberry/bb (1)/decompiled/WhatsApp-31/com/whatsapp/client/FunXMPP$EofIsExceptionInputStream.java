...
public <init>( com.whatsapp.client.FunXMPP$EofIsExceptionInputStream, java.io.InputStream ); // address: 0
	...
	aload_0 
	aload_1 
	putfield inner   // get_name_1:  inner   // get_name_2:  inner   // get_Name:    inner   // getName->1:  inner   // getName->2:  inner   // getName->N:  inner   // ofs = 54412 ord = 0 addr = 0
	return 
	}
...
public final int read( com.whatsapp.client.FunXMPP$EofIsExceptionInputStream ); // address: 0
	{
	enter_narrow 
	aload_0_getfield inner   // get_name_1:  inner   // get_name_2:  inner   // get_Name:    inner   // getName->1:  inner   // getName->2:  inner   // getName->N:  inner   // ofs = 54412 ord = 0 addr = 0
