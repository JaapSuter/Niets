...

{
	...
	// @@@@@@@@@@@@@ Fields 
	final com.whatsapp.client. /*module:WhatsApp-28.class#0*/  _runtimeMessageStore ; // ofs = 54856 addr = 0)

	// @@@@@@@@@@@@@ Static routines 

public <init>( com.whatsapp.client.RuntimeMessageStore$ApplicationMessageReadableListAdapter, module:WhatsApp-28.class#0 ); // address: 0
	{
	enter_narrow 
	aload_0 
...
public final int getIndex( com.whatsapp.client.RuntimeMessageStore$ApplicationMessageReadableListAdapter, java.lang.Object ); // address: 0
	...
	enter_narrow 
	aload_1 
	checkcast_lib com.whatsapp.client.ChatHistory$ApplicationMessageAdapter//module:WhatsApp-9.class#18 module:WhatsApp-9.class#18 module:WhatsApp-9.class#18
	astore_2 
	aload_0_getfield .field_0_   // get_name_1:  .field_0_   // get_name_2:  .field_0_   // get_Name:    .field_0_   // getName->1:  null   // getName->2:  null   // getName->N:  null   // ofs = -1 ord = 0 addr = 0
	getfield .field_2_2   // get_name_1:  .field_2_2   // get_name_2:  .field_2_2   // get_Name:    .field_2_2   // getName->1:  null   // getName->2:  null   // getName->N:  null   // ofs = -1 ord = 0 addr = 2
	aload_2 
	invokenonvirtual_lib .routine_8485 // pc=1
