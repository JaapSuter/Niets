...
static public final int drawText( module:WhatsApp-14.class#21, net.rim.device.api.ui.Graphics, int, int, int, int, net.rim.device.api.ui.DrawTextParam ); // address: 0
	...
	enter 
	aload_0 
	invokeinterface interfacemethodref_96 // pc=1 guess=0
	astore_7 
	aload_0 
	invokeinterface interfacemethodref_97 // pc=1 guess=1
	istore 8
	aload_6 
	...
	astore 11
	aload_0 
	invokeinterface interfacemethodref_98 // pc=1 guess=2
	ifne Label36
	aload_0 
	invokeinterface interfacemethodref_99 // pc=1 guess=3
	ifne Label38
Label36:
	bipush -1
	goto Label46
Label38:
	aload_0 
	invokeinterface interfacemethodref_100 // pc=1 guess=4
	iload 8
	iadd 
	iload_2 
	iload 9
...
Label46:
	...
	aload_1 
	aload_0 
	invokeinterface interfacemethodref_101 // pc=1 guess=5
	...
	iload_5 
	aload_6 
	invokeinterface interfacemethodref_102 // pc=7 guess=6
	istore 15
	aload_1 
	iload 16
	invokevirtual setColor( net.rim.device.api.ui.Graphics, int ) // pc=2
