...
public <init>( com.whatsapp.client.ImagePickerInvoker$CachingThumbPicRowManager, java.lang.String, java.lang.String ); // address: 0
	...
	aload_0 
	iconst_0 
	putfield _hasFocus   // get_name_1:  _hasFocus   // get_name_2:  _hasFocus   // get_Name:    _hasFocus   // getName->1:  _hasFocus   // getName->2:  _hasFocus   // getName->N:  _hasFocus   // ofs = 52974 ord = 0 addr = 0
	aload_0 
	iconst_0 
	putfield _bmpSet   // get_name_1:  _bmpSet   // get_name_2:  _bmpSet   // get_Name:    _bmpSet   // getName->1:  _bmpSet   // getName->2:  _bmpSet   // getName->N:  _bmpSet   // ofs = 52982 ord = 2 addr = 0
	aload_0 
	aload_1 
	putfield _fullPath   // get_name_1:  _fullPath   // get_name_2:  _fullPath   // get_Name:    _fullPath   // getName->1:  _fullPath   // getName->2:  _fullPath   // getName->N:  _fullPath   // ofs = 52990 ord = 4 addr = 0
	aload_0 
	aload_2 
	putfield _filename   // get_name_1:  _filename   // get_name_2:  _filename   // get_Name:    _filename   // getName->1:  _filename   // getName->2:  _filename   // getName->N:  _filename   // ofs = 52994 ord = 5 addr = 0
	aload_1 
	...
	putfield _bmpFld   // get_name_1:  _bmpFld   // get_name_2:  _bmpFld   // get_Name:    _bmpFld   // getName->1:  _bmpFld   // getName->2:  _bmpFld   // getName->N:  _bmpFld   // ofs = 52978 ord = 1 addr = 0
	aload_0 
	iconst_1 
	putfield _bmpSet   // get_name_1:  _bmpSet   // get_name_2:  _bmpSet   // get_Name:    _bmpSet   // getName->1:  _bmpSet   // getName->2:  _bmpSet   // getName->N:  _bmpSet   // ofs = 52982 ord = 2 addr = 0
	goto Label43
...
Label43:
	aload_0 
	aload_0_getfield _bmpFld   // get_name_1:  _bmpFld   // get_name_2:  _bmpFld   // get_Name:    _bmpFld   // getName->1:  _bmpFld   // getName->2:  _bmpFld   // getName->N:  _bmpFld   // ofs = 52978 ord = 1 addr = 0
	...
	putfield _lblFld   // get_name_1:  _lblFld   // get_name_2:  _lblFld   // get_Name:    _lblFld   // getName->1:  _lblFld   // getName->2:  _lblFld   // getName->N:  _lblFld   // ofs = 52986 ord = 3 addr = 0
	aload_0_getfield _lblFld   // get_name_1:  _lblFld   // get_name_2:  _lblFld   // get_Name:    _lblFld   // getName->1:  _lblFld   // getName->2:  _lblFld   // getName->N:  _lblFld   // ofs = 52986 ord = 3 addr = 0
	bipush 2
	bipush 2
	bipush 2
	bipush 2
...
private final com.whatsapp.client.ImagePickerInvoker$CachingThumbPicRowManager.routine_1094( com.whatsapp.client.ImagePickerInvoker$CachingThumbPicRowManager ); // address: 0
	{
	enter 
	aload_0 
...
public final paint( com.whatsapp.client.ImagePickerInvoker$CachingThumbPicRowManager, net.rim.device.api.ui.Graphics ); // address: 0
	{
	enter_narrow 
	aload_0_getfield _bmpSet   // get_name_1:  _bmpSet   // get_name_2:  _bmpSet   // get_Name:    _bmpSet   // getName->1:  _bmpSet   // getName->2:  _bmpSet   // getName->N:  _bmpSet   // ofs = 52982 ord = 2 addr = 0
	ifne Label6
	aload_0 
	iconst_1 
	invokestatic enqueue( com.whatsapp.client.ImagePickerInvoker$CachingThumbPicRowManager, boolean ) // ImagePickerInvoker$CachingThumbPicRowManager$AsyncLoader
...
Label14:
	...
	aload_0 
	invokespecial com.whatsapp.client.ImagePickerInvoker$CachingThumbPicRowManager.routine_1094 // pc=1
	return 
	}
...
protected final onDisplay( com.whatsapp.client.ImagePickerInvoker$CachingThumbPicRowManager ); // address: 0
	{
	jumpspecial_lib onDisplay( net.rim.device.api.ui.Manager )
	}
