...
static public final boolean imageNeedsRotate( net.rim.device.api.system.EncodedImage ); // address: 0
	...
	ldc literal_299:"6"
	aload_1 
	ldc literal_300:"orientation"
	invokeinterface interfacemethodref_53 // pc=2 guess=3
	invokevirtual_short .equals // idx=1 pc=2
	istore_2 
	iload_2 
	ireturn 
...
Label14:
	...
	ifnull Label42
	aload_2 
	invokeinterface interfacemethodref_52 // pc=1 guess=9
	iload_1 
	ireturn 
	astore_3 
	iload_1 
...
static private final java.lang.String com.whatsapp.client.MediaData.routine_2503( java.lang.String ); // address: 0
	...
	astore_1 
	aload_1 
	invokeinterface interfacemethodref_54 // pc=1 guess=10
	ifne Label21
	aload_1 
	invokeinterface interfacemethodref_57 // pc=1 guess=11
Label21:
	aload_2 
	astore_0 
	aload_1 
	ifnull Label52
	aload_1 
	invokeinterface interfacemethodref_52 // pc=1 guess=12
	aload_0 
	areturn 
	astore_2 
	aload_0 
...
public final boolean bufferFile( com.whatsapp.client.MediaData ); // address: 0
	...
	astore_1 
	aload_1 
	invokeinterface interfacemethodref_50 // pc=1 guess=0
	astore_2 
	aload_0 
	aload_1 
	invokeinterface interfacemethodref_51 // pc=1 guess=1
	l2i 
	putfield .field_7_7   // get_name_1:  .field_7_7   // get_name_2:  .field_7_7   // get_Name:    .field_7_7   // getName->1:  null   // getName->2:  null   // getName->N:  null   // ofs = -1 ord = 0 addr = 7
	aload_0 
	aload_0_getfield .field_7_7   // get_name_1:  .field_7_7   // get_name_2:  .field_7_7   // get_Name:    .field_7_7   // getName->1:  null   // getName->2:  null   // getName->N:  null   // ofs = -1 ord = 0 addr = 7
...
Label36:
	...
	ifnull Label42
	aload_1 
	invokeinterface interfacemethodref_52 // pc=1 guess=2
	goto Label42
	astore_5 
Label42:
	iload_4 
...
public final boolean saveFile( com.whatsapp.client.MediaData, java.lang.String, java.lang.String, boolean ); // address: 0
	...
	dup 
	ldc literal_297:"Cannot save files on the event dispatch thread"
...
Label101:
	...
	astore 8
	aload 8
	invokeinterface interfacemethodref_54 // pc=1 guess=4
	ifeq Label128
	aload 8
	invokeinterface interfacemethodref_52 // pc=1 guess=5
	goto Label124
	astore 12
Label124:
	aload 10
...
Label128:
	aload 8
	invokeinterface interfacemethodref_55 // pc=1 guess=6
	aload 8
	invokeinterface interfacemethodref_56 // pc=1 guess=7
	astore 9
	aload 9
	aload_0_getfield .field_6_6   // get_name_1:  .field_6_6   // get_name_2:  .field_6_6   // get_Name:    .field_6_6   // getName->1:  null   // getName->2:  null   // getName->N:  null   // ofs = -1 ord = 0 addr = 6
	aload_0_getfield .field_8_8   // get_name_1:  .field_8_8   // get_name_2:  .field_8_8   // get_Name:    .field_8_8   // getName->1:  null   // getName->2:  null   // getName->N:  null   // ofs = -1 ord = 0 addr = 8
...
Label22:
	...
	ifeq Label30
	aload_5 
	invokeinterface interfacemethodref_60 // pc=1 guess=15
...
Label30:
	...
	ifnull Label54
	aload_4 
	invokeinterface interfacemethodref_52 // pc=1 guess=16
	goto Label54
	astore_5 
	goto Label54
	astore_5 
