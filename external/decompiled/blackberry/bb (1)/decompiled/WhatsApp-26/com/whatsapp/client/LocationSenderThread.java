...
Label40:
	...
	ifnull Label46
	aload_4 
	invokeinterface interfacemethodref_74 // pc=1 guess=3
	goto Label46
	astore 11
Label46:
	aload 10
...
Label48:
	...
	astore_4 
	aload_4 
	invokeinterface interfacemethodref_75 // pc=1 guess=4
	istore_6 
	iload_6 
	sipush 200
	if_icmpeq Label78
	...
	new_lib net.rim.device.api.ui.XYRect//net.rim.device.api.ui.XYRect net.rim.device.api.ui.XYRect net.rim.device.api.ui.XYRect
	dup 
	ldc literal_381:"HTTP response code: "
...
Label78:
	aload_4 
	invokeinterface interfacemethodref_76 // pc=1 guess=5
	astore_5 
	iconst_0 
	istore 10
	iconst_0 
...
static final <clinit>(  ); // address: 0
	...
	clinit_wait 
	ldc literal_382:"http://maps.google.com/maps/api/staticmap?center={0},{1}&zoom=15&size=200x200&sensor=true&format=jpg&mobile=true&markers=color:red|size:mid|{0},{1}"
...
private final boolean com.whatsapp.client.LocationSenderThread.routine_3180( com.whatsapp.client.LocationSenderThread, javax.microedition.location.Criteria ); // address: 0
	...
	dup 
	ldc literal_380:"no location provider for this gps criteria."
...
Label15:
	...
	invokeinterface interfacemethodref_72 // pc=2 guess=0
Label20:
	aload_2 
	monitorexit 
	return 
...
Label100:
	...
	aload 8
	invokeinterface interfacemethodref_73 // pc=2 guess=1
	aload 9
	monitorexit 
	goto Label115
	astore 10
