...
Label8:
	...
	astore_3 
	aload_3 
	invokeinterface interfacemethodref_93 // pc=1 guess=0
	istore_4 
Label26:
	aload_3 
	invokeinterface interfacemethodref_93 // pc=1 guess=0
	ifeq Label59
	aload_3 
	invokeinterface interfacemethodref_94 // pc=1 guess=1
	...
	aload_6 
	aload_5 
	invokeinterface interfacemethodref_95 // pc=3 guess=2
	astore_7 
	aload_7 
	ifnull Label53
	aload_0_getfield .field_0_   // get_name_1:  .field_0_   // get_name_2:  .field_0_   // get_Name:    .field_0_   // getName->1:  null   // getName->2:  null   // getName->N:  null   // ofs = -1 ord = 0 addr = 0
...
Label67:
	...
	aload_6 
	aload_5 
	invokeinterface interfacemethodref_96 // pc=3 guess=3
	astore_7 
	aload_7 
	ifnonnull Label85
	goto_w Label8
