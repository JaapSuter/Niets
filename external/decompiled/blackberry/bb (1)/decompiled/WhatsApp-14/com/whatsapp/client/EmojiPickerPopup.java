...
public <init>( com.whatsapp.client.EmojiPickerPopup ); // address: 0
	...
	enter 
	aload_0 
	new_lib com.whatsapp.client.//module:WhatsApp-15.class#0 module:WhatsApp-15.class#0 module:WhatsApp-15.class#0
	dup 
	invokespecial_lib .routine_248 // pc=1
	iconst_0 
	i2l 
	...
	checkcast_lib com.whatsapp.client.EmojiPickerPopup$EmojiVerticalFieldManager//module:WhatsApp-15.class#0 module:WhatsApp-15.class#0 module:WhatsApp-15.class#0
	aload_0 
	...
	invokespecial_lib .routine_1583 // pc=3
	putfield _title   // get_name_1:  _title   // get_name_2:  _title   // get_Name:    _title   // getName->1:  _title   // getName->2:  _title   // getName->N:  _title   // ofs = 54242 ord = 0 addr = 0
	aload_0_getfield _title   // get_name_1:  _title   // get_name_2:  _title   // get_Name:    _title   // getName->1:  _title   // getName->2:  _title   // getName->N:  _title   // ofs = 54242 ord = 0 addr = 0
	iconst_0 
	iconst_0 
	iconst_0 
	iconst_0 
	...
	invokespecial_lib .routine_3991 // pc=3
	putfield _flowFieldManager   // get_name_1:  _flowFieldManager   // get_name_2:  _flowFieldManager   // get_Name:    _flowFieldManager   // getName->1:  _flowFieldManager   // getName->2:  _flowFieldManager   // getName->N:  _flowFieldManager   // ofs = 54246 ord = 1 addr = 0
	aload_0 
	aload_0_getfield _title   // get_name_1:  _title   // get_name_2:  _title   // get_Name:    _title   // getName->1:  _title   // getName->2:  _title   // getName->N:  _title   // ofs = 54242 ord = 0 addr = 0
	invokevirtual add( net.rim.device.api.ui.Screen, net.rim.device.api.ui.Field ) // pc=2
	aload_0 
	aload_0_getfield _flowFieldManager   // get_name_1:  _flowFieldManager   // get_name_2:  _flowFieldManager   // get_Name:    _flowFieldManager   // getName->1:  _flowFieldManager   // getName->2:  _flowFieldManager   // getName->N:  _flowFieldManager   // ofs = 54246 ord = 1 addr = 0
	invokevirtual add( net.rim.device.api.ui.Screen, net.rim.device.api.ui.Field ) // pc=2
	aload_0 
	getstatic _lastPageSelection // EmojiPickerPopup
	putfield _currentPage   // get_name_1:  _currentPage   // get_name_2:  _currentPage   // get_Name:    _currentPage   // getName->1:  _currentPage   // getName->2:  _currentPage   // getName->N:  _currentPage   // ofs = 54250 ord = 2 addr = 0
	aload_0 
...
static final <clinit>(  ); // address: 0
	{
	enter 
	clinit_lib java.io.IOException//java.io.IOException java.io.IOException java.io.IOException
	...
	invokestatic_lib module:WhatsApp-27.class#28.routine_5758(  ) // class#28
	aastore 
	putstatic com.whatsapp.client.EmojiPickerPopup.field_54270 // EmojiPickerPopup
	op01xx 
	stringarrayinit [?????????????????????????????????????????????????????????????????????????????????????????????????????????????, ?????????????????????????????????????????????????????, ???????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????????, ??????????????????????????????????????????????????????????????????????]
	putstatic com.whatsapp.client.EmojiPickerPopup.field_54276 // EmojiPickerPopup
	clinit_return 
	}

	// @@@@@@@@@@@@@ Non-virtual routines 

private final com.whatsapp.client.BitmapButtonField com.whatsapp.client.EmojiPickerPopup.routine_5378( com.whatsapp.client.EmojiPickerPopup, char, int ); // address: 0
	{
	enter 
	...
	iload_1 
	iload_2 
	invokestatic_lib module:WhatsApp-15.class#1.routine_1772(  ) // class#1
...
private final updateButtons( com.whatsapp.client.EmojiPickerPopup, char ); // address: 0
	{
	enter 
	getstatic com.whatsapp.client.EmojiPickerPopup.field_54270 // EmojiPickerPopup
	aload_0_getfield _currentPage   // get_name_1:  _currentPage   // get_name_2:  _currentPage   // get_Name:    _currentPage   // getName->1:  _currentPage   // getName->2:  _currentPage   // getName->N:  _currentPage   // ofs = 54250 ord = 2 addr = 0
	aaload 
	astore_2 
	getstatic com.whatsapp.client.EmojiPickerPopup.field_54276 // EmojiPickerPopup
	aload_0_getfield _currentPage   // get_name_1:  _currentPage   // get_name_2:  _currentPage   // get_Name:    _currentPage   // getName->1:  _currentPage   // getName->2:  _currentPage   // getName->N:  _currentPage   // ofs = 54250 ord = 2 addr = 0
	aaload 
	astore_3 
	aload_0_getfield _title   // get_name_1:  _title   // get_name_2:  _title   // get_Name:    _title   // getName->1:  _title   // getName->2:  _title   // getName->N:  _title   // ofs = 54242 ord = 0 addr = 0
	aload_2 
	invokenonvirtual_lib .routine_881 // pc=2
	aload_0_getfield _title   // get_name_1:  _title   // get_name_2:  _title   // get_Name:    _title   // getName->1:  _title   // getName->2:  _title   // getName->N:  _title   // ofs = 54242 ord = 0 addr = 0
	getstatic com.whatsapp.client.EmojiPickerPopup.field_54270 // EmojiPickerPopup
	aload_0 
	bipush -1
	...
	aaload 
	invokenonvirtual_lib .routine_901 // pc=2
	aload_0_getfield _title   // get_name_1:  _title   // get_name_2:  _title   // get_Name:    _title   // getName->1:  _title   // getName->2:  _title   // getName->N:  _title   // ofs = 54242 ord = 0 addr = 0
	getstatic com.whatsapp.client.EmojiPickerPopup.field_54270 // EmojiPickerPopup
	aload_0 
	iconst_1 
	invokespecial com.whatsapp.client.EmojiPickerPopup.getRelativePage // pc=2
	aaload 
	invokenonvirtual_lib .routine_921 // pc=2
	aload_0_getfield _flowFieldManager   // get_name_1:  _flowFieldManager   // get_name_2:  _flowFieldManager   // get_Name:    _flowFieldManager   // getName->1:  _flowFieldManager   // getName->2:  _flowFieldManager   // getName->N:  _flowFieldManager   // ofs = 54246 ord = 1 addr = 0
...
Label33:
	...
	iload_6 
	bipush 48
	invokespecial com.whatsapp.client.EmojiPickerPopup.routine_5378 // pc=3
	astore_7 
	aload_0_getfield _flowFieldManager   // get_name_1:  _flowFieldManager   // get_name_2:  _flowFieldManager   // get_Name:    _flowFieldManager   // getName->1:  _flowFieldManager   // getName->2:  _flowFieldManager   // getName->N:  _flowFieldManager   // ofs = 54246 ord = 1 addr = 0
	aload_7 
...
public final setClickHandler( com.whatsapp.client.EmojiPickerPopup, module:WhatsApp-13.class#8 ); // address: 0
	{
	putfield_return _handler   // get_name_1:  _handler   // get_name_2:  _handler   // get_Name:    _handler   // getName->1:  _handler   // getName->2:  _handler   // getName->N:  _handler   // ofs = 54254 ord = 3 addr = 0
	}
...
public final fieldChanged( com.whatsapp.client.EmojiPickerPopup, net.rim.device.api.ui.Field, int ); // address: 0
	{
	enter 
	aload_0_getfield _handler   // get_name_1:  _handler   // get_name_2:  _handler   // get_Name:    _handler   // getName->1:  _handler   // getName->2:  _handler   // getName->N:  _handler   // ofs = 54254 ord = 3 addr = 0
	ifnull Label22
	aload_1 
...
Label54:
	...
	aload_4 
	iload_6 
	invokenonvirtual_lib .routine_3851 // pc=2
Label61:
	aload_0 
	iload_1 
	iload_3 
