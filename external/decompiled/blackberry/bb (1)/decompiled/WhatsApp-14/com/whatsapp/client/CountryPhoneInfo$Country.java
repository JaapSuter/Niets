...

{
	...
	// @@@@@@@@@@@@@ Fields 
	public String /*java.lang.String*/  isoCode ; // ofs = 53248 addr = 0)
	public String /*java.lang.String*/  name ; // ofs = 53252 addr = 0)
	public int /*int*/  countryCode ; // ofs = 53256 addr = 0)
	public java.util.Vector /*java.util.Vector*/  mccVector ; // ofs = 53260 addr = 0)
	public net.rim.device.api.util.IntVector /*net.rim.device.api.util.IntVector*/  lengthsVector ; // ofs = 53264 addr = 0)
	public net.rim.device.api.util.IntVector /*net.rim.device.api.util.IntVector*/  trimsVector ; // ofs = 53268 addr = 0)
	public boolean /*boolean*/  leadingZeroAllowed ; // ofs = 53272 addr = 0)
...
public final boolean hasMcc( com.whatsapp.client.CountryPhoneInfo$Country, int ); // address: 0
	...
	invokestatic_lib module:WhatsApp-32.class#2.routine_3276(  ) // class#2
	astore_2 
	aload_0_getfield .field_3_3   // get_name_1:  .field_3_3   // get_name_2:  .field_3_3   // get_Name:    .field_3_3   // getName->1:  null   // getName->2:  null   // getName->N:  null   // ofs = -1 ord = 0 addr = 3
	aload_2 
