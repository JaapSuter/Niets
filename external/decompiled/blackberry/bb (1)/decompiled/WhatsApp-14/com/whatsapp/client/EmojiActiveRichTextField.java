...

{
	...
	// @@@@@@@@@@@@@ Fields 
	private int /*int*/  field_54110 ; // ofs = 54110 addr = 0)
...
private final int[] com.whatsapp.client.EmojiActiveRichTextField.routine_4421( com.whatsapp.client.EmojiActiveRichTextField, java.lang.String ); // address: 0
	{
	enter 
...
private final java.lang.String com.whatsapp.client.EmojiActiveRichTextField.routine_4542( com.whatsapp.client.EmojiActiveRichTextField, java.lang.String ); // address: 0
	{
	enter 
...
private final int com.whatsapp.client.EmojiActiveRichTextField.routine_4605( com.whatsapp.client.EmojiActiveRichTextField, int, int ); // address: 0
	{
	enter 
	aload_0 
	...
	dup 
	ldc literal_52:"Direction must be 1 or -1"
...
private final com.whatsapp.client.EmojiActiveRichTextField.routine_4682( com.whatsapp.client.EmojiActiveRichTextField ); // address: 0
	{
	enter 
	aload_0 
	...
	ifeq Label11
	iload_1 
	aload_0_getfield com.whatsapp.client.EmojiActiveRichTextField.field_54110   // get_name_1:  com.whatsapp.client.EmojiActiveRichTextField.field_54110   // get_name_2:  com.whatsapp.client.EmojiActiveRichTextField.field_54110   // get_Name:    com.whatsapp.client.EmojiActiveRichTextField.field_54110   // getName->1:     // getName->2:     // getName->N:     // ofs = 54110 ord = 0 addr = 0
	if_icmpne Label11
	return 
Label11:
	aload_0 
...
Label20:
	...
	iload_1 
	iload_2 
	invokespecial com.whatsapp.client.EmojiActiveRichTextField.routine_4605 // pc=3
	iadd 
	istore_3 
	aload_0 
	iload_3 
...
private final com.whatsapp.client.EmojiActiveRichTextField.routine_4747( com.whatsapp.client.EmojiActiveRichTextField, net.rim.device.api.system.Clipboard ); // address: 0
	{
	enter_narrow 
	aload_1 
...
public final setText( com.whatsapp.client.EmojiActiveRichTextField, java.lang.String ); // address: 0
	...
	aload_0 
	aload_1 
	invokespecial com.whatsapp.client.EmojiActiveRichTextField.routine_4542 // pc=2
	astore_2 
	iconst_1 
	...
	aload_0 
	aload_2 
	invokespecial com.whatsapp.client.EmojiActiveRichTextField.routine_4421 // pc=2
	astore_4 
	aload_4 
	arraylength 
	iconst_1 
...
protected final onFocus( com.whatsapp.client.EmojiActiveRichTextField, int ); // address: 0
	{
	jumpspecial_lib onFocus( net.rim.device.api.ui.component.TextField, int )
	}


protected final boolean keyChar( com.whatsapp.client.EmojiActiveRichTextField, char, int, int ); // address: 0
	{
	jumpspecial_lib boolean keyChar( net.rim.device.api.ui.component.RichTextField, char, int, int )
	}
...
public final selectionCopy( com.whatsapp.client.EmojiActiveRichTextField, net.rim.device.api.system.Clipboard ); // address: 0
	...
	enter_narrow 
	aload_0 
	invokespecial com.whatsapp.client.EmojiActiveRichTextField.routine_4682 // pc=1
	aload_0 
	aload_1 
	invokespecial_lib net.rim.device.api.ui.component.ActiveRichTextField.selectionCopy // pc=2
	aload_0 
	aload_1 
	invokespecial com.whatsapp.client.EmojiActiveRichTextField.routine_4747 // pc=2
	return 
	}
...
public final select( com.whatsapp.client.EmojiActiveRichTextField, boolean ); // address: 0
	...
	invokespecial com.whatsapp.client.EmojiActiveRichTextField.routine_4605 // pc=3
	iadd 
	putfield com.whatsapp.client.EmojiActiveRichTextField.field_54110   // get_name_1:  com.whatsapp.client.EmojiActiveRichTextField.field_54110   // get_name_2:  com.whatsapp.client.EmojiActiveRichTextField.field_54110   // get_Name:    com.whatsapp.client.EmojiActiveRichTextField.field_54110   // getName->1:     // getName->2:     // getName->N:     // ofs = 54110 ord = 0 addr = 0
	aload_0 
	aload_0_getfield com.whatsapp.client.EmojiActiveRichTextField.field_54110   // get_name_1:  com.whatsapp.client.EmojiActiveRichTextField.field_54110   // get_name_2:  com.whatsapp.client.EmojiActiveRichTextField.field_54110   // get_Name:    com.whatsapp.client.EmojiActiveRichTextField.field_54110   // getName->1:     // getName->2:     // getName->N:     // ofs = 54110 ord = 0 addr = 0
	iconst_0 
	invokenonvirtual com.whatsapp.client.EmojiActiveRichTextField.setCursorPosition // pc=3
