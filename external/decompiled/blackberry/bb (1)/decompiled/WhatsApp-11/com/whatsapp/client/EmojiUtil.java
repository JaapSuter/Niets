...
static public final int drawText( module:WhatsApp-14.class#21, net.rim.device.api.ui.Graphics, int, int, int, int, net.rim.device.api.ui.DrawTextParam ); // address: 0
	...
	enter 
	aload_0 
	invokeinterface interfacemethodref_60 // pc=1 guess=0
	astore_7 
	aload_0 
	invokeinterface interfacemethodref_61 // pc=1 guess=1
	istore 8
	aload_6 
	...
	astore 11
	aload_0 
	invokeinterface interfacemethodref_62 // pc=1 guess=2
	ifne Label36
	aload_0 
	invokeinterface interfacemethodref_63 // pc=1 guess=3
	ifne Label38
Label36:
	bipush -1
	goto Label46
...
Label46:
	...
	iload_5 
	aload_6 
	invokeinterface interfacemethodref_66 // pc=7 guess=6
	istore 15
	aload_1 
	iload 16
	invokevirtual setColor( net.rim.device.api.ui.Graphics, int ) // pc=2
