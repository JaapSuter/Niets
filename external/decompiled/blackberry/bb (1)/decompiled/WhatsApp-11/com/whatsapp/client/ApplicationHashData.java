...
{
	// @@@@@@@@@@@@@ Static fields 
	private final static String /*java.lang.String*/  field_54622 ; // ofs = 54622 addr = 21)
	private final static long /*long*/  field_54628 ; // ofs = 54628 addr = 22)
	private final static long /*long*/  field_54634 ; // ofs = 54634 addr = 24)
...
Label15:
	invokespecial com.whatsapp.client.ApplicationHashData.routine_3013 // pc=3
	return 
	}


static public final saveModified( module:WhatsApp-26.class#11, com.whatsapp.client.ApplicationHashData ); // address: 0
	{
	enter_narrow 
	aload_1 
...
static final <clinit>(  ); // address: 0
	...
	clinit_wait 
	invokestatic_lib module:WhatsApp-10.class#4.routine_2824(  ) // class#4
	putstatic com.whatsapp.client.ApplicationHashData.field_54622 // ApplicationHashData
	invokestatic_lib long currentTimeMillis(  ) // System
	lputstatic com.whatsapp.client.ApplicationHashData.field_54628 // ApplicationHashData
	lgetstatic com.whatsapp.client.ApplicationHashData.field_54628 // ApplicationHashData
	iipush 518400000
	i2l 
	lsub 
	lputstatic com.whatsapp.client.ApplicationHashData.field_54634 // ApplicationHashData
	clinit_return 
	}

	// @@@@@@@@@@@@@ Non-virtual routines 

private final com.whatsapp.client.ApplicationHashData.routine_3013( com.whatsapp.client.ApplicationHashData, java.lang.String, java.lang.String ); // address: 0
	{
	jumpspecial com.whatsapp.client.ApplicationHashData.routine_3025( com.whatsapp.client.ApplicationHashData, java.lang.String, java.lang.Object )
	}


private final com.whatsapp.client.ApplicationHashData.routine_3025( com.whatsapp.client.ApplicationHashData, java.lang.String, java.lang.Object ); // address: 0
	{
	enter_narrow 
	aload_2 
	ifnonnull Label8
...
private final java.lang.String com.whatsapp.client.ApplicationHashData.routine_3062( com.whatsapp.client.ApplicationHashData, java.lang.String, java.lang.String ); // address: 0
	{
	enter 
	aload_0_getfield .field_0_   // get_name_1:  .field_0_   // get_name_2:  .field_0_   // get_Name:    .field_0_   // getName->1:  null   // getName->2:  null   // getName->N:  null   // ofs = -1 ord = 0 addr = 0
	aload_1 
...
private final com.whatsapp.client.ApplicationHashData.routine_3094( com.whatsapp.client.ApplicationHashData, java.lang.String, boolean ); // address: 0
	{
	enter 
	aload_0 
	aload_1 
	...
	invokespecial com.whatsapp.client.ApplicationHashData.routine_3025 // pc=3
	return 
	}


private final boolean com.whatsapp.client.ApplicationHashData.routine_3126( com.whatsapp.client.ApplicationHashData, java.lang.String, boolean ); // address: 0
	{
	enter 
	aload_0_getfield .field_0_   // get_name_1:  .field_0_   // get_name_2:  .field_0_   // get_Name:    .field_0_   // getName->1:  null   // getName->2:  null   // getName->N:  null   // ofs = -1 ord = 0 addr = 0
	aload_1 
...
private final com.whatsapp.client.ApplicationHashData.routine_3157( com.whatsapp.client.ApplicationHashData, java.lang.String, byte[] ); // address: 0
	{
	jumpspecial com.whatsapp.client.ApplicationHashData.routine_3025( com.whatsapp.client.ApplicationHashData, java.lang.String, java.lang.Object )
	}


private final com.whatsapp.client.ApplicationHashData.routine_3174( com.whatsapp.client.ApplicationHashData, java.lang.String, int ); // address: 0
	{
	enter 
	aload_0 
	aload_1 
...
private final int com.whatsapp.client.ApplicationHashData.routine_3206( com.whatsapp.client.ApplicationHashData, java.lang.String, int ); // address: 0
	{
	enter 
	aload_0_getfield .field_0_   // get_name_1:  .field_0_   // get_name_2:  .field_0_   // get_Name:    .field_0_   // getName->1:  null   // getName->2:  null   // getName->N:  null   // ofs = -1 ord = 0 addr = 0
	aload_1 
...
private final com.whatsapp.client.ApplicationHashData.routine_3242( com.whatsapp.client.ApplicationHashData, java.lang.String, long ); // address: 0
	{
	enter 
	aload_0 
	aload_1 
...
private final long com.whatsapp.client.ApplicationHashData.routine_3275( com.whatsapp.client.ApplicationHashData, java.lang.String, long ); // address: 0
	{
	enter 
	aload_0_getfield .field_0_   // get_name_1:  .field_0_   // get_name_2:  .field_0_   // get_Name:    .field_0_   // getName->1:  null   // getName->2:  null   // getName->N:  null   // ofs = -1 ord = 0 addr = 0
	aload_1 
...
public final boolean isAutosaveMedia( com.whatsapp.client.ApplicationHashData ); // address: 0
	...
	enter_narrow 
	aload_0 
	ldc literal_706:"AUTOSAVE_MEDIA"
	iconst_1 
	invokespecial com.whatsapp.client.ApplicationHashData.routine_3126 // pc=3
	ireturn 
	}
...
public final setAutosaveMedia( com.whatsapp.client.ApplicationHashData, boolean ); // address: 0
	...
	ldc literal_706:"AUTOSAVE_MEDIA"
	iload_1 
	invokespecial com.whatsapp.client.ApplicationHashData.routine_3094 // pc=3
	return 
	}
...
public final setApplicationLocked( com.whatsapp.client.ApplicationHashData, boolean ); // address: 0
	...
	enter_narrow 
	aload_0 
	ldc literal_707:"APPLICATION_LOCKED"
	iload_1 
	invokespecial com.whatsapp.client.ApplicationHashData.routine_3094 // pc=3
	return 
	}
...
public final java.lang.String getChatUserID( com.whatsapp.client.ApplicationHashData ); // address: 0
	...
	enter_narrow 
	aload_0 
	ldc literal_708:"CHAT_USER_ID"
	getstatic_lib module:WhatsApp-12.class#0.static_156 // class#0
	invokespecial com.whatsapp.client.ApplicationHashData.routine_3062 // pc=3
	areturn 
	}
...
public final setContactsToShow( com.whatsapp.client.ApplicationHashData, int ); // address: 0
	...
	enter_narrow 
	aload_0 
	ldc literal_709:"CONTACTS_TO_SHOW"
	iload_1 
...
public final setLastStatusChangeTimestamp( com.whatsapp.client.ApplicationHashData, long ); // address: 0
	...
	enter 
	aload_0 
	ldc literal_711:"LAST_STATUS_CHANGE_TIMESTAMP"
	lload 1
	invokespecial com.whatsapp.client.ApplicationHashData.routine_3242 // pc=4
	return 
	}
...
public final setNetworkAccessPermission( com.whatsapp.client.ApplicationHashData, boolean ); // address: 0
	...
	enter_narrow 
	aload_0 
	ldc literal_712:"NETWORK_ACCESS_PERMISSION"
	iload_1 
	invokespecial com.whatsapp.client.ApplicationHashData.routine_3094 // pc=3
	return 
	}
...
public final setShowStatusAutomatorWelcome( com.whatsapp.client.ApplicationHashData, boolean ); // address: 0
	...
	enter_narrow 
	aload_0 
	ldc literal_713:"SHOW_STATUS_AUTOMATOR_WELCOME"
	iload_1 
	invokespecial com.whatsapp.client.ApplicationHashData.routine_3094 // pc=3
	return 
	}
...
public final setSubmitStatusOnSave( com.whatsapp.client.ApplicationHashData, boolean ); // address: 0
	...
	enter_narrow 
	aload_0 
	ldc literal_714:"SUBMIT_STATUS_ON_SAVE"
	iload_1 
	invokespecial com.whatsapp.client.ApplicationHashData.routine_3094 // pc=3
	return 
	}
...
public final boolean isWelcomeScreenShown( com.whatsapp.client.ApplicationHashData ); // address: 0
	...
	enter_narrow 
	aload_0 
	ldc literal_715:"WELCOME_SCREEN_SHOWN"
	iconst_0 
	invokespecial com.whatsapp.client.ApplicationHashData.routine_3126 // pc=3
	ireturn 
	}
...
public final setInstallTimestamp( com.whatsapp.client.ApplicationHashData, long ); // address: 0
	...
	enter 
	aload_0 
	ldc literal_718:"INSTALL_TIMESTAMP"
	lload 1
	invokespecial com.whatsapp.client.ApplicationHashData.routine_3242 // pc=4
	return 
	}
...
public final boolean isUseSystemMessagesFolder( com.whatsapp.client.ApplicationHashData ); // address: 0
	...
	enter_narrow 
	aload_0 
	ldc literal_721:"USE_SYSTEM_MESSAGES_FOLDER"
	iconst_1 
	invokespecial com.whatsapp.client.ApplicationHashData.routine_3126 // pc=3
	ireturn 
	}
...
public final boolean isUseMessagePreview( com.whatsapp.client.ApplicationHashData ); // address: 0
	...
	enter_narrow 
	aload_0 
	ldc literal_723:"USE_MESSAGE_PREVIEW"
	iconst_1 
	invokespecial com.whatsapp.client.ApplicationHashData.routine_3126 // pc=3
	ireturn 
	}
...
public final long getLastAlertStamp( com.whatsapp.client.ApplicationHashData ); // address: 0
	...
	enter 
	aload_0 
	ldc literal_724:"LAST_ALERT_STAMP"
	iconst_0 
	i2l 
	invokespecial com.whatsapp.client.ApplicationHashData.routine_3275 // pc=4
	lreturn 
	}
...
public final int getLastAlertItem( com.whatsapp.client.ApplicationHashData ); // address: 0
	...
	enter_narrow 
	aload_0 
	ldc literal_725:"LAST_ALERT_ITEM"
	bipush -1
	invokespecial com.whatsapp.client.ApplicationHashData.routine_3206 // pc=3
	ireturn 
	}
...
public final java.lang.String getLastVersionRunAs( com.whatsapp.client.ApplicationHashData ); // address: 0
	...
	enter_narrow 
	aload_0 
	ldc literal_726:"LAST_VERSION_RUN_AS"
	getstatic_lib module:WhatsApp-12.class#0.static_156 // class#0
	invokespecial com.whatsapp.client.ApplicationHashData.routine_3062 // pc=3
	areturn 
	}
...
public final setLastIMSI( com.whatsapp.client.ApplicationHashData, byte[] ); // address: 0
	...
	enter_narrow 
	aload_0 
	ldc literal_727:"LAST_IMSI"
	aload_1 
	invokespecial com.whatsapp.client.ApplicationHashData.routine_3157 // pc=3
	return 
	}
...
public final java.lang.String getFilesystemRoot( com.whatsapp.client.ApplicationHashData ); // address: 0
	...
	enter_narrow 
	aload_0 
	ldc literal_728:"FILESYSTEM_ROOT"
	getstatic com.whatsapp.client.ApplicationHashData.field_54622 // ApplicationHashData
	invokespecial com.whatsapp.client.ApplicationHashData.routine_3062 // pc=3
	areturn 
	}
...
public final boolean isGoogleMapsDefault( com.whatsapp.client.ApplicationHashData ); // address: 0
	...
	enter_narrow 
	aload_0 
	ldc literal_729:"GOOGLE_MAPS_DEFAULT"
	iconst_0 
	invokespecial com.whatsapp.client.ApplicationHashData.routine_3126 // pc=3
	ireturn 
	}
...
public final long getJidMuteTime( com.whatsapp.client.ApplicationHashData, java.lang.String ); // address: 0
	...
	dup 
	ldc literal_731:"JID_MUTE_TIME_"
