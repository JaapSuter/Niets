...
Label131:
	...
	invokeinterface interfacemethodref_65 // pc=1 guess=12
	aload_0 
	aload_0_getfield _playbackPlayer   // get_name_1:  _playbackPlayer   // get_name_2:  _playbackPlayer   // get_Name:    _playbackPlayer   // getName->1:  _playbackPlayer   // getName->2:  _playbackPlayer   // getName->N:  _playbackPlayer   // ofs = 54414 ord = 5 addr = 0
	ldc literal_275:"VolumeControl"
	invokeinterface interfacemethodref_66 // pc=2 guess=13
	...
	aload_0 
	aload_0_getfield _playbackPlayer   // get_name_1:  _playbackPlayer   // get_name_2:  _playbackPlayer   // get_Name:    _playbackPlayer   // getName->1:  _playbackPlayer   // getName->2:  _playbackPlayer   // getName->N:  _playbackPlayer   // ofs = 54414 ord = 5 addr = 0
	invokeinterface interfacemethodref_67 // pc=1 guess=14
	iipush 1000000
	i2l 
	ldiv 
	l2i 
...
Label18:
	...
	aload_0_getfield _playbackPlayer   // get_name_1:  _playbackPlayer   // get_name_2:  _playbackPlayer   // get_Name:    _playbackPlayer   // getName->1:  _playbackPlayer   // getName->2:  _playbackPlayer   // getName->N:  _playbackPlayer   // ofs = 54414 ord = 5 addr = 0
	invokeinterface interfacemethodref_57 // pc=1 guess=4
	goto Label33
	astore_2 
Label33:
	aload_0 
...
Label10:
	...
	if_icmpne Label46
	aload_0_getfield _playbackPlayer   // get_name_1:  _playbackPlayer   // get_name_2:  _playbackPlayer   // get_Name:    _playbackPlayer   // getName->1:  _playbackPlayer   // getName->2:  _playbackPlayer   // getName->N:  _playbackPlayer   // ofs = 54414 ord = 5 addr = 0
	invokeinterface interfacemethodref_58 // pc=1 guess=5
	iload_1 
	ifeq Label24
	aload_0_getfield _playbackPlayer   // get_name_1:  _playbackPlayer   // get_name_2:  _playbackPlayer   // get_Name:    _playbackPlayer   // getName->1:  _playbackPlayer   // getName->2:  _playbackPlayer   // getName->N:  _playbackPlayer   // ofs = 54414 ord = 5 addr = 0
	iconst_0 
	i2l 
	invokeinterface interfacemethodref_59 // pc=3 guess=6
	pop2 
	goto Label24
	astore_3 
Label24:
...
Label6:
	...
	ifnull Label10
	aload_0_getfield _playbackPlayer   // get_name_1:  _playbackPlayer   // get_name_2:  _playbackPlayer   // get_Name:    _playbackPlayer   // getName->1:  _playbackPlayer   // getName->2:  _playbackPlayer   // getName->N:  _playbackPlayer   // ofs = 54414 ord = 5 addr = 0
	invokeinterface interfacemethodref_60 // pc=1 guess=7
Label10:
	aload_0 
...
protected final boolean keyControl( com.whatsapp.client.SimpleAudioPopup, char, int, int ); // address: 0
	...
	iconst_0 
	aload_0_getfield _volControl   // get_name_1:  _volControl   // get_name_2:  _volControl   // get_Name:    _volControl   // getName->1:  _volControl   // getName->2:  _volControl   // getName->N:  _volControl   // ofs = 54418 ord = 6 addr = 0
	invokeinterface interfacemethodref_61 // pc=1 guess=8
	bipush 10
	isub 
	invokestatic_lib int max( int, int ) // Math
	invokeinterface interfacemethodref_62 // pc=2 guess=9
	pop 
	iconst_1 
	ireturn 
Label15:
	...
	if_icmpne Label37
	aload_0_getfield _volControl   // get_name_1:  _volControl   // get_name_2:  _volControl   // get_Name:    _volControl   // getName->1:  _volControl   // getName->2:  _volControl   // getName->N:  _volControl   // ofs = 54418 ord = 6 addr = 0
	invokeinterface interfacemethodref_63 // pc=1 guess=10
	ifeq Label26
	aload_0_getfield _volControl   // get_name_1:  _volControl   // get_name_2:  _volControl   // get_Name:    _volControl   // getName->1:  _volControl   // getName->2:  _volControl   // getName->N:  _volControl   // ofs = 54418 ord = 6 addr = 0
	iconst_0 
	invokeinterface interfacemethodref_64 // pc=2 guess=11
	iconst_1 
	ireturn 
Label26:
	aload_0_getfield _volControl   // get_name_1:  _volControl   // get_name_2:  _volControl   // get_Name:    _volControl   // getName->1:  _volControl   // getName->2:  _volControl   // getName->N:  _volControl   // ofs = 54418 ord = 6 addr = 0
