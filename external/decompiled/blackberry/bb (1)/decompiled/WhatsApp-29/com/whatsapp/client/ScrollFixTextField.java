...

{
	...
	// @@@@@@@@@@@@@ Fields 
	public com.whatsapp.client.BBMStyleInputField /*com.whatsapp.client.BBMStyleInputField*/  _inputField ; // ofs = 53798 addr = 0)
	public com.whatsapp.client.BitmapButtonField /*com.whatsapp.client.BitmapButtonField*/  _emojiButton ; // ofs = 53802 addr = 0)
...
public <init>( com.whatsapp.client.ScrollFixTextField, long ); // address: 0
	...
	putfield _inputField   // get_name_1:  _inputField   // get_name_2:  _inputField   // get_Name:    _inputField   // getName->1:  _inputField   // getName->2:  _inputField   // getName->N:  _inputField   // ofs = 53798 ord = 0 addr = 0
	aload_0 
	new ScrollFixTextField$InnerVFM
	dup 
	aload_0_getfield _inputField   // get_name_1:  _inputField   // get_name_2:  _inputField   // get_Name:    _inputField   // getName->1:  _inputField   // getName->2:  _inputField   // getName->N:  _inputField   // ofs = 53798 ord = 0 addr = 0
	invokespecial com.whatsapp.client.ScrollFixTextField$InnerVFM.<init> // pc=2
	putfield _innerVFM   // get_name_1:  _innerVFM   // get_name_2:  _innerVFM   // get_Name:    _innerVFM   // getName->1:  _innerVFM   // getName->2:  _innerVFM   // getName->N:  _innerVFM   // ofs = 53806 ord = 2 addr = 0
	aload_0_getfield _innerVFM   // get_name_1:  _innerVFM   // get_name_2:  _innerVFM   // get_Name:    _innerVFM   // getName->1:  _innerVFM   // getName->2:  _innerVFM   // getName->N:  _innerVFM   // ofs = 53806 ord = 2 addr = 0
	...
	aload_0_getfield _innerVFM   // get_name_1:  _innerVFM   // get_name_2:  _innerVFM   // get_Name:    _innerVFM   // getName->1:  _innerVFM   // getName->2:  _innerVFM   // getName->N:  _innerVFM   // ofs = 53806 ord = 2 addr = 0
	getstatic_lib module:WhatsApp-7.class#21.static_53 // class#21
	...
	putfield _emojiButton   // get_name_1:  _emojiButton   // get_name_2:  _emojiButton   // get_Name:    _emojiButton   // getName->1:  _emojiButton   // getName->2:  _emojiButton   // getName->N:  _emojiButton   // ofs = 53802 ord = 1 addr = 0
	aload_0_getfield _emojiButton   // get_name_1:  _emojiButton   // get_name_2:  _emojiButton   // get_Name:    _emojiButton   // getName->1:  _emojiButton   // getName->2:  _emojiButton   // getName->N:  _emojiButton   // ofs = 53802 ord = 1 addr = 0
	bipush 5
	...
	invokevirtual setMargin( net.rim.device.api.ui.Field, int, int, int, int ) // pc=5
	aload_0_getfield _emojiButton   // get_name_1:  _emojiButton   // get_name_2:  _emojiButton   // get_Name:    _emojiButton   // getName->1:  _emojiButton   // getName->2:  _emojiButton   // getName->N:  _emojiButton   // ofs = 53802 ord = 1 addr = 0
	new ScrollFixTextField$1
	dup 
	aload_0 
	invokespecial com.whatsapp.client.ScrollFixTextField$1.<init> // pc=2
