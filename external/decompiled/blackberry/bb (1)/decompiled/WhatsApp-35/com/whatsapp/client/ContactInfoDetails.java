...
static protected final net.rim.device.api.system.EncodedImage loadImage( net.rim.blackberry.api.pdap.BlackBerryContact ); // address: 0
	...
	bipush 110
	iconst_0 
	invokeinterface interfacemethodref_58 // pc=3 guess=10
	astore_1 
	aload_1 
	ifnull Label29
	aload_1 
...
Label15:
	aload_3 
	bipush 117
	invokeinterface interfacemethodref_50 // pc=2 guess=2
	ifeq Label30
	aload_1 
	bipush 117
	invokeinterface interfacemethodref_51 // pc=2 guess=3
	ifle Label30
	aload_0 
	aload_1 
	bipush 117
	iconst_0 
	invokeinterface interfacemethodref_52 // pc=3 guess=4
	putfield .field_0_   // get_name_1:  .field_0_   // get_name_2:  .field_0_   // get_Name:    .field_0_   // getName->1:  null   // getName->2:  null   // getName->N:  null   // ofs = -1 ord = 0 addr = 0
	goto Label39
Label30:
	aload_0 
...
Label39:
	...
	bipush 106
	iconst_0 
	invokeinterface interfacemethodref_53 // pc=3 guess=5
	astore_4 
	aload_3 
	bipush 106
	bipush 3
	invokeinterface interfacemethodref_54 // pc=3 guess=6
	ifeq Label66
	aload_4 
	bipush 3
	aaload 
...
Label163:
	...
	bipush 115
	iload_5 
	invokeinterface interfacemethodref_55 // pc=3 guess=7
	istore_6 
	aload_1 
	bipush 115
	iload_5 
...
Label414:
	...
	bipush 101
	iconst_0 
	invokeinterface interfacemethodref_56 // pc=3 guess=8
...
Label456:
	aload_0 
	aload_1 
	invokeinterface interfacemethodref_57 // pc=1 guess=9
	putfield .field_36_36   // get_name_1:  .field_36_36   // get_name_2:  .field_36_36   // get_Name:    .field_36_36   // getName->1:  null   // getName->2:  null   // getName->N:  null   // ofs = -1 ord = 0 addr = 36
	aload_3 
	bipush 118
	invokeinterface interfacemethodref_50 // pc=2 guess=2
...
public final java.lang.String toVCard( com.whatsapp.client.ContactInfoDetails ); // address: 0
	...
	new_lib net.rim.device.api.ui.Screen//net.rim.device.api.ui.Screen net.rim.device.api.ui.Screen net.rim.device.api.ui.Screen
	dup 
	ldc literal_366:"BEGIN:VCARD??VERSION:3.0??"
	invokespecial_lib java.lang.StringBuffer.<init> // pc=2
	astore_1 
	aload_1 
	ldc literal_367:"N:"
...
Label162:
	...
	new_lib net.rim.device.api.ui.Screen//net.rim.device.api.ui.Screen net.rim.device.api.ui.Screen net.rim.device.api.ui.Screen
	dup 
	ldc literal_373:"TEL;type=PAGER:"
	invokespecial_lib java.lang.StringBuffer.<init> // pc=2
	aload_0 
	aload_0_getfield .field_13_13   // get_name_1:  .field_13_13   // get_name_2:  .field_13_13   // get_Name:    .field_13_13   // getName->1:  null   // getName->2:  null   // getName->N:  null   // ofs = -1 ord = 0 addr = 13
	invokespecial com.whatsapp.client.ContactInfoDetails.routine_8985 // pc=2
...
Label178:
	...
	new_lib net.rim.device.api.ui.Screen//net.rim.device.api.ui.Screen net.rim.device.api.ui.Screen net.rim.device.api.ui.Screen
	dup 
	ldc literal_374:"TEL;type=OTHER:"
	invokespecial_lib java.lang.StringBuffer.<init> // pc=2
	aload_0 
	aload_0_getfield .field_16_16   // get_name_1:  .field_16_16   // get_name_2:  .field_16_16   // get_Name:    .field_16_16   // getName->1:  null   // getName->2:  null   // getName->N:  null   // ofs = -1 ord = 0 addr = 16
	invokespecial com.whatsapp.client.ContactInfoDetails.routine_8985 // pc=2
...
Label228:
	...
	new_lib net.rim.device.api.ui.Screen//net.rim.device.api.ui.Screen net.rim.device.api.ui.Screen net.rim.device.api.ui.Screen
	dup 
	ldc literal_376:"EMAIL;type=INTERNET:"
	invokespecial_lib java.lang.StringBuffer.<init> // pc=2
	aload_0_getfield .field_6_6   // get_name_1:  .field_6_6   // get_name_2:  .field_6_6   // get_Name:    .field_6_6   // getName->1:  null   // getName->2:  null   // getName->N:  null   // ofs = -1 ord = 0 addr = 6
	iload_2 
	invokevirtual java.lang.Object elementAt( java.util.Vector, int ) // pc=2
