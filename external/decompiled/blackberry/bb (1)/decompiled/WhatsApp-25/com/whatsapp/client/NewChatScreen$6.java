...
abstract final class NewChatScreen$6 extends Object
implements Runnable

{

	// @@@@@@@@@@@@@ Fields 
	private final com.whatsapp.client.NewChatScreen /*com.whatsapp.client.NewChatScreen*/  field_53854 ; // ofs = 53854 addr = 0)

	// @@@@@@@@@@@@@ Static routines 

<init>( com.whatsapp.client.NewChatScreen$6, com.whatsapp.client.NewChatScreen ); // address: 0
	{
	enter_narrow 
	aload_0 
...
public final run( com.whatsapp.client.NewChatScreen$6 ); // address: 0
	{
	enter_narrow 
