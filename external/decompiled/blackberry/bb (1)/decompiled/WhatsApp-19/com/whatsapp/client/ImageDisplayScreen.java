...

{
	...
	private com.whatsapp.client. /*module:WhatsApp.class#11*/  _targetCID ; // ofs = 53160 addr = 0)
...
static public final assignPicToContact( java.lang.String, module:WhatsApp.class#11 ); // address: 0
	...
	aload_5 
	arraylength 
	invokeinterface interfacemethodref_5 // pc=7 guess=3
	goto Label42
Label34:
	aload_4 
	bipush 110
	...
	aload_5 
	arraylength 
	invokeinterface interfacemethodref_6 // pc=6 guess=4
Label42:
	aload_4 
	...
	dup 
	ldc literal_51:"Couldn't save picture to contact, got error: "
...
Label9:
	...
	goto Label29
	astore_3 
	ldc literal_50:"Couldn't create contact picture from image"
	invokestatic_lib alert( java.lang.String ) // Dialog
	return 
Label29:
	aload_0_getfield _targetCID   // get_name_1:  _targetCID   // get_name_2:  _targetCID   // get_Name:    _targetCID   // getName->1:  _targetCID   // getName->2:  _targetCID   // getName->N:  _targetCID   // ofs = 53160 ord = 26 addr = 0
