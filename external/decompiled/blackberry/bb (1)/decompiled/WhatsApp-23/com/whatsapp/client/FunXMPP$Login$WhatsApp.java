...
Label15:
	...
	new FunXMPP$ProtocolTreeNode
	dup 
	ldc literal_487:"w:profile:picture"
	iconst_1 
...
Label52:
	...
	iconst_0 
	invokeinterface interfacemethodref_127 // pc=3 guess=46
	return 
	}
...
Label31:
	...
	aload_0_getfield .field_2_2   // get_name_1:  .field_2_2   // get_name_2:  .field_2_2   // get_Name:    .field_2_2   // getName->1:  null   // getName->2:  null   // getName->N:  null   // ofs = -1 ord = 0 addr = 2
	aload_1 
	invokeinterface interfacemethodref_128 // pc=2 guess=47
	return 
	}
...
Label5:
	...
	invokeinterface interfacemethodref_129 // pc=1 guess=48
	dup 
	astore_1 
	ifnonnull Label11
	goto_w Label78
...
Label78:
	...
	dup 
	ldc literal_498:"fell out of loop in readFeaturesAndChallenge"
	aload_0_getfield .field_1_1   // get_name_1:  .field_1_1   // get_name_2:  .field_1_1   // get_Name:    .field_1_1   // getName->1:  null   // getName->2:  null   // getName->N:  null   // ofs = -1 ord = 0 addr = 1
	invokeinterface interfacemethodref_130 // pc=1 guess=49
...
private final com.whatsapp.client.FunXMPP$Login$WhatsApp.routine_5469( com.whatsapp.client.FunXMPP$Login$WhatsApp, java.lang.String ); // address: 0
	...
	aload_0_getfield .field_2_2   // get_name_1:  .field_2_2   // get_name_2:  .field_2_2   // get_Name:    .field_2_2   // getName->1:  null   // getName->2:  null   // getName->N:  null   // ofs = -1 ord = 0 addr = 2
	aload_3 
	invokeinterface interfacemethodref_128 // pc=2 guess=50
	return 
	}
...
private final com.whatsapp.client.FunXMPP$Login$WhatsApp.routine_5546( com.whatsapp.client.FunXMPP$Login$WhatsApp ); // address: 0
	...
	enter_narrow 
	aload_0_getfield .field_1_1   // get_name_1:  .field_1_1   // get_name_2:  .field_1_1   // get_Name:    .field_1_1   // getName->1:  null   // getName->2:  null   // getName->N:  null   // ofs = -1 ord = 0 addr = 1
	invokeinterface interfacemethodref_129 // pc=1 guess=51
	astore_1 
	aload_1 
...
public final login( com.whatsapp.client.FunXMPP$Login$WhatsApp ); // address: 0
	...
	invokeinterface interfacemethodref_125 // pc=3 guess=44
	aload_0 
	...
	aload_0_getfield .field_1_1   // get_name_1:  .field_1_1   // get_name_2:  .field_1_1   // get_Name:    .field_1_1   // getName->1:  null   // getName->2:  null   // getName->N:  null   // ofs = -1 ord = 0 addr = 1
	invokeinterface interfacemethodref_126 // pc=1 guess=45
	aload_0 
