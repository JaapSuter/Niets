...

{
	...
	// @@@@@@@@@@@@@ Fields 
	public final String /*java.lang.String*/  tag ; // ofs = 55598 addr = 0)
	public final com.whatsapp.client.FunXMPP$KeyValue /*com.whatsapp.client.FunXMPP$KeyValue[]*/  attributes ; // ofs = 55602 addr = 0)
	public final com.whatsapp.client.FunXMPP$ProtocolTreeNode /*com.whatsapp.client.FunXMPP$ProtocolTreeNode[]*/  children ; // ofs = 55606 addr = 0)
	public final byte[] /*byte[]*/  data ; // ofs = 55610 addr = 0)

	// @@@@@@@@@@@@@ Static routines 

public <init>( com.whatsapp.client.FunXMPP$ProtocolTreeNode, java.lang.String, com.whatsapp.client.FunXMPP$KeyValue[], com.whatsapp.client.FunXMPP$ProtocolTreeNode[] ); // address: 0
	{
	enter 
	aload_0 
...
public <init>( com.whatsapp.client.FunXMPP$ProtocolTreeNode, java.lang.String, com.whatsapp.client.FunXMPP$KeyValue[], java.lang.String ); // address: 0
	{
	enter 
	aload_0 
	invokespecial_lib java.lang.Object.<init> // pc=1
...
public <init>( com.whatsapp.client.FunXMPP$ProtocolTreeNode, java.lang.String, com.whatsapp.client.FunXMPP$KeyValue[], byte[] ); // address: 0
	{
	enter 
	aload_0 
	invokespecial_lib java.lang.Object.<init> // pc=1
...
public <init>( com.whatsapp.client.FunXMPP$ProtocolTreeNode, java.lang.String, com.whatsapp.client.FunXMPP$KeyValue[] ); // address: 0
	{
	enter_narrow 
	aload_0 
	invokespecial_lib java.lang.Object.<init> // pc=1
...
Label9:
	...
	dup 
	ldc literal_522:"safeGetChild sees null node/child"
	invokespecial com.whatsapp.client.FunXMPP$CorruptStreamException.<init> // pc=2
	athrow 
Label14:
	aload_0_getfield .field_2_2   // get_name_1:  .field_2_2   // get_name_2:  .field_2_2   // get_Name:    .field_2_2   // getName->1:  null   // getName->2:  null   // getName->N:  null   // ofs = -1 ord = 0 addr = 2
	iload_1 
