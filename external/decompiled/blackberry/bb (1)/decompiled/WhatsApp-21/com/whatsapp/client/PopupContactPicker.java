...
{
	// @@@@@@@@@@@@@ Static fields 
	public final static String /*java.lang.String*/  _deviceName ; // ofs = 53708 addr = 24)
	public final static boolean /*boolean*/  _showTouchPrompt ; // ofs = 53714 addr = 25)

	// @@@@@@@@@@@@@ Fields 
	private  /*module:WhatsApp-10.class#30*/  _selection ; // ofs = 53684 addr = 0)
	private com.whatsapp.client.ContactPickerField /*com.whatsapp.client.ContactPickerField*/  _picker ; // ofs = 53688 addr = 0)
	private net.rim.device.api.ui.container.VerticalFieldManager /*net.rim.device.api.ui.container.VerticalFieldManager*/  _wrappedPicker ; // ofs = 53692 addr = 0)
	private java.util.Hashtable /*java.util.Hashtable*/  _alreadySelected ; // ofs = 53696 addr = 0)
	private Integer /*java.lang.Integer*/  field_53700 ; // ofs = 53700 addr = 0)
	private Integer /*java.lang.Integer*/  _invokeLaterId ; // ofs = 53704 addr = 0)
...
public <init>( com.whatsapp.client.PopupContactPicker, java.util.Hashtable ); // address: 0
	...
	aload_0 
	aconst_null 
	putfield _selection   // get_name_1:  _selection   // get_name_2:  _selection   // get_Name:    _selection   // getName->1:  _selection   // getName->2:  _selection   // getName->N:  _selection   // ofs = 53684 ord = 0 addr = 0
	aload_0 
	aload_1 
	putfield _alreadySelected   // get_name_1:  _alreadySelected   // get_name_2:  _alreadySelected   // get_Name:    _alreadySelected   // getName->1:  _alreadySelected   // getName->2:  _alreadySelected   // getName->N:  _alreadySelected   // ofs = 53696 ord = 3 addr = 0
	return 
	}
...
static <clinit>(  ); // address: 0
	...
	ldc literal_310:"9500"
	invokenonvirtual_lib java.lang.String.startsWith // pc=2
	ifne Label18
	getstatic _deviceName // PopupContactPicker
	ldc literal_311:"9530"
	invokenonvirtual_lib java.lang.String.startsWith // pc=2
	ifne Label18
	getstatic _deviceName // PopupContactPicker
	ldc literal_312:"9550"
	invokenonvirtual_lib java.lang.String.startsWith // pc=2
	ifeq Label20
Label18:
	iconst_1 
...
private net.rim.device.api.ui.container.VerticalFieldManager getWrappedPicker( com.whatsapp.client.PopupContactPicker, net.rim.device.api.ui.Field, int ); // address: 0
	{
	enter 
	aload_0_getfield _wrappedPicker   // get_name_1:  _wrappedPicker   // get_name_2:  _wrappedPicker   // get_Name:    _wrappedPicker   // getName->1:  _wrappedPicker   // getName->2:  _wrappedPicker   // getName->N:  _wrappedPicker   // ofs = 53692 ord = 2 addr = 0
	ifnull Label5
	aload_0_getfield _wrappedPicker   // get_name_1:  _wrappedPicker   // get_name_2:  _wrappedPicker   // get_Name:    _wrappedPicker   // getName->1:  _wrappedPicker   // getName->2:  _wrappedPicker   // getName->N:  _wrappedPicker   // ofs = 53692 ord = 2 addr = 0
	areturn 
Label5:
...
private com.whatsapp.client.ContactPickerField createContactDetailPopup( com.whatsapp.client.PopupContactPicker, module:WhatsApp-10.class#30 ); // address: 0
	{
	enter 
	aload_1 
	ifnonnull Label5
...
Label5:
	...
	dup 
	invokespecial_lib .routine_8095 // pc=1
	astore_2 
	aload_2 
	aload_0 
	...
	invokenonvirtual_lib .routine_6637 // pc=2
...
private setSelection( com.whatsapp.client.PopupContactPicker, module:WhatsApp-10.class#30, java.lang.String ); // address: 0
	{
	enter 
	aload_0 
	aload_1 
...
private com.whatsapp.client.ContactPickerField com.whatsapp.client.PopupContactPicker.routine_2327( com.whatsapp.client.PopupContactPicker ); // address: 0
	{
	enter 
	new_lib com.whatsapp.client.ContactPickerField//com.whatsapp.client.ContactPickerField com.whatsapp.client.ContactPickerField com.whatsapp.client.ContactPickerField
	dup 
...
Label30:
	aload_1 
	aload_0 
	invokespecial com.whatsapp.client.PopupContactPicker.routine_2482 // pc=1
	...
	invokenonvirtual_lib .routine_6795 // pc=2
	aload_1 
	areturn 
	}


private module:WhatsApp-10.class#40 getClickHandler( com.whatsapp.client.PopupContactPicker ); // address: 0
	{
	enter 
...
private module:WhatsApp-7.class#24 com.whatsapp.client.PopupContactPicker.routine_2482( com.whatsapp.client.PopupContactPicker ); // address: 0
	{
	enter_narrow 
...
Label7:
	aload_0_getfield _wrappedPicker   // get_name_1:  _wrappedPicker   // get_name_2:  _wrappedPicker   // get_Name:    _wrappedPicker   // getName->1:  _wrappedPicker   // getName->2:  _wrappedPicker   // getName->N:  _wrappedPicker   // ofs = 53692 ord = 2 addr = 0
	invokevirtual net.rim.device.api.ui.Manager getManager( net.rim.device.api.ui.Field ) // pc=1
	checkcast_lib com.whatsapp.field.PopupManager//module:WhatsApp-37.class#8 module:WhatsApp-37.class#8 module:WhatsApp-37.class#8
	aconst_null 
	aconst_null 
	invokeinterface interfacemethodref_50 // pc=3 guess=2
	aload_0 
	aconst_null 
	putfield _picker   // get_name_1:  _picker   // get_name_2:  _picker   // get_Name:    _picker   // getName->1:  _picker   // getName->2:  _picker   // getName->N:  _picker   // ofs = 53688 ord = 1 addr = 0
	aload_0 
	aconst_null 
...
private module:WhatsApp-37.class#8 getPopupManager( com.whatsapp.client.PopupContactPicker ); // address: 0
	{
	enter 
	aload_0 
	invokevirtual net.rim.device.api.ui.Manager getManager( net.rim.device.api.ui.Field ) // pc=1
...
Label13:
	aload_0 
	aload_0 
	invokespecial com.whatsapp.client.PopupContactPicker.routine_2327 // pc=1
	putfield _picker   // get_name_1:  _picker   // get_name_2:  _picker   // get_Name:    _picker   // getName->1:  _picker   // getName->2:  _picker   // getName->N:  _picker   // ofs = 53688 ord = 1 addr = 0
	aload_0 
	aload_0_getfield _picker   // get_name_1:  _picker   // get_name_2:  _picker   // get_Name:    _picker   // getName->1:  _picker   // getName->2:  _picker   // getName->N:  _picker   // ofs = 53688 ord = 1 addr = 0
	bipush 10
	...
	aload_2 
	aload_0 
	invokeinterface interfacemethodref_50 // pc=3 guess=3
	aload_2 
...
public module:WhatsApp-10.class#30 getSelection( com.whatsapp.client.PopupContactPicker ); // address: 0
	{
	areturn_field _selection   // get_name_1:  _selection   // get_name_2:  _selection   // get_Name:    _selection   // getName->1:  _selection   // getName->2:  _selection   // getName->N:  _selection   // ofs = 53684 ord = 0 addr = 0
	}
...
protected onClick( com.whatsapp.client.PopupContactPicker, module:WhatsApp-10.class#30, java.lang.String ); // address: 0
	{
	noenter_return 
	}
...
protected onUnfocus( com.whatsapp.client.PopupContactPicker ); // address: 0
	...
	aload_0 
	invokevirtual invalidate( net.rim.device.api.ui.Field ) // pc=1
	aload_0_getfield _invokeLaterId   // get_name_1:  _invokeLaterId   // get_name_2:  _invokeLaterId   // get_Name:    _invokeLaterId   // getName->1:  _invokeLaterId   // getName->2:  _invokeLaterId   // getName->N:  _invokeLaterId   // ofs = 53704 ord = 5 addr = 0
	ifnull Label11
...
protected onFocus( com.whatsapp.client.PopupContactPicker, int ); // address: 0
	...
	aload_0 
	invokevirtual invalidate( net.rim.device.api.ui.Field ) // pc=1
	aload_0_getfield _selection   // get_name_1:  _selection   // get_name_2:  _selection   // get_Name:    _selection   // getName->1:  _selection   // getName->2:  _selection   // getName->N:  _selection   // ofs = 53684 ord = 0 addr = 0
	ifnull Label26
...
protected paint( com.whatsapp.client.PopupContactPicker, net.rim.device.api.ui.Graphics ); // address: 0
	...
	invokevirtual boolean isEditable( net.rim.device.api.ui.Field ) // pc=1
	ifne Label13
	aload_0_getfield com.whatsapp.client.PopupContactPicker.field_53700   // get_name_1:  com.whatsapp.client.PopupContactPicker.field_53700   // get_name_2:  com.whatsapp.client.PopupContactPicker.field_53700   // get_Name:    com.whatsapp.client.PopupContactPicker.field_53700   // getName->1:     // getName->2:     // getName->N:     // ofs = 53700 ord = 4 addr = 0
	ifnull Label13
	aload_1 
	aload_0_getfield com.whatsapp.client.PopupContactPicker.field_53700   // get_name_1:  com.whatsapp.client.PopupContactPicker.field_53700   // get_name_2:  com.whatsapp.client.PopupContactPicker.field_53700   // get_Name:    com.whatsapp.client.PopupContactPicker.field_53700   // getName->1:     // getName->2:     // getName->N:     // ofs = 53700 ord = 4 addr = 0
	invokevirtual int intValue( java.lang.Integer ) // pc=1
...
public int drawText( com.whatsapp.client.PopupContactPicker, net.rim.device.api.ui.Graphics, int, int, int, int, net.rim.device.api.ui.DrawTextParam ); // address: 0
	...
	iload_2 
	aload_6 
	invokestatic_lib module:WhatsApp-15.class#1.routine_1524(  ) // class#1
	iadd 
	iload_2 
	aload_6 
	invokestatic_lib module:WhatsApp-15.class#1.routine_1511(  ) // class#1
	iadd 
...
public setSelection( com.whatsapp.client.PopupContactPicker, module:WhatsApp-10.class#30 ); // address: 0
	{
	enter 
	aload_0 
	aload_1 
...
public setColor( com.whatsapp.client.PopupContactPicker, int ); // address: 0
	...
	iload_1 
	invokespecial_lib java.lang.Integer.<init> // pc=2
	putfield com.whatsapp.client.PopupContactPicker.field_53700   // get_name_1:  com.whatsapp.client.PopupContactPicker.field_53700   // get_name_2:  com.whatsapp.client.PopupContactPicker.field_53700   // get_Name:    com.whatsapp.client.PopupContactPicker.field_53700   // getName->1:     // getName->2:     // getName->N:     // ofs = 53700 ord = 4 addr = 0
	return 
	}
