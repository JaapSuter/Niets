...

{
	...
	// @@@@@@@@@@@@@ Fields 
	protected java.io.OutputStream /*java.io.OutputStream*/  out ; // ofs = 54322 addr = 0)
...
public <init>( com.whatsapp.client.ProxyOutputStream, java.io.OutputStream ); // address: 0
	...
	aload_0 
	aload_1 
	putfield out   // get_name_1:  out   // get_name_2:  out   // get_Name:    out   // getName->1:  out   // getName->2:  out   // getName->N:  out   // ofs = 54322 ord = 0 addr = 0
	return 
	}
...
public write( com.whatsapp.client.ProxyOutputStream, int ); // address: 0
	...
	aload_0_getfield out   // get_name_1:  out   // get_name_2:  out   // get_Name:    out   // getName->1:  out   // getName->2:  out   // getName->N:  out   // ofs = 54322 ord = 0 addr = 0
	iload_1 
