...

{
	...
	private final com.whatsapp.client. /*module:WhatsApp-23.class#0*/  field_57040 ; // ofs = 57040 addr = 0)
...
Label48:
	...
	new_lib net.rim.device.api.ui.XYRect//net.rim.device.api.ui.XYRect net.rim.device.api.ui.XYRect net.rim.device.api.ui.XYRect
	dup 
	ldc literal_62:"HTTP response code: "
...
static final <clinit>(  ); // address: 0
	...
	clinit_wait 
	ldc literal_63:"http://maps.google.com/maps/api/staticmap?center={0},{1}&zoom=15&size=200x200&sensor=true&format=jpg&mobile=true&markers=color:red|size:mid|{0},{1}"
...
private final boolean com.whatsapp.client.LocationSenderThread.routine_3180( com.whatsapp.client.LocationSenderThread, javax.microedition.location.Criteria ); // address: 0
	...
	dup 
	ldc literal_61:"no location provider for this gps criteria."
