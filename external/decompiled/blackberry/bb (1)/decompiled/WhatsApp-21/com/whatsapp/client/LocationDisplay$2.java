...

{
	...
	// @@@@@@@@@@@@@ Fields 
	private final com.whatsapp.client.LocationDisplay /*module:WhatsApp-21.class#1*/  field_54122 ; // ofs = 54122 addr = 0)

	// @@@@@@@@@@@@@ Static routines 

<init>( com.whatsapp.client.LocationDisplay$2, module:WhatsApp-21.class#1 ); // address: 0
	{
	enter_narrow 
	aload_0 
...
public final fieldChanged( com.whatsapp.client.LocationDisplay$2, net.rim.device.api.ui.Field, int ); // address: 0
	...
	invokespecial_lib .routine_1396 // pc=1
	return 
	}
