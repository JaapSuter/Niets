...

{
	...
	// @@@@@@@@@@@@@ Fields 
	protected java.io.InputStream /*java.io.InputStream*/  in ; // ofs = 54258 addr = 0)
...
public <init>( com.whatsapp.client.ProxyInputStream, java.io.InputStream ); // address: 0
	...
	aload_0 
	aload_1 
	putfield in   // get_name_1:  in   // get_name_2:  in   // get_Name:    in   // getName->1:  in   // getName->2:  in   // getName->N:  in   // ofs = 54258 ord = 0 addr = 0
	return 
	}
...
public int read( com.whatsapp.client.ProxyInputStream ); // address: 0
	{
	enter_narrow 
	aload_0_getfield in   // get_name_1:  in   // get_name_2:  in   // get_Name:    in   // getName->1:  in   // getName->2:  in   // getName->N:  in   // ofs = 54258 ord = 0 addr = 0
