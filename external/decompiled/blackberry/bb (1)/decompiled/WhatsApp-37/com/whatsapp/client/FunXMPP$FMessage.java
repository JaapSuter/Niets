...
Label16:
	...
	aload_3 
	invokeinterface interfacemethodref_25 // pc=2 guess=31
	ifnonnull Label16
	getstatic_lib module:WhatsApp-15.class#16.static_35 // class#16
	aload_3 
	aload_0 
	invokeinterface interfacemethodref_26 // pc=3 guess=32
	aload_0 
	aload_3 
...
public <init>( com.whatsapp.client.FunXMPP$FMessage, com.whatsapp.client.FunXMPP$FMessage$Key ); // address: 0
	...
	aload_1 
	aload_0 
	invokeinterface interfacemethodref_26 // pc=3 guess=33
	aload_2 
	monitorexit 
	return 
	astore_3 
...
Label3:
	aload_1 
	aload_0 
	invokeinterface interfacemethodref_27 // pc=2 guess=34
	return 
Label7:
	aload_1 
	aload_0 
...
Label15:
	aload_1 
	aload_0 
	invokeinterface interfacemethodref_30 // pc=2 guess=37
	return 
Label19:
	aload_1 
	aload_0 
	invokeinterface interfacemethodref_31 // pc=2 guess=38
	return 
Label23:
	aload_1 
	aload_0 
	invokeinterface interfacemethodref_32 // pc=2 guess=39
	return 
Label27:
	aload_1 
	aload_0 
	invokeinterface interfacemethodref_33 // pc=2 guess=40
	return 
	}
