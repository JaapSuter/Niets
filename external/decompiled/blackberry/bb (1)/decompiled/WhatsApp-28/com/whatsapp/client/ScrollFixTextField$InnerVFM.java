...
public <init>( com.whatsapp.client.ScrollFixTextField$InnerVFM, com.whatsapp.client.BBMStyleInputField ); // address: 0
	...
	aload_0 
	aload_1 
	putfield _inputField   // get_name_1:  _inputField   // get_name_2:  _inputField   // get_Name:    _inputField   // getName->1:  _inputField   // getName->2:  _inputField   // getName->N:  _inputField   // ofs = 53910 ord = 0 addr = 0
	return 
	}
...
public final int getPreferredHeight( com.whatsapp.client.ScrollFixTextField$InnerVFM ); // address: 0
	...
	enter_narrow 
	aload_0 
	aload_0_getfield _inputField   // get_name_1:  _inputField   // get_name_2:  _inputField   // get_Name:    _inputField   // getName->1:  _inputField   // getName->2:  _inputField   // getName->N:  _inputField   // ofs = 53910 ord = 0 addr = 0
