...
public final setEmojiPickerPopup( com.whatsapp.client.EmojiPickerPopup$EmojiVerticalFieldManager, com.whatsapp.client.EmojiPickerPopup ); // address: 0
	{
	putfield_return _popup   // get_name_1:  _popup   // get_name_2:  _popup   // get_Name:    _popup   // getName->1:  _popup   // getName->2:  _popup   // getName->N:  _popup   // ofs = 55928 ord = 0 addr = 0
	}
...
protected final int nextFocus( com.whatsapp.client.EmojiPickerPopup$EmojiVerticalFieldManager, int, int ); // address: 0
	...
	istore_3 
	aload_0_getfield _popup   // get_name_1:  _popup   // get_name_2:  _popup   // get_Name:    _popup   // getName->1:  _popup   // getName->2:  _popup   // getName->N:  _popup   // ofs = 55928 ord = 0 addr = 0
	...
	aload_0_getfield _popup   // get_name_1:  _popup   // get_name_2:  _popup   // get_Name:    _popup   // getName->1:  _popup   // getName->2:  _popup   // getName->N:  _popup   // ofs = 55928 ord = 0 addr = 0
	iload_1 
	invokespecial_lib .routine_5630 // pc=2
	putfield _currentPage   // get_name_1:  _currentPage   // get_name_2:  _currentPage   // get_Name:    _currentPage   // getName->1:  _currentPage   // getName->2:  _currentPage   // getName->N:  _currentPage   // ofs = -1 ord = 1 addr = -1
	aload_0_getfield _popup   // get_name_1:  _popup   // get_name_2:  _popup   // get_Name:    _popup   // getName->1:  _popup   // getName->2:  _popup   // getName->N:  _popup   // ofs = 55928 ord = 0 addr = 0
	iconst_0 
	invokespecial_lib .routine_5504 // pc=2
	iload_3 
	iload_4 
	if_icmpne Label24
	iload_4 
...
Label24:
	...
	if_icmpne Label30
	aload_0_getfield _popup   // get_name_1:  _popup   // get_name_2:  _popup   // get_Name:    _popup   // getName->1:  _popup   // getName->2:  _popup   // getName->N:  _popup   // ofs = 55928 ord = 0 addr = 0
	invokenonvirtual_lib .routine_5066 // pc=1
	goto Label32
Label30:
	aload_0_getfield _popup   // get_name_1:  _popup   // get_name_2:  _popup   // get_Name:    _popup   // getName->1:  _popup   // getName->2:  _popup   // getName->N:  _popup   // ofs = 55928 ord = 0 addr = 0
	invokenonvirtual_lib .routine_4994 // pc=1
Label32:
	aload_0_getfield _popup   // get_name_1:  _popup   // get_name_2:  _popup   // get_Name:    _popup   // getName->1:  _popup   // getName->2:  _popup   // getName->N:  _popup   // ofs = 55928 ord = 0 addr = 0
	getfield _flowFieldManager   // get_name_1:  _flowFieldManager   // get_name_2:  _flowFieldManager   // get_Name:    _flowFieldManager   // getName->1:  _flowFieldManager   // getName->2:  _flowFieldManager   // getName->N:  _flowFieldManager   // ofs = -1 ord = 2 addr = -1
	invokevirtual int getIndex( net.rim.device.api.ui.Field ) // pc=1
	ireturn 
Label36:
	aload_0 
