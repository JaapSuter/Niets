...

{
	...
	// @@@@@@@@@@@@@ Fields 
	private final com.whatsapp.client.ScrollFixTextField /*com.whatsapp.client.ScrollFixTextField*/  field_53858 ; // ofs = 53858 addr = 0)
...
public final fieldChanged( com.whatsapp.client.ScrollFixTextField$1, net.rim.device.api.ui.Field, int ); // address: 0
	...
	getfield _inputField   // get_name_1:  _inputField   // get_name_2:  _inputField   // get_Name:    _inputField   // getName->1:  _inputField   // getName->2:  _inputField   // getName->N:  _inputField   // ofs = 53798 ord = 0 addr = 0
