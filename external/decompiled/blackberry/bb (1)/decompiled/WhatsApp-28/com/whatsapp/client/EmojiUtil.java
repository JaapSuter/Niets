...
{
	// @@@@@@@@@@@@@ Static fields 
	private final static net.rim.device.api.util.IntHashtable /*net.rim.device.api.util.IntHashtable*/  field_56012 ; // ofs = 56012 addr = 4)
...
static public final int drawText( module:WhatsApp-14.class#21, net.rim.device.api.ui.Graphics, int, int, int, int, net.rim.device.api.ui.DrawTextParam ); // address: 0
	{
	enter 
	aload_0 
	invokeinterface interfacemethodref_131 // pc=1 guess=0
	astore_7 
	aload_0 
	invokeinterface interfacemethodref_132 // pc=1 guess=1
	istore 8
	aload_6 
	...
	astore 11
	aload_0 
	invokeinterface interfacemethodref_133 // pc=1 guess=2
	ifne Label36
	aload_0 
	invokeinterface interfacemethodref_134 // pc=1 guess=3
	ifne Label38
Label36:
	bipush -1
	goto Label46
Label38:
	aload_0 
	invokeinterface interfacemethodref_135 // pc=1 guess=4
	iload 8
	iadd 
	iload_2 
	iload 9
...
Label46:
	...
	aload_1 
	aload_0 
	invokeinterface interfacemethodref_136 // pc=1 guess=5
	...
	iload_5 
	aload_6 
	invokeinterface interfacemethodref_137 // pc=7 guess=6
	istore 15
	aload_1 
	iload 16
	invokevirtual setColor( net.rim.device.api.ui.Graphics, int ) // pc=2
...
Label97:
	...
	iload 18
	iload 19
	invokestatic com.whatsapp.client.EmojiUtil.routine_1542( net.rim.device.api.ui.DrawTextParam, int, int, int ) // EmojiUtil
	aload_0 
	aload_1 
	iload_2 
	iload_3 
...
static private final com.whatsapp.client.EmojiUtil.routine_1542( net.rim.device.api.ui.DrawTextParam, int, int, int ); // address: 0
	{
	enter 
	aload_0 
	iload_1 
...
static public final java.lang.String getEllipsisString( net.rim.device.api.ui.Font, java.lang.String, int ); // address: 0
	...
	aload_0 
	aload_1 
	invokestatic int com.whatsapp.client.EmojiUtil.routine_1700( net.rim.device.api.ui.Font, java.lang.String ) // EmojiUtil
	iload_2 
	if_icmpgt Label8
	aload_1 
	areturn 
...
static private final int com.whatsapp.client.EmojiUtil.routine_1700( net.rim.device.api.ui.Font, java.lang.String ); // address: 0
	{
	enter 
	iconst_0 
	istore_2 
...
static public final net.rim.device.api.system.Bitmap getEncodedImageResource( char, int, int ); // address: 0
	...
	i2c 
	iload_2 
	invokestatic int com.whatsapp.client.EmojiUtil.routine_4758( char, int ) // EmojiUtil
	istore_5 
	getstatic com.whatsapp.client.EmojiUtil.field_56012 // EmojiUtil
	iload_5 
	...
	i2c 
	bipush 2
	invokestatic java.lang.String com.whatsapp.client.EmojiUtil.routine_2013( char, int ) // EmojiUtil
	invokevirtual java.lang.StringBuffer append( java.lang.StringBuffer, java.lang.String ) // pc=2
	ldc literal_537:"-"
	invokevirtual java.lang.StringBuffer append( java.lang.StringBuffer, java.lang.String ) // pc=2
	iload_1 
...
static private final java.lang.String com.whatsapp.client.EmojiUtil.routine_2013( char, int ); // address: 0
	{
	enter_narrow 
	iload_0 
...
static private final int com.whatsapp.client.EmojiUtil.routine_4758( char, int ); // address: 0
	{
	enter_narrow 
	iload_0 
	istore_2 
...
static final <clinit>(  ); // address: 0
	...
	putstatic com.whatsapp.client.EmojiUtil.field_56012 // EmojiUtil
	clinit_return 
	}
