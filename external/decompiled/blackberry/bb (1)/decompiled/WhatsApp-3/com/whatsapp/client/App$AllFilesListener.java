...

{
	...
	// @@@@@@@@@@@@@ Fields 
	private long /*long*/  field_59000 ; // ofs = 59000 addr = 0)
	private  /*module:WhatsApp-10.class#29*/  field_59004 ; // ofs = 59004 addr = 0)

	// @@@@@@@@@@@@@ Static routines 

public <init>( com.whatsapp.client.App$AllFilesListener, module:WhatsApp-10.class#29 ); // address: 0
	{
	enter_narrow 
	aload_0 
