...

{
	...
	// @@@@@@@@@@@@@ Fields 
	private final com.whatsapp.client.App /*com.whatsapp.client.App*/  this$0 ; // ofs = 58340 addr = 0)

	// @@@@@@@@@@@@@ Static routines 

<init>( com.whatsapp.client.App$20, com.whatsapp.client.App ); // address: 0
	{
	enter_narrow 
	aload_0 
...
public final run( com.whatsapp.client.App$20 ); // address: 0
	{
	enter 
	invokestatic_lib module:WhatsApp-10.class#4.routine_2724(  ) // class#4
	astore_1 
...
Label27:
	...
	dup 
	aload_0 
	invokespecial com.whatsapp.client.App$20$1.<init> // pc=2
	aconst_null 
	invokenonvirtual_lib .routine_5189 // pc=4
	return 
	astore_1 
Label51:
	return 
