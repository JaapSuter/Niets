...

{
	...
	// @@@@@@@@@@@@@ Fields 
	private final com.whatsapp.client.FunXMPP$StringRunnable /*module:WhatsApp-17.class#31*/  field_58218 ; // ofs = 58218 addr = 0)
	private final net.rim.blackberry.api.mail.Message /*net.rim.blackberry.api.mail.Message*/  field_58222 ; // ofs = 58222 addr = 0)
	private final long /*long*/  field_58226 ; // ofs = 58226 addr = 0)
	private final com.whatsapp.client.App /*com.whatsapp.client.App*/  field_58230 ; // ofs = 58230 addr = 0)

	// @@@@@@@@@@@@@ Static routines 

<init>( com.whatsapp.client.App$19, com.whatsapp.client.App, module:WhatsApp-17.class#31, net.rim.blackberry.api.mail.Message, long ); // address: 0
	{
	enter 
	aload_0 
