...
Label102:
	...
	iload 8
	ifeq Label117
	ldc literal_724:"status-mute-selected"
	invokestatic_lib module:WhatsApp-41.class#0.routine_27(  ) // class#0
	astore 18
	goto Label120
Label117:
	ldc literal_725:"status-mute"
	invokestatic_lib module:WhatsApp-41.class#0.routine_27(  ) // class#0
	astore 18
Label120:
	aconst_null 
...
static private final com.whatsapp.client.ChatsTabButton.routine_7007( java.lang.String ); // address: 0
	...
	astore_1 
	aload_1 
	invokeinterface interfacemethodref_123 // pc=1 guess=2
	...
	bipush 16
	aload_0 
	invokeinterface interfacemethodref_124 // pc=4 guess=3
	iconst_0 
...
static private final com.whatsapp.client.ChatsTabButton.routine_7154( java.lang.String ); // address: 0
	...
	astore_2 
	aload_2 
	invokeinterface interfacemethodref_126 // pc=1 guess=5
	astore_3 
	aload_3 
	checkcastbranch_lib 
	astore_4 
...
Label59:
	...
	iload_6 
	aload_0 
	invokeinterface interfacemethodref_124 // pc=4 guess=6
	...
	aload_7 
	iconst_0 
	invokeinterface interfacemethodref_127 // pc=3 guess=7
	iconst_0 
	new_lib net.rim.blackberry.api.invoke.AddressBookArguments//net.rim.blackberry.api.invoke.AddressBookArguments net.rim.blackberry.api.invoke.AddressBookArguments net.rim.blackberry.api.invoke.AddressBookArguments
	dup 
	ldc literal_730:"new"
	...
	aload_2 
	aload_7 
	invokeinterface interfacemethodref_128 // pc=2 guess=8
	aload_7 
...
Label113:
	...
	ifnull Label129
	aload_2 
	invokeinterface interfacemethodref_125 // pc=1 guess=9
	return 
	astore 13
	return 
	astore 11
...
static private final int com.whatsapp.client.ChatsTabButton.routine_7503( net.rim.blackberry.api.pdap.BlackBerryContactList, net.rim.blackberry.api.pdap.BlackBerryContact ); // address: 0
	...
	aload_0 
	bipush 115
	invokeinterface interfacemethodref_129 // pc=2 guess=10
	ifeq Label49
	aload_1 
	bipush 115
	invokeinterface interfacemethodref_130 // pc=2 guess=11
	istore_3 
	iload_3 
	newarray 5
	astore_4 
...
Label16:
	...
	bipush 115
	iload_5 
	invokeinterface interfacemethodref_131 // pc=3 guess=12
	iastore 
	iinc 5 1
	goto Label16
Label28:
...
static final <clinit>(  ); // address: 0
	...
	dup 
	ldc literal_733:"unread-message-count-bg.9.png"
	...
	new_lib //module:WhatsApp-42.class#1 module:WhatsApp-42.class#1 module:WhatsApp-42.class#1
	dup 
	ldc literal_734:"unread-message-count-bg-selected.9.png"
	invokestatic_lib net.rim.device.api.system.Bitmap getBitmapResource( java.lang.String ) // Bitmap
	invokespecial_lib .routine_4617 // pc=2
...
public final net.rim.device.api.system.Bitmap getIcon( com.whatsapp.client.ChatsTabButton ); // address: 0
	...
	ifgt Label6
	ldc literal_721:"chats"
	invokestatic_lib module:WhatsApp-41.class#0.routine_27(  ) // class#0
	areturn 
Label6:
	ldc literal_722:"chats-a"
	invokestatic_lib module:WhatsApp-41.class#0.routine_27(  ) // class#0
	astore_1 
	aload_1 
	invokevirtual int getWidth( net.rim.device.api.system.Bitmap ) // pc=1
...
Label30:
	aload_4 
	invokeinterface interfacemethodref_121 // pc=1 guess=0
	ifeq Label56
	aload_4 
	invokeinterface interfacemethodref_122 // pc=1 guess=1
	checkcast_lib com.whatsapp.client.BluetoothControl$4//module:WhatsApp-9.class#10 module:WhatsApp-9.class#10 module:WhatsApp-9.class#10
	astore_7 
	aload_1 
	ifnull Label52
...
Label15:
	...
	dup 
	ldc literal_723:"empty-chat-list"
...
Label12:
	...
	new_lib com.whatsapp.client.ChatServerOperation$LeaveGroup//module:WhatsApp-10.class#12 module:WhatsApp-10.class#12 module:WhatsApp-10.class#12
	dup 
	aload_1 
	getfield .field_0_   // get_name_1:  .field_0_   // get_name_2:  .field_0_   // get_Name:    .field_0_   // getName->1:  null   // getName->2:  null   // getName->N:  null   // ofs = -1 ord = 0 addr = 0
