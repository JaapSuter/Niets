...
Label26:
	...
	aload_0 
	iconst_0 
	putfield rightToLeft   // get_name_1:  rightToLeft   // get_name_2:  rightToLeft   // get_Name:    rightToLeft   // getName->1:  rightToLeft   // getName->2:  rightToLeft   // getName->N:  rightToLeft   // ofs = 54866 ord = 0 addr = 0
	return 
	}
...
private int com.whatsapp.field.WAHorizontalFieldManager.routine_4731( com.whatsapp.field.WAHorizontalFieldManager, net.rim.device.api.ui.Field ); // address: 0
	{
	enter_narrow 
	aload_0_getfield rightToLeft   // get_name_1:  rightToLeft   // get_name_2:  rightToLeft   // get_Name:    rightToLeft   // getName->1:  rightToLeft   // getName->2:  rightToLeft   // getName->N:  rightToLeft   // ofs = 54866 ord = 0 addr = 0
	ifeq Label6
	aload_1 
...
private int com.whatsapp.field.WAHorizontalFieldManager.routine_4757( com.whatsapp.field.WAHorizontalFieldManager, net.rim.device.api.ui.Field ); // address: 0
	{
	enter_narrow 
	aload_0_getfield rightToLeft   // get_name_1:  rightToLeft   // get_name_2:  rightToLeft   // get_Name:    rightToLeft   // getName->1:  rightToLeft   // getName->2:  rightToLeft   // getName->N:  rightToLeft   // ofs = 54866 ord = 0 addr = 0
	ifeq Label6
...
public setRightToLeft( com.whatsapp.field.WAHorizontalFieldManager, boolean ); // address: 0
	{
	putfield_return rightToLeft   // get_name_1:  rightToLeft   // get_name_2:  rightToLeft   // get_Name:    rightToLeft   // getName->1:  rightToLeft   // getName->2:  rightToLeft   // getName->N:  rightToLeft   // ofs = 54866 ord = 0 addr = 0
	}
...
Label10:
	...
	aload_0 
	aload_5 
	invokespecial com.whatsapp.field.WAHorizontalFieldManager.routine_4757 // pc=2
	invokestatic_lib int max( int, int ) // Math
	istore_6 
	iload_3 
	iload_6 
...
Label42:
	...
	aload_0 
	aload 11
	invokespecial com.whatsapp.field.WAHorizontalFieldManager.routine_4731 // pc=2
	invokestatic_lib int max( int, int ) // Math
	istore 12
	iload_6 
	iload 12
