...

{
	...
	// @@@@@@@@@@@@@ Fields 
	private final com.whatsapp.client.FunXMPP$Connection /*module:WhatsApp-27.class#0*/  field_57518 ; // ofs = 57518 addr = 0)

	// @@@@@@@@@@@@@ Static routines 

<init>( com.whatsapp.client.FunXMPP$Connection$17, module:WhatsApp-27.class#0 ); // address: 0
	{
	enter_narrow 
	aload_0 
...
public final parse( com.whatsapp.client.FunXMPP$Connection$17, module:WhatsApp-28.class#3, java.lang.String ); // address: 0
	{
	enter 
