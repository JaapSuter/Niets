...

{
	...
	// @@@@@@@@@@@@@ Fields 
	protected java.io.OutputStream /*java.io.OutputStream*/  out ; // ofs = 54648 addr = 0)
...
public <init>( com.whatsapp.client.ProxyOutputStream, java.io.OutputStream ); // address: 0
	...
	aload_0 
	aload_1 
	putfield out   // get_name_1:  out   // get_name_2:  out   // get_Name:    out   // getName->1:  out   // getName->2:  out   // getName->N:  out   // ofs = 54648 ord = 0 addr = 0
	return 
	}
...
public write( com.whatsapp.client.ProxyOutputStream, int ); // address: 0
	...
	aload_0_getfield out   // get_name_1:  out   // get_name_2:  out   // get_Name:    out   // getName->1:  out   // getName->2:  out   // getName->N:  out   // ofs = 54648 ord = 0 addr = 0
	iload_1 
	invokevirtual write( java.io.OutputStream, int ) // pc=2
	aload_0 
	iconst_1 
	invokevirtual afterWrite( com.whatsapp.client.ProxyOutputStream, int ) // pc=2
	return 
	astore_2 
	aload_0 
	aload_2 
