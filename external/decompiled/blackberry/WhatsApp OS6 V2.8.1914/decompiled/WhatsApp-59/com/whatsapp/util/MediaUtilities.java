...
static public final java.lang.String saveMediaToFile( java.lang.String, java.lang.String, boolean, java.lang.String, byte[], int, int ); // address: 0
	...
	dup 
	ldc literal_212:"Cannot save files on the event dispatch thread"
...
Label34:
	...
	new_lib StringBuffer//java.lang.StringBuffer java.lang.StringBuffer java.lang.StringBuffer
	dup 
	ldc literal_213:"trying file "
	invokespecial_lib java.lang.StringBuffer.<init> // pc=2
	aload 12
	invokevirtual java.lang.StringBuffer append( java.lang.StringBuffer, java.lang.String ) // pc=2
	ldc literal_214:" for local save of downloaded media"
	invokevirtual java.lang.StringBuffer append( java.lang.StringBuffer, java.lang.String ) // pc=2
	invokevirtual_short .toString // idx=2 pc=1
	...
	astore 9
	aload 9
	invokeinterface interfacemethodref_27 // pc=1 guess=0
	ifeq Label69
	aload 9
	invokeinterface interfacemethodref_28 // pc=1 guess=1
	goto Label65
	astore 13
Label65:
	aload 11
...
Label69:
	aload 9
	invokeinterface interfacemethodref_29 // pc=1 guess=2
	aload 9
	invokeinterface interfacemethodref_30 // pc=1 guess=3
	astore 10
	aload 10
	aload_4 
	iload_5 
...
Label41:
	...
	astore_5 
	aload_5 
	invokeinterface interfacemethodref_27 // pc=1 guess=4
	ifeq Label76
	aload_5 
	invokeinterface interfacemethodref_28 // pc=1 guess=5
	goto Label72
	astore 8
Label72:
	aload_6 
...
Label80:
	...
	aload_5 
	aload_6 
	invokeinterface interfacemethodref_31 // pc=2 guess=6
	aload_5 
	iconst_0 
	invokeinterface interfacemethodref_32 // pc=2 guess=7
	aload_5 
	invokeinterface interfacemethodref_33 // pc=1 guess=8
	astore_4 
	goto_w Label38
Label94:
	aload_5 
...
Label59:
	new_lib StringBuffer//java.lang.StringBuffer java.lang.StringBuffer java.lang.StringBuffer
	dup 
	ldc literal_215:"Could not silently validate media path: "
	invokespecial_lib java.lang.StringBuffer.<init> // pc=2
	aload_5 
	invokevirtual java.lang.StringBuffer append( java.lang.StringBuffer, java.lang.String ) // pc=2
	invokevirtual_short .toString // idx=2 pc=1
...
Label30:
	new_lib StringBuffer//java.lang.StringBuffer java.lang.StringBuffer java.lang.StringBuffer
	dup 
	ldc literal_216:"Could not silently validate media root: "
	invokespecial_lib java.lang.StringBuffer.<init> // pc=2
	aload_0 
	invokevirtual java.lang.StringBuffer append( java.lang.StringBuffer, java.lang.String ) // pc=2
	invokevirtual_short .toString // idx=2 pc=1
...
static private final java.lang.String com.whatsapp.util.MediaUtilities.routine_3952( java.lang.String ); // address: 0
	...
	astore_1 
	aload_1 
	invokeinterface interfacemethodref_27 // pc=1 guess=9
	ifne Label21
	aload_1 
	invokeinterface interfacemethodref_34 // pc=1 guess=10
Label21:
	aload_2 
	astore_0 
	aload_1 
	ifnull Label48
	aload_1 
	invokeinterface interfacemethodref_28 // pc=1 guess=11
	goto Label48
	astore_5 
	goto Label48
	astore_2 
...
Label8:
	...
	aload_2 
	iconst_1 
	invokeinterface interfacemethodref_35 // pc=3 guess=12
	astore_5 
Label22:
	aload_5 
	invokeinterface interfacemethodref_36 // pc=1 guess=13
	ifeq Label30
	aload_5 
	invokeinterface interfacemethodref_37 // pc=1 guess=14
...
Label30:
	...
	ifnull Label63
	aload_4 
	invokeinterface interfacemethodref_28 // pc=1 guess=15
	goto Label63
	astore 8
	goto Label63
	astore_5 
	new_lib StringBuffer//java.lang.StringBuffer java.lang.StringBuffer java.lang.StringBuffer
	dup 
	ldc literal_217:"unable to list directory contents: "
	invokespecial_lib java.lang.StringBuffer.<init> // pc=2
	aload_5 
	invokevirtual_short .toString // idx=2 pc=1
	invokevirtual java.lang.StringBuffer append( java.lang.StringBuffer, java.lang.String ) // pc=2
...
static private final java.lang.String com.whatsapp.util.MediaUtilities.routine_4383( java.lang.String, java.lang.String ); // address: 0
	...
	astore_3 
	aload_3 
	invokeinterface interfacemethodref_38 // pc=1 guess=16
	astore_4 
	aload_3 
	invokeinterface interfacemethodref_39 // pc=1 guess=17
	ifeq Label40
	aload_4 
...
Label40:
	...
	ifnull Label73
	aload_3 
	invokeinterface interfacemethodref_28 // pc=1 guess=18
	goto Label73
	astore_7 
	goto Label73
	astore_4 
	new_lib StringBuffer//java.lang.StringBuffer java.lang.StringBuffer java.lang.StringBuffer
	dup 
	ldc literal_219:"unable to strip encryption suffix: "
	invokespecial_lib java.lang.StringBuffer.<init> // pc=2
	aload_4 
	invokevirtual_short .toString // idx=2 pc=1
	invokevirtual java.lang.StringBuffer append( java.lang.StringBuffer, java.lang.String ) // pc=2
...
static public final net.rim.device.api.system.EncodedImage getEncodedImage( module:WhatsApp-38.class#0 ); // address: 0
	...
	new_lib StringBuffer//java.lang.StringBuffer java.lang.StringBuffer java.lang.StringBuffer
	dup 
	ldc literal_224:"Raw image data in unknown format: "
	invokespecial_lib java.lang.StringBuffer.<init> // pc=2
	aload_2 
	invokevirtual_short .toString // idx=2 pc=1
	invokevirtual java.lang.StringBuffer append( java.lang.StringBuffer, java.lang.String ) // pc=2
...
Label25:
	...
	new_lib StringBuffer//java.lang.StringBuffer java.lang.StringBuffer java.lang.StringBuffer
	dup 
	ldc literal_225:"Image file in unknown format: "
	invokespecial_lib java.lang.StringBuffer.<init> // pc=2
	aload_3 
	invokevirtual_short .toString // idx=2 pc=1
	invokevirtual java.lang.StringBuffer append( java.lang.StringBuffer, java.lang.String ) // pc=2
...
static public final module:WhatsApp-26.class#23 createFMessage( java.lang.String, module:WhatsApp-24.class#25 ); // address: 0
	...
	astore_2 
	new_lib com.whatsapp.client.//module:WhatsApp-26.class#23 module:WhatsApp-26.class#23 module:WhatsApp-26.class#23
	dup 
	aload_0 
...
Label34:
	new_lib StringBuffer//java.lang.StringBuffer java.lang.StringBuffer java.lang.StringBuffer
	dup 
	ldc literal_227:"using filename "
	invokespecial_lib java.lang.StringBuffer.<init> // pc=2
	aload_1 
	getfield .field_0_   // get_name_1:  .field_0_   // get_name_2:  .field_0_   // get_Name:    .field_0_   // getName->1:  null   // getName->2:  null   // getName->N:  null   // ofs = -1 ord = 0 addr = 0
	invokevirtual java.lang.StringBuffer append( java.lang.StringBuffer, java.lang.String ) // pc=2
	ldc literal_228:" with type "
	invokevirtual java.lang.StringBuffer append( java.lang.StringBuffer, java.lang.String ) // pc=2
	aload_1 
	getfield .field_1_1   // get_name_1:  .field_1_1   // get_name_2:  .field_1_1   // get_Name:    .field_1_1   // getName->1:  null   // getName->2:  null   // getName->N:  null   // ofs = -1 ord = 0 addr = 1
	invokevirtual java.lang.StringBuffer append( java.lang.StringBuffer, java.lang.String ) // pc=2
	ldc literal_229:" for invocation"
	invokevirtual java.lang.StringBuffer append( java.lang.StringBuffer, java.lang.String ) // pc=2
	invokevirtual_short .toString // idx=2 pc=1
	invokestatic_lib module:WhatsApp-79.class#39.routine_24694(  ) // class#39
	aload_4 
