...
Label86:
	...
	aload_3 
	invokenonvirtual_lib .routine_5139 // pc=1
	ldc literal_1287:"*Do Not Display*"
	invokespecial com.whatsapp.client.MediaSettingsScreen$FsRootChoice.<init> // pc=4
...
Label151:
	...
	invokeinterface interfacemethodref_111 // pc=1 guess=0
	ifne Label155
	goto_w Label291
Label155:
	aload_0 
...
Label234:
	...
	invokevirtual add( net.rim.device.api.ui.Screen, net.rim.device.api.ui.Field ) // pc=2
	invokestatic_lib module:WhatsApp-41.class#2.routine_3978(  ) // class#2
	invokeinterface interfacemethodref_112 // pc=1 guess=1
	astore 14
	invokestatic_lib module:WhatsApp-79.class#39.routine_27848(  ) // class#39
	istore 15
	aload 14
...
private final boolean com.whatsapp.client.MediaSettingsScreen.routine_4955( com.whatsapp.client.MediaSettingsScreen ); // address: 0
	...
	astore_5 
	aload_4 
	invokeinterface interfacemethodref_111 // pc=1 guess=2
	ifeq Label29
	aload_0 
...
private final deleteStorage( com.whatsapp.client.MediaSettingsScreen ); // address: 0
	...
	if_icmpne Label23
	invokestatic_lib module:WhatsApp-41.class#2.routine_3978(  ) // class#2
	invokeinterface interfacemethodref_114 // pc=1 guess=4
	invokestatic_lib com.whatsapp.client.UiApp.routine_7787(  ) // UiApp
	...
	iconst_0 
	i2l 
	invokeinterface interfacemethodref_115 // pc=3 guess=5
	iconst_0 
...
Label4:
	invokestatic_lib module:WhatsApp-41.class#2.routine_3978(  ) // class#2
	invokeinterface interfacemethodref_111 // pc=1 guess=6
	ifeq Label10
	aload_1 
