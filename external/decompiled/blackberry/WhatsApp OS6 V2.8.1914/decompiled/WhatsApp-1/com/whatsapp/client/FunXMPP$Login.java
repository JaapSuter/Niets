...
static public java.lang.String extractNonceFromChallenge( java.lang.String ); // address: 0
	...
	dup 
	ldc literal_1207:"no nonce in challenge"
...
Label13:
	...
	new_lib javax.microedition.io.OutputConnection//javax.microedition.io.OutputConnection javax.microedition.io.OutputConnection javax.microedition.io.OutputConnection
	dup 
	ldc literal_1208:"bad nonce in challenge"
	invokespecial_lib java.io.IOException.<init> // pc=2
	athrow 
Label31:
	aload_0 
...
static private byte[] com.whatsapp.client.FunXMPP$Login.routine_1215( byte[], module:WhatsApp-40.class#16 ); // address: 0
	...
	enter_narrow 
	aload_1 
	invokeinterface interfacemethodref_106 // pc=1 guess=2
	aload_1 
	aload_0 
	invokeinterface interfacemethodref_107 // pc=2 guess=3
	aload_1 
	invokeinterface interfacemethodref_108 // pc=1 guess=4
	areturn 
	}
...
Label23:
	...
	new_lib javax.microedition.io.OutputConnection//javax.microedition.io.OutputConnection javax.microedition.io.OutputConnection javax.microedition.io.OutputConnection
	dup 
	ldc literal_1206:"invalid clock setting"
	invokespecial_lib java.io.IOException.<init> // pc=2
	athrow 
Label32:
	lload 5
...
Label83:
	...
	bipush 4
	iload_6 
	invokeinterface interfacemethodref_104 // pc=4 guess=0
	aload_0_getfield .field_3_3   // get_name_1:  .field_3_3   // get_name_2:  .field_3_3   // get_Name:    .field_3_3   // getName->1:  null   // getName->2:  null   // getName->N:  null   // ofs = -1 ord = 0 addr = 3
	getfield .field_8_8   // get_name_1:  .field_8_8   // get_name_2:  .field_8_8   // get_Name:    .field_8_8   // getName->1:  null   // getName->2:  null   // getName->N:  null   // ofs = -1 ord = 0 addr = 8
	invokeinterface interfacemethodref_105 // pc=1 guess=1
	astore 9
	aload 9
	iconst_0 
	aload_7 
