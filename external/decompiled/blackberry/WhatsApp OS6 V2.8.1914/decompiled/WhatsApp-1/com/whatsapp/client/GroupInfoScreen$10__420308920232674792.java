...
abstract final class GroupInfoScreen$10 extends Object
implements Runnable

{

	// @@@@@@@@@@@@@ Fields 
	private final com.whatsapp.client.GroupInfoScreen /*com.whatsapp.client.GroupInfoScreen*/  field_55732 ; // ofs = 55732 addr = 0)
...
public final run( com.whatsapp.client.GroupInfoScreen$10 ); // address: 0
	{
	enter_narrow 
	...
	aload_1 
	aconst_null 
	invokestatic_lib module:WhatsApp-50.class#3.routine_7301(  ) // class#3
	pop 
	return 
	}
