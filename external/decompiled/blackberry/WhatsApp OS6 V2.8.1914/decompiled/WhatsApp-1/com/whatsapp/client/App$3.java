...

{
	...
	// @@@@@@@@@@@@@ Fields 
	private final boolean /*boolean*/  field_55826 ; // ofs = 55826 addr = 0)
	private final com.whatsapp.client.App /*com.whatsapp.client.App*/  field_55830 ; // ofs = 55830 addr = 0)

	// @@@@@@@@@@@@@ Static routines 

<init>( com.whatsapp.client.App$3, com.whatsapp.client.App, boolean ); // address: 0
	{
	enter_narrow 
	aload_0 
...
Label27:
	...
	ldc literal_106:"] couldn't update availability "
	invokevirtual java.lang.StringBuffer append( java.lang.StringBuffer, java.lang.String ) // pc=2
	invokevirtual_short .toString // idx=2 pc=1
	invokestatic_lib module:WhatsApp-79.class#39.routine_24694(  ) // class#39
Label47:
