...
Label75:
	...
	invokevirtual append( net.rim.blackberry.api.browser.URLEncodedPostData, java.lang.String, java.lang.String ) // pc=3
	aload 8
	ldc literal_84:"reason"
	aload_1 
	invokevirtual append( net.rim.blackberry.api.browser.URLEncodedPostData, java.lang.String, java.lang.String ) // pc=3
	new_lib Thread//java.lang.Thread java.lang.Thread java.lang.Thread
	dup 
	ldc literal_85:"https://r.whatsapp.net/v1/code.php?"
...
static private final java.lang.String[] com.whatsapp.client.PhoneNumberConfirmationScreen.routine_5454( java.io.InputStream ); // address: 0
	...
	aload_2 
	invokeinterface interfacemethodref_3 // pc=1 guess=9
	pop 
	aload_2 
	bipush 2
	aconst_null 
	ldc literal_86:"code"
	invokeinterface interfacemethodref_4 // pc=4 guess=10
	aload_2 
	invokeinterface interfacemethodref_3 // pc=1 guess=9
	pop 
	aload_2 
	bipush 2
	aconst_null 
	ldc literal_68:"response"
	invokeinterface interfacemethodref_4 // pc=4 guess=10
	aload_2 
	aconst_null 
	ldc literal_69:"status"
	invokeinterface interfacemethodref_5 // pc=3 guess=11
	astore_3 
	aload_2 
	aconst_null 
	ldc literal_70:"result"
	invokeinterface interfacemethodref_5 // pc=3 guess=11
	astore_4 
	aload_1 
	iconst_0 
...
static public final java.lang.String blockingCheckCode( java.lang.String ); // address: 0
	...
	new_lib Thread//java.lang.Thread java.lang.Thread java.lang.Thread
	dup 
	ldc literal_88:"https://r.whatsapp.net/v1/register.php?"
	invokespecial_lib java.lang.StringBuffer.<init> // pc=2
	aload_7 
	invokevirtual_short .toString // idx=2 pc=1
	invokevirtual java.lang.StringBuffer append( java.lang.StringBuffer, java.lang.String ) // pc=2
...
Label74:
	...
	getstatic_lib module:WhatsApp-12.class#0.static_55 // class#0
	invokestatic_lib module:WhatsApp-35.class#0.routine_2595(  ) // class#0
	invokeinterface interfacemethodref_7 // pc=3 guess=13
	aload 9
...
static private final java.lang.String com.whatsapp.client.PhoneNumberConfirmationScreen.routine_6076( java.io.InputStream ); // address: 0
	...
	bipush 2
	aconst_null 
	ldc literal_91:"register"
	invokeinterface interfacemethodref_4 // pc=4 guess=18
	aload_2 
	invokeinterface interfacemethodref_3 // pc=1 guess=17
	pop 
	aload_2 
	...
	aconst_null 
	ldc literal_69:"status"
	invokeinterface interfacemethodref_5 // pc=3 guess=19
	astore_3 
	aload_2 
	aconst_null 
	ldc literal_92:"login"
	invokeinterface interfacemethodref_5 // pc=3 guess=19
	astore_4 
	aload_2 
	aconst_null 
...
private final java.lang.String parseSameDeviceData( com.whatsapp.client.PhoneNumberConfirmationScreen, java.io.InputStream ); // address: 0
	...
	bipush 2
	aconst_null 
	ldc literal_67:"exist"
	invokeinterface interfacemethodref_4 // pc=4 guess=2
	aload_2 
	invokeinterface interfacemethodref_3 // pc=1 guess=1
	pop 
	aload_2 
