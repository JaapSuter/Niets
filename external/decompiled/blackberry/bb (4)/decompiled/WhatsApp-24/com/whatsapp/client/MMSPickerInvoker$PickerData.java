...

{
	...
	// @@@@@@@@@@@@@ Fields 
	public byte /*byte*/  media_wa_type ; // ofs = 53330 addr = 0)
	private String /*java.lang.String*/  field_53334 ; // ofs = 53334 addr = 0)
	public byte[] /*byte[]*/  raw_media_bytes ; // ofs = 53338 addr = 0)
	protected String /*java.lang.String*/  mimeType ; // ofs = 53342 addr = 0)
	protected net.rim.device.api.system.Bitmap /*net.rim.device.api.system.Bitmap*/  thumbBitmap ; // ofs = 53346 addr = 0)
	public int /*int*/  media_duration_seconds ; // ofs = 53350 addr = 0)
...
public final boolean bufferFile( com.whatsapp.client.MMSPickerInvoker$PickerData ); // address: 0
	...
	astore_1 
	aload_1 
	invokeinterface interfacemethodref_94 // pc=1 guess=4
	astore_2 
	aload_1 
	invokeinterface interfacemethodref_95 // pc=1 guess=5
	l2i 
	istore_3 
	aload_0 
	iload_3 
...
Label32:
	...
	ifnull Label38
	aload_1 
	invokeinterface interfacemethodref_93 // pc=1 guess=6
	goto Label38
	astore_6 
Label38:
	iload_5 
