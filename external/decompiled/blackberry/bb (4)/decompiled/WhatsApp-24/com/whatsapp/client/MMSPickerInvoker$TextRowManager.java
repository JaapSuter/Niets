...
public <init>( com.whatsapp.client.MMSPickerInvoker$TextRowManager, java.lang.String, boolean, net.rim.device.api.system.Bitmap ); // address: 0
	...
	aload_0 
	iconst_0 
	putfield _hasFocus   // get_name_1:  _hasFocus   // get_name_2:  _hasFocus   // get_Name:    _hasFocus   // getName->1:  _hasFocus   // getName->2:  _hasFocus   // getName->N:  _hasFocus   // ofs = 53414 ord = 0 addr = 0
	aload_3 
	ifnull Label24
	aload_0 
	...
	putfield _iconFld   // get_name_1:  _iconFld   // get_name_2:  _iconFld   // get_Name:    _iconFld   // getName->1:  _iconFld   // getName->2:  _iconFld   // getName->N:  _iconFld   // ofs = 53422 ord = 2 addr = 0
	aload_0_getfield _iconFld   // get_name_1:  _iconFld   // get_name_2:  _iconFld   // get_Name:    _iconFld   // getName->1:  _iconFld   // getName->2:  _iconFld   // getName->N:  _iconFld   // ofs = 53422 ord = 2 addr = 0
	bipush 2
	bipush 2
	bipush 2
	bipush 2
...
Label24:
	...
	putfield _lblFld   // get_name_1:  _lblFld   // get_name_2:  _lblFld   // get_Name:    _lblFld   // getName->1:  _lblFld   // getName->2:  _lblFld   // getName->N:  _lblFld   // ofs = 53418 ord = 1 addr = 0
	iload_2 
	ifeq Label40
	aload_0_getfield _lblFld   // get_name_1:  _lblFld   // get_name_2:  _lblFld   // get_Name:    _lblFld   // getName->1:  _lblFld   // getName->2:  _lblFld   // getName->N:  _lblFld   // ofs = 53418 ord = 1 addr = 0
