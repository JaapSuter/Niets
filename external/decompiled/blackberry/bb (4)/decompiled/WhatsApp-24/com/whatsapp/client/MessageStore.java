...
abstract public java.util.Vector getMessagesBefore( com.whatsapp.client.MessageStore, java.lang.String, module:WhatsApp-16.class#28, int ); // address: 0
	{
	halt 
	}
...
abstract public java.util.Vector getMMSMessagesBefore( com.whatsapp.client.MessageStore, java.lang.String, module:WhatsApp-16.class#28, int ); // address: 0
	{
	halt 
	}
...
abstract public boolean putMessage( com.whatsapp.client.MessageStore, module:WhatsApp-16.class#28 ); // address: 0
	{
	halt 
	}


abstract public deleteMessage( com.whatsapp.client.MessageStore, module:WhatsApp-16.class#28 ); // address: 0
	{
	halt 
	}
...
abstract public messageReceived( com.whatsapp.client.MessageStore, module:WhatsApp-16.class#28 ); // address: 0
	{
	halt 
	}


abstract public messageSaved( com.whatsapp.client.MessageStore, module:WhatsApp-16.class#28 ); // address: 0
	{
	halt 
	}


abstract public messageMediaDurationUpdated( com.whatsapp.client.MessageStore, module:WhatsApp-16.class#28 ); // address: 0
	{
	halt 
	}
...
abstract public module:WhatsApp-9.class#15 addTempGroupChat( com.whatsapp.client.MessageStore, java.lang.String ); // address: 0
	{
	halt 
	}
