...
Label6:
	...
	astore_1 
	aload_1 
	invokeinterface interfacemethodref_90 // pc=1 guess=0
	astore_2 
	iconst_0 
...
Label19:
	aload_2 
	invokeinterface interfacemethodref_91 // pc=1 guess=1
	ifeq Label30
	aload_0_getfield _stopped   // get_name_1:  _stopped   // get_name_2:  _stopped   // get_Name:    _stopped   // getName->1:  _stopped   // getName->2:  _stopped   // getName->N:  _stopped   // ofs = 53258 ord = 0 addr = 0
	ifne Label30
	aload_3 
	aload_2 
	invokeinterface interfacemethodref_92 // pc=1 guess=2
...
Label107:
	...
	ifnull Label131
	aload_1 
	invokeinterface interfacemethodref_93 // pc=1 guess=3
	return 
	astore_2 
	return 
	astore_2 
