...
public final sortByName( com.whatsapp.client.FavoritesStorage, module:WhatsApp-13.class#1 ); // address: 0
	...
	enter 
	synch 
	new_lib com.whatsapp.client.FavoritesStorage$FavComparator//module:WhatsApp-15.class#6 module:WhatsApp-15.class#6 module:WhatsApp-15.class#6
	dup 
	aload_1 
	invokespecial_lib .routine_6951 // pc=2
	astore_4 
	aload_0_getfield .field_1_1   // get_name_1:  .field_1_1   // get_name_2:  .field_1_1   // get_Name:    .field_1_1   // getName->1:  null   // getName->2:  null   // getName->N:  null   // ofs = -1 ord = 0 addr = 1
	invokevirtual int size( java.util.Vector ) // pc=1
	istore_3 
...
Label9:
	aload_2 
	invokeinterface interfacemethodref_31 // pc=1 guess=10
	ifeq Label44
	aload_2 
	invokeinterface interfacemethodref_32 // pc=1 guess=11
	checkcast UIDPhone
	astore_4 
	aload_1 
