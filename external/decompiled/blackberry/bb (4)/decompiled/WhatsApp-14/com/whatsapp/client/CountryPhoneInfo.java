...
{
	// @@@@@@@@@@@@@ Static fields 
	private static com.whatsapp.client.CountryPhoneInfo /*com.whatsapp.client.CountryPhoneInfo*/  field_52786 ; // ofs = 52786 addr = 14)

	// @@@@@@@@@@@@@ Fields 
	private java.util.Vector /*java.util.Vector*/  field_52782 ; // ofs = 52782 addr = 0)

	// @@@@@@@@@@@@@ Static routines 

static private final java.util.Vector com.whatsapp.client.CountryPhoneInfo.routine_2914( java.io.Reader ); // address: 0
	{
	enter 
	sipush 1024
	newarray 3
...
Label35:
	...
	aload_3 
	aload_5 
	invokestatic com.whatsapp.client.CountryPhoneInfo$Country com.whatsapp.client.CountryPhoneInfo.routine_3092( java.util.Vector ) // CountryPhoneInfo
	invokevirtual addElement( java.util.Vector, java.lang.Object ) // pc=2
	aload_5 
	iconst_0 
...
static private final com.whatsapp.client.CountryPhoneInfo$Country com.whatsapp.client.CountryPhoneInfo.routine_3092( java.util.Vector ); // address: 0
	{
	enter_narrow 
...
private <init>( com.whatsapp.client.CountryPhoneInfo ); // address: 0
	...
	ifnonnull Label12
	ldc literal_52:"com.whatsapp.client.CountryPhoneInfo"
...
Label13:
	...
	aload_0 
	aload_1 
	invokestatic java.util.Vector com.whatsapp.client.CountryPhoneInfo.routine_2914( java.io.Reader ) // CountryPhoneInfo
	putfield .field_0_   // get_name_1:  .field_0_   // get_name_2:  .field_0_   // get_Name:    .field_0_   // getName->1:  null   // getName->2:  null   // getName->N:  null   // ofs = -1 ord = 0 addr = 0
	return 
	astore_1 
	aload_1 
...
static public final com.whatsapp.client.CountryPhoneInfo getInstance(  ); // address: 0
	{
	enter_narrow 
	getstatic com.whatsapp.client.CountryPhoneInfo.field_52786 // CountryPhoneInfo
	ifnonnull Label7
	new CountryPhoneInfo
	dup 
	invokespecial com.whatsapp.client.CountryPhoneInfo.<init> // pc=1
	putstatic com.whatsapp.client.CountryPhoneInfo.field_52786 // CountryPhoneInfo
Label7:
	getstatic com.whatsapp.client.CountryPhoneInfo.field_52786 // CountryPhoneInfo
	areturn 
	}
