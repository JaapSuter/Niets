...

{
	...
	// @@@@@@@@@@@@@ Fields 
	private final com.whatsapp.field.WAVerticalFieldManager /*com.whatsapp.field.WAVerticalFieldManager*/  field_53444 ; // ofs = 53444 addr = 0)
...
public final scrollChanged( com.whatsapp.field.WAVerticalFieldManager$1, net.rim.device.api.ui.Manager, int, int ); // address: 0
	...
	getfield consistentBottomEdge   // get_name_1:  consistentBottomEdge   // get_name_2:  consistentBottomEdge   // get_Name:    consistentBottomEdge   // getName->1:  consistentBottomEdge   // getName->2:  consistentBottomEdge   // getName->N:  consistentBottomEdge   // ofs = -1 ord = 0 addr = -1
	ifeq Label12
	iload_3 
	aload_0_getfield .field_0_   // get_name_1:  .field_0_   // get_name_2:  .field_0_   // get_Name:    .field_0_   // getName->1:  null   // getName->2:  null   // getName->N:  null   // ofs = -1 ord = 0 addr = 0
	...
	aload_0_getfield .field_0_   // get_name_1:  .field_0_   // get_name_2:  .field_0_   // get_Name:    .field_0_   // getName->1:  null   // getName->2:  null   // getName->N:  null   // ofs = -1 ord = 0 addr = 0
	iload_4 
	invokenonvirtual_lib .routine_361 // pc=2
Label12:
	return 
	}
