...
Label98:
	...
	iload 8
	ifeq Label113
	ldc literal_668:"status-mute-selected"
	invokestatic_lib module:WhatsApp-9.class#2.routine_1887(  ) // class#2
	astore 18
	goto Label116
Label113:
	ldc literal_669:"status-mute"
	invokestatic_lib module:WhatsApp-9.class#2.routine_1887(  ) // class#2
	astore 18
Label116:
	aload_0 
...
static private final com.whatsapp.client.ChatsTabButton.routine_4312( java.lang.String ); // address: 0
	...
	astore_1 
	aload_1 
	invokeinterface interfacemethodref_58 // pc=1 guess=2
	...
	bipush 16
	aload_0 
	invokeinterface interfacemethodref_59 // pc=4 guess=3
	iconst_0 
...
static private final com.whatsapp.client.ChatsTabButton.routine_4390( java.lang.String ); // address: 0
	...
	astore_2 
	aload_2 
	invokeinterface interfacemethodref_60 // pc=1 guess=4
	astore_3 
	aload_3 
	checkcastbranch_lib 
	astore_4 
...
Label57:
	...
	iload_6 
	aload_0 
	invokeinterface interfacemethodref_59 // pc=4 guess=5
	...
	aload_7 
	iconst_0 
	invokeinterface interfacemethodref_61 // pc=3 guess=6
	iconst_0 
	new_lib net.rim.blackberry.api.invoke.AddressBookArguments//net.rim.blackberry.api.invoke.AddressBookArguments net.rim.blackberry.api.invoke.AddressBookArguments net.rim.blackberry.api.invoke.AddressBookArguments
	dup 
	ldc literal_672:"new"
	...
	aload_2 
	aload_7 
	invokeinterface interfacemethodref_62 // pc=2 guess=7
	aload_7 
...
static private final int com.whatsapp.client.ChatsTabButton.routine_4666( net.rim.blackberry.api.pdap.BlackBerryContactList, net.rim.blackberry.api.pdap.BlackBerryContact ); // address: 0
	...
	aload_0 
	bipush 115
	invokeinterface interfacemethodref_63 // pc=2 guess=8
	ifeq Label49
	aload_1 
	bipush 115
	invokeinterface interfacemethodref_64 // pc=2 guess=9
	istore_3 
	iload_3 
	newarray 5
	astore_4 
...
Label16:
	...
	bipush 115
	iload_5 
	invokeinterface interfacemethodref_65 // pc=3 guess=10
	iastore 
	iinc 5 1
	goto Label16
Label28:
...
public final net.rim.device.api.system.Bitmap getIcon( com.whatsapp.client.ChatsTabButton ); // address: 0
	...
	ifgt Label6
	ldc literal_665:"chats"
	invokestatic_lib module:WhatsApp-9.class#2.routine_1887(  ) // class#2
	areturn 
Label6:
	ldc literal_666:"chats-a"
	invokestatic_lib module:WhatsApp-9.class#2.routine_1887(  ) // class#2
	astore_1 
	aload_1 
...
Label30:
	aload_4 
	invokeinterface interfacemethodref_56 // pc=1 guess=0
	ifeq Label56
	aload_4 
	invokeinterface interfacemethodref_57 // pc=1 guess=1
	checkcast_lib com.whatsapp.client.ChatHistory//module:WhatsApp-9.class#15 module:WhatsApp-9.class#15 module:WhatsApp-9.class#15
	astore_7 
	aload_1 
	ifnull Label52
...
Label15:
	...
	dup 
	ldc literal_667:"empty-chat-list"
