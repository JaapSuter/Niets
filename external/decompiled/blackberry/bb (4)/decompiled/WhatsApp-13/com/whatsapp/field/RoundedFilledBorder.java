...
Label24:
	aload_0 
	iload_2 
	putfield fillColor   // get_name_1:  fillColor   // get_name_2:  fillColor   // get_Name:    fillColor   // getName->1:  fillColor   // getName->2:  fillColor   // getName->N:  fillColor   // ofs = 53184 ord = 0 addr = 0
	aload_0 
	iload_3 
	putfield edgeColor   // get_name_1:  edgeColor   // get_name_2:  edgeColor   // get_Name:    edgeColor   // getName->1:  edgeColor   // getName->2:  edgeColor   // getName->N:  edgeColor   // ofs = 53188 ord = 1 addr = 0
	aload_0 
	iload_4 
	putfield transparency   // get_name_1:  transparency   // get_name_2:  transparency   // get_Name:    transparency   // getName->1:  transparency   // getName->2:  transparency   // getName->N:  transparency   // ofs = 53192 ord = 2 addr = 0
	return 
	}
...
public final paint( com.whatsapp.field.RoundedFilledBorder, net.rim.device.api.ui.Graphics, net.rim.device.api.ui.XYRect ); // address: 0
	...
	istore_4 
	aload_1 
	aload_0_getfield transparency   // get_name_1:  transparency   // get_name_2:  transparency   // get_Name:    transparency   // getName->1:  transparency   // getName->2:  transparency   // getName->N:  transparency   // ofs = 53192 ord = 2 addr = 0
	invokevirtual setGlobalAlpha( net.rim.device.api.ui.Graphics, int ) // pc=2
	aload_1 
	aload_0_getfield fillColor   // get_name_1:  fillColor   // get_name_2:  fillColor   // get_Name:    fillColor   // getName->1:  fillColor   // getName->2:  fillColor   // getName->N:  fillColor   // ofs = 53184 ord = 0 addr = 0
	...
	aload_1 
	aload_0_getfield edgeColor   // get_name_1:  edgeColor   // get_name_2:  edgeColor   // get_Name:    edgeColor   // getName->1:  edgeColor   // getName->2:  edgeColor   // getName->N:  edgeColor   // ofs = 53188 ord = 1 addr = 0
	invokevirtual setColor( net.rim.device.api.ui.Graphics, int ) // pc=2
	aload_1 
	aload_2 
	getfield x   // get_name_1:  x   // get_name_2:  x   // get_Name:    x   // getName->1:  x   // getName->2:  x   // getName->N:  x   // ofs = -1 ord = 1 addr = -1
