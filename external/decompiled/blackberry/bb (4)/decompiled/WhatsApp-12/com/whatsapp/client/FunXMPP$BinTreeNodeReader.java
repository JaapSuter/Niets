...
Label24:
	...
	dup 
	ldc literal_866:"nextTree sees 0 list or null tag"
	aload_0 
...
Label23:
	...
	dup 
	ldc literal_867:"invalid list size in readListSize: token "
...
private final java.lang.String com.whatsapp.client.FunXMPP$BinTreeNodeReader.routine_3064( com.whatsapp.client.FunXMPP$BinTreeNodeReader, int ); // address: 0
	...
	new FunXMPP$CorruptStreamException
	dup 
	ldc literal_868:"-1 token in readString"
	aload_0 
	invokevirtual_short .virtual_4 // idx=4 pc=1
	invokespecial com.whatsapp.client.FunXMPP$CorruptStreamException.<init> // pc=3
	athrow 
...
Label90:
	new FunXMPP$CorruptStreamException
	dup 
	ldc literal_871:"readString couldn't reconstruct jid"
	aload_0 
	invokevirtual_short .virtual_4 // idx=4 pc=1
	invokespecial com.whatsapp.client.FunXMPP$CorruptStreamException.<init> // pc=3
	athrow 
Label97:
	new FunXMPP$CorruptStreamException
	dup 
	ldc literal_872:"readString couldn't match token"
	aload_0 
	invokevirtual_short .virtual_4 // idx=4 pc=1
	invokespecial com.whatsapp.client.FunXMPP$CorruptStreamException.<init> // pc=3
	athrow 
...
Label14:
	...
	new FunXMPP$CorruptStreamException
	dup 
	ldc literal_873:"invalid token/length in getToken"
	aload_0 
	invokevirtual_short .virtual_4 // idx=4 pc=1
	invokespecial com.whatsapp.client.FunXMPP$CorruptStreamException.<init> // pc=3
	athrow 
...
public final streamStart( com.whatsapp.client.FunXMPP$BinTreeNodeReader ); // address: 0
	...
	new FunXMPP$CorruptStreamException
	dup 
	ldc literal_865:"expecting STREAM_START in streamStart"
	aload_0 
	invokevirtual_short .virtual_4 // idx=4 pc=1
	invokespecial com.whatsapp.client.FunXMPP$CorruptStreamException.<init> // pc=3
	athrow 
