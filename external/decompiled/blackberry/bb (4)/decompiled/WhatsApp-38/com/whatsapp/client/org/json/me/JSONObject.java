...
Label11:
	...
	dup 
	ldc literal_114:"JSON does not allow non-finite numbers"
	invokespecial_lib .routine_1403 // pc=2
	athrow 
Label16:
	aload_0 
...
Label24:
	new_lib com.whatsapp.client.org.json.me.JSONException//module:WhatsApp-36.class#4 module:WhatsApp-36.class#4 module:WhatsApp-36.class#4
	dup 
	ldc literal_115:"JSON does not allow non-finite numbers."
	invokespecial_lib .routine_1403 // pc=2
	athrow 
Label29:
	return 
...
Label26:
	...
	new_lib net.rim.device.api.ui.component.LabelField//net.rim.device.api.ui.component.LabelField net.rim.device.api.ui.component.LabelField net.rim.device.api.ui.component.LabelField
	dup 
	ldc literal_117:"Bad value from toJSONString: "
	invokespecial_lib java.lang.StringBuffer.<init> // pc=2
	aload_1 
...
Label9:
	aload_1 
	invokeinterface interfacemethodref_11 // pc=1 guess=0
	ifeq Label41
	aload_2 
...
Label20:
	aload_1 
	invokeinterface interfacemethodref_12 // pc=1 guess=1
	astore_3 
	aload_2 
	aload_3 
	invokevirtual_short .toString // idx=2 pc=1
