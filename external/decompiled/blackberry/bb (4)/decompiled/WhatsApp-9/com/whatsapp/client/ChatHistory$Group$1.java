...

{
	...
	// @@@@@@@@@@@@@ Fields 
	private net.rim.device.api.util.Comparator /*net.rim.device.api.util.Comparator*/  field_53524 ; // ofs = 53524 addr = 0)
...
Label23:
	...
	aload_1 
	aload_2 
	invokeinterface interfacemethodref_92 // pc=3 guess=4
	ireturn 
	}
