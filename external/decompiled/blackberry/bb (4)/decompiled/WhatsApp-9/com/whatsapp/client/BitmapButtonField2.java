...
public <init>( com.whatsapp.client.BitmapButtonField2, net.rim.device.api.system.Bitmap, long ); // address: 0
	...
	aload_0 
	aload_1 
	putfield bitmap   // get_name_1:  bitmap   // get_name_2:  bitmap   // get_Name:    bitmap   // getName->1:  bitmap   // getName->2:  bitmap   // getName->N:  bitmap   // ofs = 53362 ord = 0 addr = 0
	return 
	}
...
public final int getPreferredHeight( com.whatsapp.client.BitmapButtonField2 ); // address: 0
	{
	enter_narrow 
	aload_0_getfield bitmap   // get_name_1:  bitmap   // get_name_2:  bitmap   // get_Name:    bitmap   // getName->1:  bitmap   // getName->2:  bitmap   // getName->N:  bitmap   // ofs = 53362 ord = 0 addr = 0
