...

{
	...
	// @@@@@@@@@@@@@ Fields 
	public String /*java.lang.String*/  _jid ; // ofs = 54446 addr = 0)
	public boolean /*boolean*/  _dirty ; // ofs = 54450 addr = 0)
	public java.util.Vector /*java.util.Vector*/  _messagesV ; // ofs = 54454 addr = 0)
	public java.util.Hashtable /*java.util.Hashtable*/  _messagesHT ; // ofs = 54458 addr = 0)
	public String /*java.lang.String*/  _unsentLine ; // ofs = 54462 addr = 0)
	public int /*int*/  _chatState ; // ofs = 54466 addr = 0)
	public com.whatsapp.client. /*module:WhatsApp-10.class#0*/  _groupChat ; // ofs = 54470 addr = 0)
	public boolean /*boolean*/  _storagePreviousMessageEnabled ; // ofs = 54474 addr = 0)
	public boolean /*boolean*/  _storagePreviousMessageConfigured ; // ofs = 54478 addr = 0)
	private com.whatsapp.client.ChatHistory$ApplicationMessageAdapter /*com.whatsapp.client.ChatHistory$ApplicationMessageAdapter*/  field_54482 ; // ofs = 54482 addr = 0)
...
public <init>( com.whatsapp.client.ChatHistory, java.lang.String ); // address: 0
	...
	aload_0 
	aload_0 
	invokespecial com.whatsapp.client.ChatHistory.routine_7723 // pc=1
...
Label15:
	...
	checkcast_lib com.whatsapp.client.//module:WhatsApp-13.class#8 module:WhatsApp-13.class#8 module:WhatsApp-13.class#8
	astore_2 
	aload_2 
	ifnull Label51
...
static public final net.rim.device.api.system.Bitmap getPhoto( module:WhatsApp-13.class#8, int ); // address: 0
	{
	enter 
	aconst_null 
	astore_2 
...
Label29:
	...
	areturn 
Label33:
	getstatic_lib module:WhatsApp-13.class#7.static_23 // class#7
	iload_1 
	iload_1 
	getstatic_lib module:WhatsApp-13.class#7.static_25 // class#7
	invokestatic_lib module:WhatsApp-13.class#7.routine_9380(  ) // class#7
	areturn 
	}
...
static public final net.rim.device.api.system.Bitmap getGroupPhoto( module:WhatsApp-10.class#0, int ); // address: 0
	...
	ifnonnull Label9
	getstatic_lib module:WhatsApp-13.class#7.static_24 // class#7
	iload_1 
	iload_1 
...
Label33:
	...
	iload_1 
	iload_1 
	invokestatic_lib module:WhatsApp-13.class#7.routine_9337(  ) // class#7
	astore_4 
	aload_4 
...
static public final boolean isMuted( java.lang.String ); // address: 0
	...
	aload_2 
	aload_0 
	invokenonvirtual_lib .routine_2769 // pc=2
	lstore 3
	lload 3
...
Label17:
	...
	iconst_0 
	i2l 
	invokenonvirtual_lib .routine_2811 // pc=4
	aload_1 
	aload_2 
...
public final addMessage( com.whatsapp.client.ChatHistory, module:WhatsApp-16.class#28 ); // address: 0
	{
	enter 
	synch 
...
Label8:
	aload_0 
	invokespecial com.whatsapp.client.ChatHistory.routine_7689 // pc=1
	istore_2 
	aload_0 
	invokespecial com.whatsapp.client.ChatHistory.routine_7723 // pc=1
	istore_3 
...
Label33:
	...
	bipush -1
	if_icmpeq Label45
	ldc literal_70:"system"
	ldc_nullstr 
	ldc literal_71:"store"
	iload_4 
	invokestatic_lib module:WhatsApp-6.class#0.routine_10094(  ) // class#0
	astore_5 
...
public final deleteMessage( com.whatsapp.client.ChatHistory, module:WhatsApp-16.class#28 ); // address: 0
	{
	enter_narrow 
	synch 
	aload_0_getfield .field_3_3   // get_name_1:  .field_3_3   // get_name_2:  .field_3_3   // get_Name:    .field_3_3   // getName->1:  null   // getName->2:  null   // getName->N:  null   // ofs = -1 ord = 0 addr = 3
...
private final boolean com.whatsapp.client.ChatHistory.routine_7689( com.whatsapp.client.ChatHistory ); // address: 0
	{
	enter_narrow 
	aload_0 
	invokespecial com.whatsapp.client.ChatHistory.routine_7723 // pc=1
	...
	invokeinterface interfacemethodref_13 // pc=1 guess=13
	ifeq Label9
	iconst_1 
	ireturn 
Label9:
...
private final boolean com.whatsapp.client.ChatHistory.routine_7723( com.whatsapp.client.ChatHistory ); // address: 0
	{
	enter_narrow 
	invokestatic_lib module:WhatsApp-24.class#13.routine_9245(  ) // class#13
...
Label7:
	...
	aload_2 
	iload_1 
	invokestatic net.rim.device.api.system.Bitmap getPhoto( module:WhatsApp-13.class#8, int ) // ChatHistory
	areturn 
	}


public final module:WhatsApp-16.class#28 getLastMessage( com.whatsapp.client.ChatHistory ); // address: 0
	{
	enter_narrow 
	aload_0_getfield .field_2_2   // get_name_1:  .field_2_2   // get_name_2:  .field_2_2   // get_Name:    .field_2_2   // getName->1:  null   // getName->2:  null   // getName->N:  null   // ofs = -1 ord = 0 addr = 2
...
public final module:WhatsApp-16.class#28 getLastNonSystemMessage( com.whatsapp.client.ChatHistory ); // address: 0
	{
	enter_narrow 
	aload_0_getfield .field_2_2   // get_name_1:  .field_2_2   // get_name_2:  .field_2_2   // get_Name:    .field_2_2   // getName->1:  null   // getName->2:  null   // getName->N:  null   // ofs = -1 ord = 0 addr = 2
	invokevirtual int size( java.util.Vector ) // pc=1
