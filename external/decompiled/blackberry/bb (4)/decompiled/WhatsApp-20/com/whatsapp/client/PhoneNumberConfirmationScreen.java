...
Label75:
	...
	invokevirtual append( net.rim.blackberry.api.browser.URLEncodedPostData, java.lang.String, java.lang.String ) // pc=3
	aload 8
	ldc literal_571:"method"
	aload_0 
	invokevirtual append( net.rim.blackberry.api.browser.URLEncodedPostData, java.lang.String, java.lang.String ) // pc=3
	aload 8
	ldc literal_572:"imsi"
	invokestatic_lib module:WhatsApp-35.class#0.routine_2099(  ) // class#0
	invokevirtual append( net.rim.blackberry.api.browser.URLEncodedPostData, java.lang.String, java.lang.String ) // pc=3
	aload 8
	ldc literal_573:"reason"
	aload_1 
	invokevirtual append( net.rim.blackberry.api.browser.URLEncodedPostData, java.lang.String, java.lang.String ) // pc=3
	new_lib Thread//java.lang.Thread java.lang.Thread java.lang.Thread
	dup 
	ldc literal_574:"https://r.whatsapp.net/v1/code.php?"
	...
	ifnull Label121
	aload 14
	invokeinterface interfacemethodref_85 // pc=1 guess=4
	goto Label121
	astore 21
Label121:
	aload 16
...
Label123:
	...
	invokeinterface interfacemethodref_86 // pc=3 guess=5
	aload 14
	invokeinterface interfacemethodref_87 // pc=1 guess=6
	istore 16
	iload 16
	sipush 200
	if_icmpeq Label156
...
Label156:
	aload 14
	invokeinterface interfacemethodref_88 // pc=1 guess=7
	astore 17
	aload 17
...
static private final java.lang.String[] com.whatsapp.client.PhoneNumberConfirmationScreen.routine_5454( java.io.InputStream ); // address: 0
	...
	invokeinterface interfacemethodref_81 // pc=2 guess=8
	aload_2 
	invokeinterface interfacemethodref_82 // pc=1 guess=9
	pop 
	aload_2 
	bipush 2
	aconst_null 
	ldc literal_575:"code"
	invokeinterface interfacemethodref_83 // pc=4 guess=10
	aload_2 
	invokeinterface interfacemethodref_82 // pc=1 guess=9
	pop 
	aload_2 
	bipush 2
	aconst_null 
	ldc literal_557:"response"
	invokeinterface interfacemethodref_83 // pc=4 guess=10
	aload_2 
	aconst_null 
	ldc literal_558:"status"
	invokeinterface interfacemethodref_84 // pc=3 guess=11
	astore_3 
	aload_2 
	aconst_null 
	ldc literal_559:"result"
	invokeinterface interfacemethodref_84 // pc=3 guess=11
	astore_4 
	aload_1 
	iconst_0 
...
static public final java.lang.String blockingCheckCode( java.lang.String ); // address: 0
	...
	new_lib Thread//java.lang.Thread java.lang.Thread java.lang.Thread
	dup 
	ldc literal_577:"https://r.whatsapp.net/v1/register.php?"
	invokespecial_lib java.lang.StringBuffer.<init> // pc=2
	aload_7 
	invokevirtual_short .toString // idx=2 pc=1
	invokevirtual java.lang.StringBuffer append( java.lang.StringBuffer, java.lang.String ) // pc=2
	...
	ifnull Label72
	aload 9
	invokeinterface interfacemethodref_85 // pc=1 guess=12
	goto Label72
	astore 16
Label72:
	aload 11
...
Label74:
	...
	getstatic_lib module:WhatsApp-12.class#0.static_55 // class#0
	invokestatic_lib module:WhatsApp-35.class#0.routine_2595(  ) // class#0
	invokeinterface interfacemethodref_86 // pc=3 guess=13
	aload 9
	invokeinterface interfacemethodref_87 // pc=1 guess=14
	istore 11
	iload 11
	sipush 200
	if_icmpeq Label107
	ldc literal_578:"fail-http"
	astore 12
	aload 9
	ifnull Label105
	aload 9
...
Label107:
	aload 9
	invokeinterface interfacemethodref_88 // pc=1 guess=15
	astore 12
	aload 12
...
Label119:
	...
	areturn 
	astore 10
	ldc literal_579:"fail-exception"
	astore 11
	aload 9
	ifnull Label130
	aload 9
...
static private final java.lang.String com.whatsapp.client.PhoneNumberConfirmationScreen.routine_6076( java.io.InputStream ); // address: 0
	...
	getstatic_lib module:WhatsApp-12.class#0.static_2 // class#0
	invokespecial_lib java.io.InputStreamReader.<init> // pc=3
	invokeinterface interfacemethodref_81 // pc=2 guess=16
	aload_2 
	invokeinterface interfacemethodref_82 // pc=1 guess=17
	pop 
	aload_2 
	bipush 2
	aconst_null 
	ldc literal_580:"register"
	invokeinterface interfacemethodref_83 // pc=4 guess=18
	aload_2 
	invokeinterface interfacemethodref_82 // pc=1 guess=17
	pop 
	aload_2 
	...
	aconst_null 
	ldc literal_558:"status"
	invokeinterface interfacemethodref_84 // pc=3 guess=19
	astore_3 
	aload_2 
	aconst_null 
	ldc literal_581:"login"
	invokeinterface interfacemethodref_84 // pc=3 guess=19
	astore_4 
	aload_2 
	aconst_null 
...
private final java.lang.String parseSameDeviceData( com.whatsapp.client.PhoneNumberConfirmationScreen, java.io.InputStream ); // address: 0
	...
	getstatic_lib module:WhatsApp-12.class#0.static_2 // class#0
	invokespecial_lib java.io.InputStreamReader.<init> // pc=3
	invokeinterface interfacemethodref_81 // pc=2 guess=0
	aload_2 
	invokeinterface interfacemethodref_82 // pc=1 guess=1
	pop 
	aload_2 
	bipush 2
	aconst_null 
	ldc literal_556:"exist"
	invokeinterface interfacemethodref_83 // pc=4 guess=2
	aload_2 
	invokeinterface interfacemethodref_82 // pc=1 guess=1
	pop 
	aload_2 
	...
	aconst_null 
	ldc literal_558:"status"
	invokeinterface interfacemethodref_84 // pc=3 guess=3
	astore_3 
	aload_2 
	aconst_null 
	ldc literal_559:"result"
...
private final showSMSConfirmationScreen( com.whatsapp.client.PhoneNumberConfirmationScreen, java.lang.String ); // address: 0
	...
	aload_2 
	new_lib com.whatsapp.client.//module:WhatsApp-5.class#6 module:WhatsApp-5.class#6 module:WhatsApp-5.class#6
	dup 
	iconst_1 
	aload_1 
...
private final showVoiceConfirmationScreen( com.whatsapp.client.PhoneNumberConfirmationScreen, java.lang.String ); // address: 0
	{
	enter 
	new_lib com.whatsapp.client.//module:WhatsApp-7.class#10 module:WhatsApp-7.class#10 module:WhatsApp-7.class#10
	dup 
	aload_1 
