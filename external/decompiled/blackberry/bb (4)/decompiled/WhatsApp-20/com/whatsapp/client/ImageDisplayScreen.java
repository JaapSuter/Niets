...

{
	...
	private com.whatsapp.client. /*module:WhatsApp.class#12*/  _targetCID ; // ofs = 53034 addr = 0)
...
Label42:
	...
	dup 
	ldc literal_52:"Couldn't save picture to contact, got error: "
...
Label9:
	...
	goto Label29
	astore_3 
	ldc literal_51:"Couldn't create contact picture from image"
	invokestatic_lib alert( java.lang.String ) // Dialog
	return 
Label29:
	aload_0_getfield _targetCID   // get_name_1:  _targetCID   // get_name_2:  _targetCID   // get_Name:    _targetCID   // getName->1:  _targetCID   // getName->2:  _targetCID   // getName->N:  _targetCID   // ofs = 53034 ord = 26 addr = 0
...
Label40:
	...
	instanceof_lib com.whatsapp.client.//module:WhatsApp-13.class#0 module:WhatsApp-13.class#0 module:WhatsApp-13.class#0
	ifeq Label53
	invokestatic_lib com.whatsapp.client.UiApp.routine_9623(  ) // UiApp
	invokevirtual net.rim.device.api.ui.Screen getActiveScreen( net.rim.device.api.ui.UiApplication ) // pc=1
