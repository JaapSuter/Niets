...
{
	// @@@@@@@@@@@@@ Static fields 
	private static byte[] /*byte[]*/  field_54862 ; // ofs = 54862 addr = 11)
...
private <init>( com.whatsapp.client.SyncManager$UTF8URLEncoder ); // address: 0
	...
	aload_0 
	new_lib java.io.InputStreamReader//java.io.InputStreamReader java.io.InputStreamReader java.io.InputStreamReader
	dup 
	sipush 1024
	sipush 4096
...
<init>( com.whatsapp.client.SyncManager$UTF8URLEncoder, module:WhatsApp-30.class#5 ); // address: 0
	{
	enter_narrow 
	aload_0 
...
static final <clinit>(  ); // address: 0
	...
	putstatic com.whatsapp.client.SyncManager$UTF8URLEncoder.field_54862 // SyncManager$UTF8URLEncoder
	clinit_return 
	}

	// @@@@@@@@@@@@@ Non-virtual routines 

private final byte[] com.whatsapp.client.SyncManager$UTF8URLEncoder.routine_5906( com.whatsapp.client.SyncManager$UTF8URLEncoder, java.lang.String, boolean ); // address: 0
	{
	enter 
	aload_1 
...
Label85:
	...
	istore_7 
	aload_4 
	getstatic com.whatsapp.client.SyncManager$UTF8URLEncoder.field_54862 // SyncManager$UTF8URLEncoder
	iload_7 
	bipush 4
	ishr 
	baload 
...
public final append( com.whatsapp.client.SyncManager$UTF8URLEncoder, java.lang.String, java.lang.String ); // address: 0
	...
	aload_1 
	iconst_0 
	invokespecial com.whatsapp.client.SyncManager$UTF8URLEncoder.routine_5906 // pc=3
	astore_3 
	aload_0 
	aload_2 
	iconst_0 
