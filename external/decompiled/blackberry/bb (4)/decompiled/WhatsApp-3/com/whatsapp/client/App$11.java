...

{
	...
	// @@@@@@@@@@@@@ Fields 
	private final long /*long*/  field_57830 ; // ofs = 57830 addr = 0)
	private final com.whatsapp.client.App /*com.whatsapp.client.App*/  field_57834 ; // ofs = 57834 addr = 0)

	// @@@@@@@@@@@@@ Static routines 

<init>( com.whatsapp.client.App$11, com.whatsapp.client.App, long ); // address: 0
	{
	enter 
	aload_0 
...
public final run( com.whatsapp.client.App$11 ); // address: 0
	...
	invokestatic_lib module:WhatsApp-9.class#0.routine_921(  ) // class#0
	return 
	astore_1 
	return 
	}
