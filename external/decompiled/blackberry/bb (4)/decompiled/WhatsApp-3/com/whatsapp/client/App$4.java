...
abstract final class App$4 extends Object
implements Runnable

{

	// @@@@@@@@@@@@@ Fields 
	private final com.whatsapp.client.App /*com.whatsapp.client.App*/  field_58696 ; // ofs = 58696 addr = 0)

	// @@@@@@@@@@@@@ Static routines 

<init>( com.whatsapp.client.App$4, com.whatsapp.client.App ); // address: 0
	{
	enter_narrow 
	aload_0 
...
public final run( com.whatsapp.client.App$4 ); // address: 0
	{
	enter_narrow 
	...
	invokenonvirtual_lib .routine_1949 // pc=1
	return 
	astore_1 
	return 
	}
