...

{
	...
	// @@@@@@@@@@@@@ Fields 
	private long /*long*/  field_59032 ; // ofs = 59032 addr = 0)
	private com.whatsapp.client. /*module:WhatsApp-10.class#31*/  field_59036 ; // ofs = 59036 addr = 0)

	// @@@@@@@@@@@@@ Static routines 

public <init>( com.whatsapp.client.App$AllFilesListener, module:WhatsApp-10.class#31 ); // address: 0
	{
	enter_narrow 
	aload_0 
