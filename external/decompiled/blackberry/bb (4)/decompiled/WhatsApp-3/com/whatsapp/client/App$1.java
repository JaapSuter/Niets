...
abstract final class App$1 extends Object
implements Runnable

{

	// @@@@@@@@@@@@@ Fields 
	private final com.whatsapp.client. /*module:WhatsApp.class#10*/  field_57722 ; // ofs = 57722 addr = 0)
	private final com.whatsapp.client.App /*com.whatsapp.client.App*/  field_57726 ; // ofs = 57726 addr = 0)

	// @@@@@@@@@@@@@ Static routines 

<init>( com.whatsapp.client.App$1, com.whatsapp.client.App, module:WhatsApp.class#10 ); // address: 0
	{
	enter_narrow 
	aload_0 
...
public final run( com.whatsapp.client.App$1 ); // address: 0
	{
	enter_narrow 
	sipush 30000
	i2l 
