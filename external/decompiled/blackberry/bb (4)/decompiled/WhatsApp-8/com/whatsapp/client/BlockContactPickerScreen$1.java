...

{
	...
	// @@@@@@@@@@@@@ Fields 
	private final com.whatsapp.client.BlockContactPickerScreen /*com.whatsapp.client.BlockContactPickerScreen*/  field_59478 ; // ofs = 59478 addr = 0)
...
public final boolean filter( com.whatsapp.client.BlockContactPickerScreen$1, module:WhatsApp-10.class#34 ); // address: 0
	{
	enter_narrow 
	...
	getfield _currentList   // get_name_1:  _currentList   // get_name_2:  _currentList   // get_Name:    _currentList   // getName->1:  _currentList   // getName->2:  _currentList   // getName->N:  _currentList   // ofs = -1 ord = 0 addr = -1
	aload_1 
