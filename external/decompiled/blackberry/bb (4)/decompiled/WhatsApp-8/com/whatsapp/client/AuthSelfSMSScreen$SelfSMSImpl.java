...

{
	...
	// @@@@@@@@@@@@@ Fields 
	private com.whatsapp.client.AuthSelfSMSScreen$SelfSMSImpl$SendThread /*com.whatsapp.client.AuthSelfSMSScreen$SelfSMSImpl$SendThread*/  _sender ; // ofs = 54556 addr = 0)
	private int /*int*/  field_54560 ; // ofs = 54560 addr = 0)
...
public <init>( com.whatsapp.client.AuthSelfSMSScreen$SelfSMSImpl ); // address: 0
	...
	enter_narrow 
	aload_0 
	invokespecial_lib .routine_11817 // pc=1
	aload_0 
	bipush -1
...
private final boolean com.whatsapp.client.AuthSelfSMSScreen$SelfSMSImpl.routine_493( com.whatsapp.client.AuthSelfSMSScreen$SelfSMSImpl, java.lang.String, java.lang.String ); // address: 0
	{
	enter 
	aload_1 
	ifnull Label5
...
public final sendTextMessage( com.whatsapp.client.AuthSelfSMSScreen$SelfSMSImpl, java.lang.String ); // address: 0
	...
	ifnull Label12
	aload_0_getfield .field_0_   // get_name_1:  .field_0_   // get_name_2:  .field_0_   // get_Name:    .field_0_   // getName->1:  null   // getName->2:  null   // getName->N:  null   // ofs = -1 ord = 0 addr = 0
	ldc literal_371:"fail-nodata"
	ldc_nullstr 
	invokeinterface interfacemethodref_7 // pc=3 guess=1
Label12:
	return 
Label13:
...
protected final receivedSmsMessage( com.whatsapp.client.AuthSelfSMSScreen$SelfSMSImpl, java.lang.String, java.lang.String ); // address: 0
	...
	invokeinterface interfacemethodref_8 // pc=2 guess=2
Label7:
	aload_0 
	aload_1 
	aload_0 
	invokevirtual_short .virtual_10 // idx=10 pc=1
	invokespecial com.whatsapp.client.AuthSelfSMSScreen$SelfSMSImpl.routine_493 // pc=3
	ifne Label20
	aload_0_getfield .field_0_   // get_name_1:  .field_0_   // get_name_2:  .field_0_   // get_Name:    .field_0_   // getName->1:  null   // getName->2:  null   // getName->N:  null   // ofs = -1 ord = 0 addr = 0
	ifnull Label19
	aload_0_getfield .field_0_   // get_name_1:  .field_0_   // get_name_2:  .field_0_   // get_Name:    .field_0_   // getName->1:  null   // getName->2:  null   // getName->N:  null   // ofs = -1 ord = 0 addr = 0
