...
abstract final class AuthVoiceScreen$7$1$1 extends Object
implements Runnable

{

	// @@@@@@@@@@@@@ Fields 
	private final net.rim.device.api.ui.text.TextFilter /*net.rim.device.api.ui.text.TextFilter*/  field_55664 ; // ofs = 55664 addr = 0)
	private final com.whatsapp.client.AuthVoiceScreen$7$1 /*com.whatsapp.client.AuthVoiceScreen$7$1*/  field_55668 ; // ofs = 55668 addr = 0)

	// @@@@@@@@@@@@@ Static routines 

<init>( com.whatsapp.client.AuthVoiceScreen$7$1$1, com.whatsapp.client.AuthVoiceScreen$7$1, net.rim.device.api.ui.text.TextFilter ); // address: 0
	{
	enter_narrow 
	aload_0 
...
public final run( com.whatsapp.client.AuthVoiceScreen$7$1$1 ); // address: 0
	{
	enter_narrow 
