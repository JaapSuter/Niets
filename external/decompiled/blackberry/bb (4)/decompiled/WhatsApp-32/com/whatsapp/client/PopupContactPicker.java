...
static <clinit>(  ); // address: 0
	...
	ldc literal_729:"9500"
	invokenonvirtual_lib java.lang.String.startsWith // pc=2
	ifne Label18
	getstatic _deviceName // PopupContactPicker
	ldc literal_730:"9530"
	invokenonvirtual_lib java.lang.String.startsWith // pc=2
	ifne Label18
	getstatic _deviceName // PopupContactPicker
	ldc literal_731:"9550"
	invokenonvirtual_lib java.lang.String.startsWith // pc=2
	ifeq Label20
Label18:
	iconst_1 
...
Label7:
	aload_0_getfield _wrappedPicker   // get_name_1:  _wrappedPicker   // get_name_2:  _wrappedPicker   // get_Name:    _wrappedPicker   // getName->1:  _wrappedPicker   // getName->2:  _wrappedPicker   // getName->N:  _wrappedPicker   // ofs = 53328 ord = 2 addr = 0
	invokevirtual net.rim.device.api.ui.Manager getManager( net.rim.device.api.ui.Field ) // pc=1
	checkcast_lib com.whatsapp.field.PopupManager//module:WhatsApp-38.class#7 module:WhatsApp-38.class#7 module:WhatsApp-38.class#7
	aconst_null 
	aconst_null 
	invokeinterface interfacemethodref_108 // pc=3 guess=0
	aload_0 
	aconst_null 
...
Label13:
	...
	aload_2 
	aload_0 
	invokeinterface interfacemethodref_108 // pc=3 guess=1
	aload_2 
