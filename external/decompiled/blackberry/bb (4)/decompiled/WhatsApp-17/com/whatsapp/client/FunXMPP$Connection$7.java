...
public final parse( com.whatsapp.client.FunXMPP$Connection$7, module:WhatsApp-18.class#3, java.lang.String ); // address: 0
	...
	invokeinterface interfacemethodref_60 // pc=4 guess=35
Label23:
	return 
	}
...
public final error( com.whatsapp.client.FunXMPP$Connection$7, int ); // address: 0
	...
	aconst_null 
	aconst_null 
	invokeinterface interfacemethodref_60 // pc=4 guess=36
	return 
Label11:
	aload_0_getfield .field_1_1   // get_name_1:  .field_1_1   // get_name_2:  .field_1_1   // get_Name:    .field_1_1   // getName->1:  null   // getName->2:  null   // getName->N:  null   // ofs = -1 ord = 0 addr = 1
	getfield .field_6_6   // get_name_1:  .field_6_6   // get_name_2:  .field_6_6   // get_Name:    .field_6_6   // getName->1:  null   // getName->2:  null   // getName->N:  null   // ofs = -1 ord = 0 addr = 6
	aload_0_getfield .field_0_   // get_name_1:  .field_0_   // get_name_2:  .field_0_   // get_Name:    .field_0_   // getName->1:  null   // getName->2:  null   // getName->N:  null   // ofs = -1 ord = 0 addr = 0
	iload_1 
	invokeinterface interfacemethodref_61 // pc=3 guess=37
	return 
	}
