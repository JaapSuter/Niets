...
abstract public parse( com.whatsapp.client.FunXMPP$IqResultHandler, module:WhatsApp-18.class#3, java.lang.String ); // address: 0
	{
	halt 
	}
...
public error( com.whatsapp.client.FunXMPP$IqResultHandler, module:WhatsApp-18.class#3 ); // address: 0
	{
	enter 
	aload_1 
