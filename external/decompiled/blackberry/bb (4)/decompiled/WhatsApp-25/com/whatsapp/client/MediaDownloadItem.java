...
Label53:
	...
	invokeinterface interfacemethodref_10 // pc=3 guess=1
	aload_3 
	...
	new_lib net.rim.device.api.collection.ReadableList//net.rim.device.api.collection.ReadableList net.rim.device.api.collection.ReadableList net.rim.device.api.collection.ReadableList
	dup 
	ldc literal_165:"HTTP response code: "
...
Label90:
	...
	invokeinterface interfacemethodref_12 // pc=3 guess=3
	istore 8
	aload_3 
	invokeinterface interfacemethodref_13 // pc=1 guess=4
	astore_4 
	aload_3 
	invokeinterface interfacemethodref_14 // pc=1 guess=5
	astore 9
	iconst_0 
	istore 10
	iconst_0 
