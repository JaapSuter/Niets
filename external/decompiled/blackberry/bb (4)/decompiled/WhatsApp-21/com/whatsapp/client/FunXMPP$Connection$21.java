...
Label13:
	...
	invokeinterface interfacemethodref_91 // pc=2 guess=24
	iinc 5 1
	goto Label13
Label28:
	...
	ifnull Label32
	aload_0_getfield .field_0_   // get_name_1:  .field_0_   // get_name_2:  .field_0_   // get_Name:    .field_0_   // getName->1:  null   // getName->2:  null   // getName->N:  null   // ofs = -1 ord = 0 addr = 0
	invokeinterface interfacemethodref_83 // pc=1 guess=25
Label32:
	return 
	}
...
public final error( com.whatsapp.client.FunXMPP$Connection$21, int ); // address: 0
	...
	aload_0_getfield .field_1_1   // get_name_1:  .field_1_1   // get_name_2:  .field_1_1   // get_Name:    .field_1_1   // getName->1:  null   // getName->2:  null   // getName->N:  null   // ofs = -1 ord = 0 addr = 1
	iload_1 
	invokeinterface interfacemethodref_82 // pc=2 guess=26
Label6:
	return 
	}
