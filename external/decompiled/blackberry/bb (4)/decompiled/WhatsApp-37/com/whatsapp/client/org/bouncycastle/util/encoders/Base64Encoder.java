...

{
	...
	// @@@@@@@@@@@@@ Fields 
	protected final byte[] /*byte[]*/  encodingTable ; // ofs = 53544 addr = 0)
	protected byte /*byte*/  padding ; // ofs = 53548 addr = 0)
	protected final byte[] /*byte[]*/  decodingTable ; // ofs = 53552 addr = 0)
