...

{
	...
	// @@@@@@@@@@@@@ Fields 
	private final String /*java.lang.String*/  field_55164 ; // ofs = 55164 addr = 0)
	private final com.whatsapp.client.SqliteMessageStore /*module:WhatsApp-30.class#0*/  field_55168 ; // ofs = 55168 addr = 0)

	// @@@@@@@@@@@@@ Static routines 

<init>( com.whatsapp.client.SqliteMessageStore$2, module:WhatsApp-30.class#0, java.lang.String ); // address: 0
	{
	enter_narrow 
	aload_0 
...
public final onParticipantsReported( com.whatsapp.client.SqliteMessageStore$2, java.util.Vector ); // address: 0
	...
	pop 
	aload_0_getfield .field_1_1   // get_name_1:  .field_1_1   // get_name_2:  .field_1_1   // get_Name:    .field_1_1   // getName->1:  null   // getName->2:  null   // getName->N:  null   // ofs = -1 ord = 0 addr = 1
	invokespecial_lib .routine_7933 // pc=1
	return 
	}
