...
static public final int drawText( module:WhatsApp-14.class#20, net.rim.device.api.ui.Graphics, int, int, int, int, net.rim.device.api.ui.DrawTextParam ); // address: 0
	...
	enter 
	aload_0 
	invokeinterface interfacemethodref_87 // pc=1 guess=1
	astore_7 
	aload_0 
	invokeinterface interfacemethodref_88 // pc=1 guess=2
	istore 8
	aload_6 
	...
	astore 11
	aload_0 
	invokeinterface interfacemethodref_89 // pc=1 guess=3
	ifne Label36
	aload_0 
	invokeinterface interfacemethodref_90 // pc=1 guess=4
	ifne Label38
Label36:
	bipush -1
	goto Label46
Label38:
	aload_0 
	invokeinterface interfacemethodref_91 // pc=1 guess=5
	iload 8
	iadd 
	iload_2 
	iload 9
...
Label46:
	...
	aload_1 
	aload_0 
	invokeinterface interfacemethodref_92 // pc=1 guess=6
	...
	iload_5 
	aload_6 
	invokeinterface interfacemethodref_93 // pc=7 guess=7
	istore 15
	aload_1 
	iload 16
	invokevirtual setColor( net.rim.device.api.ui.Graphics, int ) // pc=2
