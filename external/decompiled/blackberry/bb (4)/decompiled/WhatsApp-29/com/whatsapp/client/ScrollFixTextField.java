...

{
	...
	// @@@@@@@@@@@@@ Fields 
	public com.whatsapp.client.BBMStyleInputField /*com.whatsapp.client.BBMStyleInputField*/  _inputField ; // ofs = 53970 addr = 0)
	public com.whatsapp.client.BitmapButtonField /*com.whatsapp.client.BitmapButtonField*/  _emojiButton ; // ofs = 53974 addr = 0)
...
public <init>( com.whatsapp.client.ScrollFixTextField, long ); // address: 0
	...
	putfield _inputField   // get_name_1:  _inputField   // get_name_2:  _inputField   // get_Name:    _inputField   // getName->1:  _inputField   // getName->2:  _inputField   // getName->N:  _inputField   // ofs = 53970 ord = 0 addr = 0
	aload_0 
	new_lib com.whatsapp.client.ScrollFixTextField$InnerVFM//com.whatsapp.client.ScrollFixTextField$InnerVFM com.whatsapp.client.ScrollFixTextField$InnerVFM com.whatsapp.client.ScrollFixTextField$InnerVFM
	dup 
	aload_0_getfield _inputField   // get_name_1:  _inputField   // get_name_2:  _inputField   // get_Name:    _inputField   // getName->1:  _inputField   // getName->2:  _inputField   // getName->N:  _inputField   // ofs = 53970 ord = 0 addr = 0
	invokespecial_lib .routine_7714 // pc=2
	putfield _innerVFM   // get_name_1:  _innerVFM   // get_name_2:  _innerVFM   // get_Name:    _innerVFM   // getName->1:  _innerVFM   // getName->2:  _innerVFM   // getName->N:  _innerVFM   // ofs = 53978 ord = 2 addr = 0
	aload_0_getfield _innerVFM   // get_name_1:  _innerVFM   // get_name_2:  _innerVFM   // get_Name:    _innerVFM   // getName->1:  _innerVFM   // getName->2:  _innerVFM   // getName->N:  _innerVFM   // ofs = 53978 ord = 2 addr = 0
	...
	aload_0_getfield _innerVFM   // get_name_1:  _innerVFM   // get_name_2:  _innerVFM   // get_Name:    _innerVFM   // getName->1:  _innerVFM   // getName->2:  _innerVFM   // getName->N:  _innerVFM   // ofs = 53978 ord = 2 addr = 0
	getstatic_lib module:WhatsApp-7.class#22.static_55 // class#22
	...
	invokestatic_lib module:WhatsApp-15.class#5.routine_3779(  ) // class#5
	...
	putfield _emojiButton   // get_name_1:  _emojiButton   // get_name_2:  _emojiButton   // get_Name:    _emojiButton   // getName->1:  _emojiButton   // getName->2:  _emojiButton   // getName->N:  _emojiButton   // ofs = 53974 ord = 1 addr = 0
	aload_0_getfield _emojiButton   // get_name_1:  _emojiButton   // get_name_2:  _emojiButton   // get_Name:    _emojiButton   // getName->1:  _emojiButton   // getName->2:  _emojiButton   // getName->N:  _emojiButton   // ofs = 53974 ord = 1 addr = 0
	bipush 5
	invokenonvirtual_lib .routine_1953 // pc=2
	aload_0_getfield _emojiButton   // get_name_1:  _emojiButton   // get_name_2:  _emojiButton   // get_Name:    _emojiButton   // getName->1:  _emojiButton   // getName->2:  _emojiButton   // getName->N:  _emojiButton   // ofs = 53974 ord = 1 addr = 0
	iconst_1 
	invokenonvirtual_lib .routine_1942 // pc=2
	aload_0_getfield _emojiButton   // get_name_1:  _emojiButton   // get_name_2:  _emojiButton   // get_Name:    _emojiButton   // getName->1:  _emojiButton   // getName->2:  _emojiButton   // getName->N:  _emojiButton   // ofs = 53974 ord = 1 addr = 0
	bipush 5
	bipush 5
	bipush 5
	...
	invokevirtual setMargin( net.rim.device.api.ui.Field, int, int, int, int ) // pc=5
	aload_0_getfield _emojiButton   // get_name_1:  _emojiButton   // get_name_2:  _emojiButton   // get_Name:    _emojiButton   // getName->1:  _emojiButton   // getName->2:  _emojiButton   // getName->N:  _emojiButton   // ofs = 53974 ord = 1 addr = 0
	new_lib com.whatsapp.client.ScrollFixTextField$1//module:WhatsApp-28.class#23 module:WhatsApp-28.class#23 module:WhatsApp-28.class#23
	dup 
	aload_0 
	invokespecial_lib .routine_7661 // pc=2
