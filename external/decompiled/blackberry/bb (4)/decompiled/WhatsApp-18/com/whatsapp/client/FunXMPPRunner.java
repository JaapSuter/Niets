...
{
	// @@@@@@@@@@@@@ Static fields 
	private static String /*java.lang.String*/  field_54078 ; // ofs = 54078 addr = 17)

	// @@@@@@@@@@@@@ Fields 
	private com.whatsapp.client.App /*com.whatsapp.client.App*/  field_54070 ; // ofs = 54070 addr = 0)
	public com.whatsapp.client.FunXMPP$Connection /*module:WhatsApp-17.class#0*/  _connection ; // ofs = 54074 addr = 0)
...
public <init>( com.whatsapp.client.FunXMPPRunner, com.whatsapp.client.App ); // address: 0
	...
	aload_0 
	aload_1 
	putfield com.whatsapp.client.FunXMPPRunner.field_54070   // get_name_1:  com.whatsapp.client.FunXMPPRunner.field_54070   // get_name_2:  com.whatsapp.client.FunXMPPRunner.field_54070   // get_Name:    com.whatsapp.client.FunXMPPRunner.field_54070   // getName->1:     // getName->2:     // getName->N:     // ofs = 54070 ord = 0 addr = 0
	return 
	}
...
static final <clinit>(  ); // address: 0
	{
	enter 
	clinit_lib java.io.Writer//java.io.Writer java.io.Writer java.io.Writer
	synch_static FunXMPPRunner
	clinit_wait 
	ldc literal_124:"time"
	putstatic com.whatsapp.client.FunXMPPRunner.field_54078 // FunXMPPRunner
	clinit_return 
	}

	// @@@@@@@@@@@@@ Non-virtual routines 

private final java.lang.String com.whatsapp.client.FunXMPPRunner.routine_7831( com.whatsapp.client.FunXMPPRunner, boolean, java.lang.String ); // address: 0
	{
	enter 
	iload_1 
	ifeq Label5
...
private final com.whatsapp.client.FunXMPPRunner.routine_7946( com.whatsapp.client.FunXMPPRunner ); // address: 0
	{
	enter 
	aload_0_getfield com.whatsapp.client.FunXMPPRunner.field_54070   // get_name_1:  com.whatsapp.client.FunXMPPRunner.field_54070   // get_name_2:  com.whatsapp.client.FunXMPPRunner.field_54070   // get_Name:    com.whatsapp.client.FunXMPPRunner.field_54070   // getName->1:     // getName->2:     // getName->N:     // ofs = 54070 ord = 0 addr = 0
...
Label12:
	istore_1 
	aload_0_getfield _connection   // get_name_1:  _connection   // get_name_2:  _connection   // get_Name:    _connection   // getName->1:  _connection   // getName->2:  _connection   // getName->N:  _connection   // ofs = 54074 ord = 1 addr = 0
...
Label30:
	aload_0_getfield _connection   // get_name_1:  _connection   // get_name_2:  _connection   // get_Name:    _connection   // getName->1:  _connection   // getName->2:  _connection   // getName->N:  _connection   // ofs = 54074 ord = 1 addr = 0
	invokenonvirtual_lib .routine_3785 // pc=1
Label32:
	return 
	}


private final com.whatsapp.client.FunXMPPRunner.routine_8024( com.whatsapp.client.FunXMPPRunner ); // address: 0
	{
	enter 
	invokestatic_lib module:WhatsApp-10.class#6.routine_2993(  ) // class#6
	iconst_0 
	i2l 
	lcmp 
	ifne Label8
	aload_0_getfield _connection   // get_name_1:  _connection   // get_name_2:  _connection   // get_Name:    _connection   // getName->1:  _connection   // getName->2:  _connection   // getName->N:  _connection   // ofs = 54074 ord = 1 addr = 0
	invokenonvirtual_lib .routine_4426 // pc=1
Label8:
	return 
	}
...
Label120:
	aload 8
	bipush 2
	invokenonvirtual_lib .routine_4774 // pc=2
	aload 8
	invokenonvirtual_lib .routine_5076 // pc=1
	goto_w Label33
Label126:
	aload 8
	...
	iload 12
	aload 17
	invokespecial com.whatsapp.client.FunXMPPRunner.routine_7831 // pc=3
	astore 9
	iconst_0 
	istore 12
	aload 9
...
Label158:
	...
	checkcast_lib java.util.Date//java.util.Date java.util.Date java.util.Date
	astore_4 
	aload_4 
	bipush 2
	iconst_1 
	invokeinterface interfacemethodref_11 // pc=3 guess=24
	aload_4 
	iconst_0 
	iconst_0 
	invokeinterface interfacemethodref_11 // pc=3 guess=24
	...
	astore_6 
	new FunXMPPRunner$MeteredInputStream
	dup 
	aload_5 
	iconst_1 
	aload 8
	invokespecial com.whatsapp.client.FunXMPPRunner$MeteredInputStream.<init> // pc=4
	astore_5 
	aload 15
...
Label203:
	...
	dup 
	new_lib com.whatsapp.client.FunXMPP$BinTreeNodeReader//module:WhatsApp-16.class#3 module:WhatsApp-16.class#3 module:WhatsApp-16.class#3
	dup 
	aload_5 
	getstatic_lib module:WhatsApp-16.class#1.static_5 // class#1
	invokespecial_lib .routine_3432 // pc=3
	new_lib com.whatsapp.client.FunXMPP$BinTreeNodeWriter//module:WhatsApp-16.class#4 module:WhatsApp-16.class#4 module:WhatsApp-16.class#4
	dup 
	aload_6 
	getstatic_lib module:WhatsApp-16.class#1.static_5 // class#1
	invokespecial_lib .routine_4544 // pc=3
	...
	astore 19
	new_lib com.whatsapp.client.FunXMPP$Connection//module:WhatsApp-17.class#0 module:WhatsApp-17.class#0 module:WhatsApp-17.class#0
	dup 
	aload 19
	...
	invokespecial_lib .routine_9028 // pc=10
	astore_3 
	aload 19
	aload_3 
...
Label292:
	...
	invokestatic_lib module:WhatsApp-35.class#0.routine_4706(  ) // class#0
	pop 
	goto_w Label843
Label322:
	aload 8
...
Label384:
	aload_0 
	aconst_null 
	putfield _connection   // get_name_1:  _connection   // get_name_2:  _connection   // get_Name:    _connection   // getName->1:  _connection   // getName->2:  _connection   // getName->N:  _connection   // ofs = 54074 ord = 1 addr = 0
	aload 8
	bipush 2
	invokenonvirtual_lib .routine_4774 // pc=2
	iload 19
	...
	iconst_1 
	bipush 2
	invokeinterface interfacemethodref_14 // pc=4 guess=27
	aload 28
	monitorexit 
	goto Label463
	astore 31
...
Label871:
	...
	aload 20
	invokenonvirtual_lib .routine_2161 // pc=3
	aload_0_getfield _connection   // get_name_1:  _connection   // get_name_2:  _connection   // get_Name:    _connection   // getName->1:  _connection   // getName->2:  _connection   // getName->N:  _connection   // ofs = 54074 ord = 1 addr = 0
	invokenonvirtual_lib .routine_2511 // pc=1
Label887:
	aload_0_getfield com.whatsapp.client.FunXMPPRunner.field_54070   // get_name_1:  com.whatsapp.client.FunXMPPRunner.field_54070   // get_name_2:  com.whatsapp.client.FunXMPPRunner.field_54070   // get_Name:    com.whatsapp.client.FunXMPPRunner.field_54070   // getName->1:     // getName->2:     // getName->N:     // ofs = 54070 ord = 0 addr = 0
	...
	aload_0 
	invokespecial com.whatsapp.client.FunXMPPRunner.routine_7946 // pc=1
	aload_0 
	invokespecial com.whatsapp.client.FunXMPPRunner.routine_8024 // pc=1
	iload 10
	ifeq Label927
	invokestatic_lib long currentTimeMillis(  ) // System
	lstore 21
Label899:
	aload_0_getfield _connection   // get_name_1:  _connection   // get_name_2:  _connection   // get_Name:    _connection   // getName->1:  _connection   // getName->2:  _connection   // getName->N:  _connection   // ofs = 54074 ord = 1 addr = 0
	invokenonvirtual_lib .routine_5720 // pc=1
	ifeq Label931
	invokestatic_lib long currentTimeMillis(  ) // System
	lstore 21
	goto Label899
	...
	getstatic com.whatsapp.client.FunXMPPRunner.field_54078 // FunXMPPRunner
	invokenonvirtual_lib java.lang.String.indexOf // pc=2
	bipush -1
	if_icmpne Label919
Label917:
