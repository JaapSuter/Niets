...
private final com.whatsapp.client.UsageStats.routine_10486( com.whatsapp.client.UsageStats ); // address: 0
	{
	enter 
	invokestatic_lib long currentTimeMillis(  ) // System
	aload_0 
	...
	dup 
	new_lib com.whatsapp.client.UsageStats$1//module:WhatsApp-33.class#6 module:WhatsApp-33.class#6 module:WhatsApp-33.class#6
	dup 
	aload_0 
	invokespecial_lib .routine_691 // pc=2
...
public final recordMessageReceived( com.whatsapp.client.UsageStats, module:WhatsApp-16.class#28 ); // address: 0
	{
	enter 
	synch 
	invokestatic_lib long currentTimeMillis(  ) // System
...
Label46:
	aload_0 
	invokespecial com.whatsapp.client.UsageStats.routine_10486 // pc=1
	return 
	}


public final recordMessageSent( com.whatsapp.client.UsageStats, module:WhatsApp-16.class#28 ); // address: 0
	{
	enter 
	synch 
	aload_1 
