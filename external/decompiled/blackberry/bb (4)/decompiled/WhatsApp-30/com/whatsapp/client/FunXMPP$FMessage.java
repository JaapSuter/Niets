...
Label16:
	...
	aload_3 
	invokeinterface interfacemethodref_94 // pc=2 guess=42
	ifnonnull Label16
	getstatic message_store // FunXMPP
	aload_3 
	aload_0 
	invokeinterface interfacemethodref_95 // pc=3 guess=43
	aload_0 
	aload_3 
...
public <init>( com.whatsapp.client.FunXMPP$FMessage, com.whatsapp.client.FunXMPP$FMessage$Key ); // address: 0
	...
	aload_1 
	aload_0 
	invokeinterface interfacemethodref_95 // pc=3 guess=44
	aload_2 
	monitorexit 
	return 
	astore_3 
...
Label3:
	aload_1 
	aload_0 
	invokeinterface interfacemethodref_96 // pc=2 guess=45
	return 
Label7:
	aload_1 
	aload_0 
	invokeinterface interfacemethodref_97 // pc=2 guess=46
	return 
Label11:
	aload_1 
	aload_0 
	invokeinterface interfacemethodref_98 // pc=2 guess=47
	return 
Label15:
	aload_1 
	aload_0 
	invokeinterface interfacemethodref_99 // pc=2 guess=48
	return 
Label19:
	aload_1 
	aload_0 
	invokeinterface interfacemethodref_100 // pc=2 guess=49
	return 
Label23:
	aload_1 
	aload_0 
	invokeinterface interfacemethodref_101 // pc=2 guess=50
	return 
Label27:
	aload_1 
	aload_0 
	invokeinterface interfacemethodref_102 // pc=2 guess=51
	return 
	}
