...

{
	...
	private com.whatsapp.client. /*module:WhatsApp-36.class#17*/  field_53272 ; // ofs = 53272 addr = 0)
...
Label57:
	...
	iload_6 
	aload_0 
	invokeinterface interfacemethodref_5 // pc=4 guess=5
	...
	aload_7 
	iconst_0 
	invokeinterface interfacemethodref_7 // pc=3 guess=6
	iconst_0 
	new_lib net.rim.blackberry.api.invoke.AddressBookArguments//net.rim.blackberry.api.invoke.AddressBookArguments net.rim.blackberry.api.invoke.AddressBookArguments net.rim.blackberry.api.invoke.AddressBookArguments
	dup 
	ldc literal_59:"new"
...
Label16:
	...
	bipush 115
	iload_5 
	invokeinterface interfacemethodref_11 // pc=3 guess=10
	iastore 
	iinc 5 1
	goto Label16
Label28:
...
private final addHomescreenShortcut( com.whatsapp.client.ChatsTabButton ); // address: 0
	...
	getfield .field_5_5   // get_name_1:  .field_5_5   // get_name_2:  .field_5_5   // get_Name:    .field_5_5   // getName->1:  null   // getName->2:  null   // getName->N:  null   // ofs = -1 ord = 0 addr = 5
	ifne Label34
	new_lib com.whatsapp.client.//module:WhatsApp-13.class#8 module:WhatsApp-13.class#8 module:WhatsApp-13.class#8
	dup 
	getstatic_lib module:WhatsApp-12.class#0.static_156 // class#0
	iconst_0 
	i2l 
...
public final net.rim.device.api.system.Bitmap getIcon( com.whatsapp.client.ChatsTabButton ); // address: 0
	...
	ifgt Label6
	ldc literal_52:"chats"
	invokestatic_lib module:WhatsApp-9.class#2.routine_1887(  ) // class#2
	areturn 
Label6:
	ldc literal_53:"chats-a"
	invokestatic_lib module:WhatsApp-9.class#2.routine_1887(  ) // class#2
	astore_1 
	aload_1 
...
Label15:
	...
	dup 
	ldc literal_54:"empty-chat-list"
