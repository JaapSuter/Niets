...

{
	...
	// @@@@@@@@@@@@@ Fields 
	private long /*long*/  field_55834 ; // ofs = 55834 addr = 0)
	public com.whatsapp.client.MMSPickerInvoker /*com.whatsapp.client.MMSPickerInvoker*/  _parentScr ; // ofs = 55838 addr = 0)
	private com.whatsapp.client.UiApp /*com.whatsapp.client.UiApp*/  field_55842 ; // ofs = 55842 addr = 0)
	private boolean /*boolean*/  field_55846 ; // ofs = 55846 addr = 0)
	private boolean /*boolean*/  field_55850 ; // ofs = 55850 addr = 0)
	private java.util.Hashtable /*java.util.Hashtable*/  field_55854 ; // ofs = 55854 addr = 0)
	private java.util.Hashtable /*java.util.Hashtable*/  field_55858 ; // ofs = 55858 addr = 0)
	private java.util.Hashtable /*java.util.Hashtable*/  field_55862 ; // ofs = 55862 addr = 0)
	private java.util.Vector /*java.util.Vector*/  field_55866 ; // ofs = 55866 addr = 0)
...
private final boolean com.whatsapp.client.MMSPickerInvoker$CameraFileListener.routine_4702( com.whatsapp.client.MMSPickerInvoker$CameraFileListener, java.lang.String ); // address: 0
	{
	enter 
	aconst_null 
	astore_3 
...
private final com.whatsapp.client.MMSPickerInvoker$CameraFileListener.routine_4874( com.whatsapp.client.MMSPickerInvoker$CameraFileListener, java.lang.String ); // address: 0
	{
	enter_narrow 
	aload_0 
	iconst_0 
	...
	getfield _systemPicker   // get_name_1:  _systemPicker   // get_name_2:  _systemPicker   // get_Name:    _systemPicker   // getName->1:  _systemPicker   // getName->2:  _systemPicker   // getName->N:  _systemPicker   // ofs = 55590 ord = 8 addr = 0
	ifnull Label15
	aload_0_getfield .field_2_2   // get_name_1:  .field_2_2   // get_name_2:  .field_2_2   // get_Name:    .field_2_2   // getName->1:  null   // getName->2:  null   // getName->N:  null   // ofs = -1 ord = 0 addr = 2
	iconst_1 
...
private final com.whatsapp.client.MMSPickerInvoker$CameraFileListener.routine_4951( com.whatsapp.client.MMSPickerInvoker$CameraFileListener ); // address: 0
	{
	enter 
...
private final com.whatsapp.client.MMSPickerInvoker$CameraFileListener.routine_5029( com.whatsapp.client.MMSPickerInvoker$CameraFileListener, java.lang.String ); // address: 0
	{
	enter 
	aload_1 
	iconst_0 
...
private final java.lang.String com.whatsapp.client.MMSPickerInvoker$CameraFileListener.routine_5110( com.whatsapp.client.MMSPickerInvoker$CameraFileListener, java.lang.String ); // address: 0
	{
	enter 
	aconst_null 
	astore_2 
...
private final com.whatsapp.client.MMSPickerInvoker$CameraFileListener.routine_5183( com.whatsapp.client.MMSPickerInvoker$CameraFileListener, java.lang.String, java.lang.String ); // address: 0
	{
	enter 
	aload_1 
	iconst_0 
...
Label25:
	aload_0 
	aload_2 
	invokespecial com.whatsapp.client.MMSPickerInvoker$CameraFileListener.routine_5029 // pc=2
	return 
	}


private final boolean com.whatsapp.client.MMSPickerInvoker$CameraFileListener.routine_5255( com.whatsapp.client.MMSPickerInvoker$CameraFileListener, java.lang.String ); // address: 0
	{
	enter 
	aload_1 
	ifnonnull Label5
...
private final boolean com.whatsapp.client.MMSPickerInvoker$CameraFileListener.routine_5328( com.whatsapp.client.MMSPickerInvoker$CameraFileListener, java.lang.String ); // address: 0
	{
	enter 
	aload_1 
	stringlength 
...
public final fileJournalChanged( com.whatsapp.client.MMSPickerInvoker$CameraFileListener ); // address: 0
	...
	monitorenter 
	aload_0 
	invokespecial com.whatsapp.client.MMSPickerInvoker$CameraFileListener.routine_4951 // pc=1
	aload_0_getfield .field_9_9   // get_name_1:  .field_9_9   // get_name_2:  .field_9_9   // get_Name:    .field_9_9   // getName->1:  null   // getName->2:  null   // getName->N:  null   // ofs = -1 ord = 0 addr = 9
...
Label19:
	...
	checkcast_lib net.rim.device.api.ui.VirtualKeyboard//net.rim.device.api.ui.VirtualKeyboard net.rim.device.api.ui.VirtualKeyboard net.rim.device.api.ui.VirtualKeyboard
	astore_5 
	aload_5 
	...
	aload_0 
	aload_2 
	invokespecial com.whatsapp.client.MMSPickerInvoker$CameraFileListener.routine_5255 // pc=2
	ifeq Label42
	aload_0 
	aload_2 
	invokespecial com.whatsapp.client.MMSPickerInvoker$CameraFileListener.routine_5029 // pc=2
...
Label48:
	...
	aload_0 
	aload_2 
	invokespecial com.whatsapp.client.MMSPickerInvoker$CameraFileListener.routine_5110 // pc=2
	astore_7 
	goto Label115
Label60:
	aload_0_getfield .field_6_6   // get_name_1:  .field_6_6   // get_name_2:  .field_6_6   // get_Name:    .field_6_6   // getName->1:  null   // getName->2:  null   // getName->N:  null   // ofs = -1 ord = 0 addr = 6
...
Label65:
	...
	aload 8
	aload_2 
	invokespecial com.whatsapp.client.MMSPickerInvoker$CameraFileListener.routine_5183 // pc=3
	goto_w Label188
Label84:
	aload_0 
	aload 8
...
Label139:
	aload_0 
	aload_2 
	invokespecial com.whatsapp.client.MMSPickerInvoker$CameraFileListener.routine_5328 // pc=2
	ifeq Label144
	goto Label188
Label144:
	aload_0 
	aload_2 
	invokespecial com.whatsapp.client.MMSPickerInvoker$CameraFileListener.routine_4702 // pc=2
	ifeq Label152
	aload_0 
	iconst_1 
	putfield .field_5_5   // get_name_1:  .field_5_5   // get_name_2:  .field_5_5   // get_Name:    .field_5_5   // getName->1:  null   // getName->2:  null   // getName->N:  null   // ofs = -1 ord = 0 addr = 5
...
Label198:
	...
	invokevirtual java.lang.StringBuffer append( java.lang.StringBuffer, java.lang.String ) // pc=2
	invokevirtual_short .toString // idx=2 pc=1
	invokespecial com.whatsapp.client.MMSPickerInvoker$CameraFileListener.routine_4874 // pc=2
Label210:
	return 
	}
