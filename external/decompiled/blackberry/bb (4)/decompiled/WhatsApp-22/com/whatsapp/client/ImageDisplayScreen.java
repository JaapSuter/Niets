...
static public final assignPicToContact( java.lang.String, module:WhatsApp.class#12 ); // address: 0
	...
	invokeinterface interfacemethodref_38 // pc=2 guess=0
	astore_4 
	aload_0 
	...
	aload_4 
	bipush 110
	invokeinterface interfacemethodref_39 // pc=2 guess=1
	ifle Label34
	aload_4 
	bipush 110
	iconst_0 
	...
	aload_5 
	arraylength 
	invokeinterface interfacemethodref_40 // pc=7 guess=2
	goto Label42
Label34:
	aload_4 
	bipush 110
	...
	aload_5 
	arraylength 
	invokeinterface interfacemethodref_41 // pc=6 guess=3
Label42:
	aload_4 
	invokeinterface interfacemethodref_42 // pc=1 guess=4
	aload_3 
	ifnull Label77
	aload_3 
	invokeinterface interfacemethodref_43 // pc=1 guess=5
	return 
	astore_4 
	return 
	astore_4 
	...
	dup 
	ldc literal_414:"Couldn't save picture to contact, got error: "
...
Label9:
	...
	goto Label29
	astore_3 
	ldc literal_413:"Couldn't create contact picture from image"
	invokestatic_lib alert( java.lang.String ) // Dialog
	return 
Label29:
	aload_0_getfield _targetCID   // get_name_1:  _targetCID   // get_name_2:  _targetCID   // get_Name:    _targetCID   // getName->1:  _targetCID   // getName->2:  _targetCID   // getName->N:  _targetCID   // ofs = 53034 ord = 26 addr = 0
