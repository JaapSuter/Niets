...
protected <init>( com.whatsapp.client.InitializationScreen$ProgressField, com.whatsapp.client.InitializationScreen, long ); // address: 0
	...
	aload_0 
	aload_1 
	putfield com.whatsapp.client.InitializationScreen$ProgressField.field_54200   // get_name_1:  com.whatsapp.client.InitializationScreen$ProgressField.field_54200   // get_name_2:  com.whatsapp.client.InitializationScreen$ProgressField.field_54200   // get_Name:    com.whatsapp.client.InitializationScreen$ProgressField.field_54200   // getName->1:     // getName->2:     // getName->N:     // ofs = 54200 ord = 4 addr = 0
	aload_0 
	iconst_0 
	putfield inProgress   // get_name_1:  inProgress   // get_name_2:  inProgress   // get_Name:    inProgress   // getName->1:  inProgress   // getName->2:  inProgress   // getName->N:  inProgress   // ofs = 54184 ord = 0 addr = 0
	aload_0 
	iconst_0 
	putfield complete   // get_name_1:  complete   // get_name_2:  complete   // get_Name:    complete   // getName->1:  complete   // getName->2:  complete   // getName->N:  complete   // ofs = 54188 ord = 1 addr = 0
	aload_0 
	ldc literal_416:"bb-init-circle.png"
	invokestatic_lib net.rim.device.api.system.Bitmap getBitmapResource( java.lang.String ) // Bitmap
	putfield background   // get_name_1:  background   // get_name_2:  background   // get_Name:    background   // getName->1:  background   // getName->2:  background   // getName->N:  background   // ofs = 54192 ord = 2 addr = 0
	aload_0 
	invokespecial com.whatsapp.client.InitializationScreen$ProgressField.routine_6637 // pc=1
	return 
	}

	// @@@@@@@@@@@@@ Non-virtual routines 

private final com.whatsapp.client.InitializationScreen$ProgressField.routine_6637( com.whatsapp.client.InitializationScreen$ProgressField ); // address: 0
	{
	enter 
	aload_0_getfield inProgress   // get_name_1:  inProgress   // get_name_2:  inProgress   // get_Name:    inProgress   // getName->1:  inProgress   // getName->2:  inProgress   // getName->N:  inProgress   // ofs = 54184 ord = 0 addr = 0
	ifeq Label17
	aload_0_getfield complete   // get_name_1:  complete   // get_name_2:  complete   // get_Name:    complete   // getName->1:  complete   // getName->2:  complete   // getName->N:  complete   // ofs = 54188 ord = 1 addr = 0
	ifne Label17
	aload_0_getfield progressField   // get_name_1:  progressField   // get_name_2:  progressField   // get_Name:    progressField   // getName->1:  progressField   // getName->2:  progressField   // getName->N:  progressField   // ofs = 54196 ord = 3 addr = 0
	ifnonnull Label24
	aload_0 
	...
	putfield progressField   // get_name_1:  progressField   // get_name_2:  progressField   // get_Name:    progressField   // getName->1:  progressField   // getName->2:  progressField   // getName->N:  progressField   // ofs = 54196 ord = 3 addr = 0
	aload_0 
	aload_0_getfield progressField   // get_name_1:  progressField   // get_name_2:  progressField   // get_Name:    progressField   // getName->1:  progressField   // getName->2:  progressField   // getName->N:  progressField   // ofs = 54196 ord = 3 addr = 0
...
public final int getPreferredWidth( com.whatsapp.client.InitializationScreen$ProgressField ); // address: 0
	{
	enter_narrow 
	aload_0_getfield background   // get_name_1:  background   // get_name_2:  background   // get_Name:    background   // getName->1:  background   // getName->2:  background   // getName->N:  background   // ofs = 54192 ord = 2 addr = 0
...
protected final paint( com.whatsapp.client.InitializationScreen$ProgressField, net.rim.device.api.ui.Graphics ); // address: 0
	...
	aload_0_getfield complete   // get_name_1:  complete   // get_name_2:  complete   // get_Name:    complete   // getName->1:  complete   // getName->2:  complete   // getName->N:  complete   // ofs = 54188 ord = 1 addr = 0
	ifeq Label44
	ldc literal_415:"bb-init-checkmark.png"
	invokestatic_lib net.rim.device.api.system.Bitmap getBitmapResource( java.lang.String ) // Bitmap
	astore_2 
	aload_0 
	invokevirtual int getWidth( net.rim.device.api.ui.Field ) // pc=1
