...

{
	...
	// @@@@@@@@@@@@@ Fields 
	protected final byte[] /*byte[]*/  encodingTable ; // ofs = 52882 addr = 0)
	protected byte /*byte*/  padding ; // ofs = 52886 addr = 0)
	protected final byte[] /*byte[]*/  decodingTable ; // ofs = 52890 addr = 0)
...
private boolean ignore( com.whatsapp.client.org.bouncycastle.util.encoders.Base64Encoder, char ); // address: 0
	{
	enter_narrow 
	iload_1 
	bipush 10
...
private int nextI( com.whatsapp.client.org.bouncycastle.util.encoders.Base64Encoder, byte[], int, int ); // address: 0
	{
	enter 
Label1:
	iload_2 
	...
	baload 
	i2c 
	invokespecial com.whatsapp.client.org.bouncycastle.util.encoders.Base64Encoder.ignore // pc=2
	ifeq Label13
	iinc 2 1
	goto Label1
Label13:
...
private int decodeLastBlock( com.whatsapp.client.org.bouncycastle.util.encoders.Base64Encoder, java.io.OutputStream, char, char, char, char ); // address: 0
	{
	enter 
	iload_4 
...
Label22:
	...
	iload 11
	iload 12
	invokespecial com.whatsapp.client.org.bouncycastle.util.encoders.Base64Encoder.nextI // pc=4
	istore 11
Label34:
	iload 11
	iload 12
...
Label117:
	...
	baload 
	i2c 
	invokespecial com.whatsapp.client.org.bouncycastle.util.encoders.Base64Encoder.decodeLastBlock // pc=6
	iadd 
	istore 9
	iload 9
	ireturn 
