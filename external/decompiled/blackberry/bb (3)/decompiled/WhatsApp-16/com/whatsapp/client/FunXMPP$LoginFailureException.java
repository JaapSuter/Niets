...

{
	...
	// @@@@@@@@@@@@@ Fields 
	public int /*int*/  type ; // ofs = 54350 addr = 0)
	public long /*long*/  expire_date ; // ofs = 54354 addr = 0)
...
public <init>( com.whatsapp.client.FunXMPP$LoginFailureException, int ); // address: 0
	...
	aload_0 
	iload_1 
	putfield type   // get_name_1:  type   // get_name_2:  type   // get_Name:    type   // getName->1:  type   // getName->2:  type   // getName->N:  type   // ofs = 54350 ord = 0 addr = 0
	return 
	}
