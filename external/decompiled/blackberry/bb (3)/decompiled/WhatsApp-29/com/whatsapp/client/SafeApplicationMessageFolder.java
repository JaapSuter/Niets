...

{
	...
	// @@@@@@@@@@@@@ Fields 
	private net.rim.blackberry.api.messagelist.ApplicationMessageFolder /*net.rim.blackberry.api.messagelist.ApplicationMessageFolder*/  _applicationMessageFolder ; // ofs = 53472 addr = 0)
	private Object /*java.lang.Object*/  _asyncThreadLock ; // ofs = 53476 addr = 0)
	private Long /*java.lang.Long*/  _asyncThreadStartTime ; // ofs = 53480 addr = 0)
	private java.util.Vector /*java.util.Vector*/  _asyncUpdateVector ; // ofs = 53484 addr = 0)
	private java.util.Vector /*java.util.Vector*/  _asyncAddVector ; // ofs = 53488 addr = 0)
	private java.util.Vector /*java.util.Vector*/  _asyncRemoveVector ; // ofs = 53492 addr = 0)
...
public final fireElementRemoved( com.whatsapp.client.SafeApplicationMessageFolder, net.rim.blackberry.api.messagelist.ApplicationMessage ); // address: 0
	...
	aload_0 
	invokespecial com.whatsapp.client.SafeApplicationMessageFolder.startAsyncThread // pc=1
	aload_2 
	monitorexit 
	return 
	astore_3 
...
private final startAsyncThread( com.whatsapp.client.SafeApplicationMessageFolder ); // address: 0
	{
	enter 
