...
{
	// @@@@@@@@@@@@@ Static fields 
	private final static String /*java.lang.String*/  filesystemRootDefault ; // ofs = 54130 addr = 12)
	private final static long /*long*/  installTimestampDefault ; // ofs = 54136 addr = 13)
	private final static long /*long*/  lastStatusChangeTimestampDefault ; // ofs = 54142 addr = 15)
...
public <init>( com.whatsapp.client.ApplicationHashData ); // address: 0
	...
	invokestatic_lib module:WhatsApp-36.class#1.routine_5695(  ) // class#1
	ifeq Label14
	getstatic_lib module:WhatsApp-45.class#0.static_47 // class#0
	goto Label15
Label14:
	getstatic_lib module:WhatsApp-45.class#0.static_46 // class#0
Label15:
	invokespecial com.whatsapp.client.ApplicationHashData.setString // pc=3
	return 
	}


static public final saveModified( module:WhatsApp-27.class#0, com.whatsapp.client.ApplicationHashData ); // address: 0
	{
	enter_narrow 
	aload_1 
...
static final <clinit>(  ); // address: 0
	...
	clinit_wait 
	invokestatic_lib module:WhatsApp-12.class#5.routine_2927(  ) // class#5
	putstatic filesystemRootDefault // ApplicationHashData
	invokestatic_lib long currentTimeMillis(  ) // System
	lputstatic installTimestampDefault // ApplicationHashData
	lgetstatic installTimestampDefault // ApplicationHashData
	iipush 518400000
	i2l 
	lsub 
	lputstatic lastStatusChangeTimestampDefault // ApplicationHashData
	clinit_return 
	}

	// @@@@@@@@@@@@@ Non-virtual routines 

private final setString( com.whatsapp.client.ApplicationHashData, java.lang.String, java.lang.String ); // address: 0
	{
	jumpspecial safeMapPut( com.whatsapp.client.ApplicationHashData, java.lang.String, java.lang.Object )
	}


private final safeMapPut( com.whatsapp.client.ApplicationHashData, java.lang.String, java.lang.Object ); // address: 0
	{
	enter_narrow 
	aload_2 
	ifnonnull Label8
...
private final java.lang.String getString( com.whatsapp.client.ApplicationHashData, java.lang.String, java.lang.String ); // address: 0
	{
	enter 
	aload_0_getfield .field_0_   // get_name_1:  .field_0_   // get_name_2:  .field_0_   // get_Name:    .field_0_   // getName->1:  null   // getName->2:  null   // getName->N:  null   // ofs = -1 ord = 0 addr = 0
	aload_1 
...
private final setBoolean( com.whatsapp.client.ApplicationHashData, java.lang.String, boolean ); // address: 0
	{
	enter 
	aload_0 
	aload_1 
	...
	invokespecial com.whatsapp.client.ApplicationHashData.safeMapPut // pc=3
	return 
	}


private final boolean getBoolean( com.whatsapp.client.ApplicationHashData, java.lang.String, boolean ); // address: 0
	{
	enter 
	aload_0_getfield .field_0_   // get_name_1:  .field_0_   // get_name_2:  .field_0_   // get_Name:    .field_0_   // getName->1:  null   // getName->2:  null   // getName->N:  null   // ofs = -1 ord = 0 addr = 0
	aload_1 
...
private final setByteArray( com.whatsapp.client.ApplicationHashData, java.lang.String, byte[] ); // address: 0
	{
	jumpspecial safeMapPut( com.whatsapp.client.ApplicationHashData, java.lang.String, java.lang.Object )
	}


private final setInt( com.whatsapp.client.ApplicationHashData, java.lang.String, int ); // address: 0
	{
	enter 
	aload_0 
	aload_1 
...
private final int getInt( com.whatsapp.client.ApplicationHashData, java.lang.String, int ); // address: 0
	{
	enter 
	aload_0_getfield .field_0_   // get_name_1:  .field_0_   // get_name_2:  .field_0_   // get_Name:    .field_0_   // getName->1:  null   // getName->2:  null   // getName->N:  null   // ofs = -1 ord = 0 addr = 0
	aload_1 
...
private final setLong( com.whatsapp.client.ApplicationHashData, java.lang.String, long ); // address: 0
	{
	enter 
	aload_0 
	aload_1 
...
private final long getLong( com.whatsapp.client.ApplicationHashData, java.lang.String, long ); // address: 0
	{
	enter 
	aload_0_getfield .field_0_   // get_name_1:  .field_0_   // get_name_2:  .field_0_   // get_Name:    .field_0_   // getName->1:  null   // getName->2:  null   // getName->N:  null   // ofs = -1 ord = 0 addr = 0
	aload_1 
...
public final boolean isAutosaveMedia( com.whatsapp.client.ApplicationHashData ); // address: 0
	...
	iconst_1 
	invokespecial com.whatsapp.client.ApplicationHashData.getBoolean // pc=3
	ireturn 
	}
...
public final setAutosaveMedia( com.whatsapp.client.ApplicationHashData, boolean ); // address: 0
	...
	ldc literal_51:"AUTOSAVE_MEDIA"
	iload_1 
	invokespecial com.whatsapp.client.ApplicationHashData.setBoolean // pc=3
	return 
	}
...
public final java.lang.String getChatUserID( com.whatsapp.client.ApplicationHashData ); // address: 0
	...
	invokespecial com.whatsapp.client.ApplicationHashData.getString // pc=3
	areturn 
	}
...
public final setContactsToShow( com.whatsapp.client.ApplicationHashData, int ); // address: 0
	...
	iload_1 
	invokespecial com.whatsapp.client.ApplicationHashData.setInt // pc=3
	return 
	}
...
public final setLastStatusChangeTimestamp( com.whatsapp.client.ApplicationHashData, long ); // address: 0
	...
	lload 1
	invokespecial com.whatsapp.client.ApplicationHashData.setLong // pc=4
	return 
	}
...
public final long getLastAlertStamp( com.whatsapp.client.ApplicationHashData ); // address: 0
	...
	iconst_0 
	i2l 
	invokespecial com.whatsapp.client.ApplicationHashData.getLong // pc=4
	lreturn 
	}
...
public final int getLastAlertItem( com.whatsapp.client.ApplicationHashData ); // address: 0
	...
	bipush -1
	invokespecial com.whatsapp.client.ApplicationHashData.getInt // pc=3
	ireturn 
	}
...
public final setLastIMSI( com.whatsapp.client.ApplicationHashData, byte[] ); // address: 0
	...
	aload_1 
	invokespecial com.whatsapp.client.ApplicationHashData.setByteArray // pc=3
	return 
	}
...
public final java.lang.String getFilesystemRoot( com.whatsapp.client.ApplicationHashData ); // address: 0
	...
	getstatic filesystemRootDefault // ApplicationHashData
	invokespecial com.whatsapp.client.ApplicationHashData.getString // pc=3
	areturn 
	}
