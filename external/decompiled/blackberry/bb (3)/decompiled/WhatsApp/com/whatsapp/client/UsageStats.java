...
static public final reset(  ); // address: 0
	...
	aload_1 
	aload_0 
	invokenonvirtual_lib .routine_460 // pc=2
	return 
	}

	// @@@@@@@@@@@@@ Non-virtual routines 

private final saveCheck( com.whatsapp.client.UsageStats ); // address: 0
	{
	enter 
	invokestatic_lib long currentTimeMillis(  ) // System
	aload_0 
	...
	dup 
	new_lib com.whatsapp.client.//module:WhatsApp-34.class#2 module:WhatsApp-34.class#2 module:WhatsApp-34.class#2
	dup 
	aload_0 
	invokespecial_lib .routine_6956 // pc=2
...
public final recordMessageReceived( com.whatsapp.client.UsageStats, module:WhatsApp-14.class#29 ); // address: 0
	{
	enter 
	synch 
	invokestatic_lib long currentTimeMillis(  ) // System
...
Label46:
	aload_0 
	invokespecial com.whatsapp.client.UsageStats.saveCheck // pc=1
	return 
	}


public final recordMessageSent( com.whatsapp.client.UsageStats, module:WhatsApp-14.class#29 ); // address: 0
	{
	enter 
	synch 
	aload_1 
